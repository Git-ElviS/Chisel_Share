...
void VCastToUIntTester___024root__trace_chg_sub_0(VCastToUIntTester___024root* vlSelf, VerilatedVcd* tracep);

void VCastToUIntTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCastToUIntTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VCastToUIntTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VCastToUIntTester___024root__trace_chg_sub_0(VCastToUIntTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VCastToUIntTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCastToUIntTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VCastToUIntTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCastToUIntTester___024root__trace_cleanup\n"); );
    // Init
    VCastToUIntTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VCastToUIntTester___024root*>(voidSelf);
    VCastToUIntTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
