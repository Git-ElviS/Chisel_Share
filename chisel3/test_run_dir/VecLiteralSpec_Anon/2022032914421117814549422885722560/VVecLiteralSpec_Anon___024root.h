...
VL_MODULE(VVecLiteralSpec_Anon___024root) {
  public:
    ...
    VL_IN8(clock,0,0);
    VL_IN8(reset,0,0);
    CData/*2:0*/ VecLiteralSpec_Anon__DOT__counter;
    CData/*2:0*/ VecLiteralSpec_Anon__DOT___wrap_value_T_1;
    CData/*7:0*/ VecLiteralSpec_Anon__DOT__m__DOT__y_1;
    CData/*7:0*/ VecLiteralSpec_Anon__DOT__m__DOT__y_2;
