...
VL_ATTR_COLD void VVecLiteralSpec_Anon___024root__trace_init_sub__TOP__0(VVecLiteralSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+4,"clock", false,-1);
    tracep->declBit(c+5,"reset", false,-1);
    tracep->declBus(c+1,"r_0", false,-1, 10,0);
    tracep->declBus(c+2,"r_1", false,-1, 10,0);
    tracep->declBus(c+3,"r_2", false,-1, 10,0);
...
VL_ATTR_COLD void VVecLiteralSpec_Anon___024root__trace_full_sub_0(VVecLiteralSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullSData(oldp+1,(vlSelf->VecLiteralSpec_Anon__DOT__r_0),11);
    tracep->fullSData(oldp+2,(vlSelf->VecLiteralSpec_Anon__DOT__r_1),11);
    tracep->fullSData(oldp+3,(vlSelf->VecLiteralSpec_Anon__DOT__r_2),11);
