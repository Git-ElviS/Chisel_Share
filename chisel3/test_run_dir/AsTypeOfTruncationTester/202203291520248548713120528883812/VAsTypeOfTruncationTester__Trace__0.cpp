...
void VAsTypeOfTruncationTester___024root__trace_chg_sub_0(VAsTypeOfTruncationTester___024root* vlSelf, VerilatedVcd* tracep);

void VAsTypeOfTruncationTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAsTypeOfTruncationTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VAsTypeOfTruncationTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VAsTypeOfTruncationTester___024root__trace_chg_sub_0(VAsTypeOfTruncationTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VAsTypeOfTruncationTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAsTypeOfTruncationTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VAsTypeOfTruncationTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAsTypeOfTruncationTester___024root__trace_cleanup\n"); );
    // Init
    VAsTypeOfTruncationTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VAsTypeOfTruncationTester___024root*>(voidSelf);
    VAsTypeOfTruncationTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
