...
VL_INLINE_OPT void VCompatibilityInteroperabilitySpec_Anon___024root___sequent__TOP__0(VCompatibilityInteroperabilitySpec_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/CompatibilityInteroperabilitySpec_Anon/202203291513547003488875785476297/CompatibilityInteroperabilitySpec_Anon.v", 11, "");
        }
    }
}
