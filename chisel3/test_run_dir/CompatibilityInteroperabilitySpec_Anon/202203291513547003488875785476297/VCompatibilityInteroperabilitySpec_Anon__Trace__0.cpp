...
void VCompatibilityInteroperabilitySpec_Anon___024root__trace_chg_sub_0(VCompatibilityInteroperabilitySpec_Anon___024root* vlSelf, VerilatedVcd* tracep);

void VCompatibilityInteroperabilitySpec_Anon___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCompatibilityInteroperabilitySpec_Anon___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VCompatibilityInteroperabilitySpec_Anon___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VCompatibilityInteroperabilitySpec_Anon___024root__trace_chg_sub_0(VCompatibilityInteroperabilitySpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VCompatibilityInteroperabilitySpec_Anon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCompatibilityInteroperabilitySpec_Anon___024root__trace_chg_sub_0\n"); );
    // Init
...
void VCompatibilityInteroperabilitySpec_Anon___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCompatibilityInteroperabilitySpec_Anon___024root__trace_cleanup\n"); );
    // Init
    VCompatibilityInteroperabilitySpec_Anon___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VCompatibilityInteroperabilitySpec_Anon___024root*>(voidSelf);
    VCompatibilityInteroperabilitySpec_Anon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
