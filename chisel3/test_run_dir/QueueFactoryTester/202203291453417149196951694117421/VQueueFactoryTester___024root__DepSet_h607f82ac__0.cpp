...
VL_INLINE_OPT void VQueueFactoryTester___024root___sequent__TOP__0(VQueueFactoryTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                            >> 0xbU) & (~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                              ? 0xcU : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                                         ? 5U : ((0x11U 
                                                              ...
                                                              ((3U 
                                                               ...
                                                               ((2U 
                                                                ...
                                                                ((1U 
                                                                  ...
                                                                  ? 1U
                                                                  : 0xaU))))))))))))))))))) 
                            != ((2U >= (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0))
                                 ? vlSelf->QueueFactoryTester__DOT__deq__DOT__ram
                                [vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]
                                 : 0U))))) {
            VL_WRITEF("[%0t] %%Error: QueueFactoryTester.v:538: Assertion failed in %NQueueFactoryTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/202203291453417149196951694117421/QueueFactoryTester.v", 538, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/202203291453417149196951694117421/QueueFactoryTester.v", 561, "");
        }
    }
    ...
    if (((~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__full)) 
        ...
        vlSelf->QueueFactoryTester__DOT__deq__DOT____Vlvbound_h86dbd62e__0 
            = ((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                ? 0xcU : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                           ? 5U : ((0x11U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                    ? 6U : ((0x10U 
                                                           ...
                                                           ((3U 
                                                            ...
                                                            ((2U 
                                                             ...
                                                             ((1U 
                                                               ...
                                                               ? 1U
                                                               : 0xaU)))))))))))))))))));
        if ((2U >= (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value))) {
    ...
    vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 
        = (3U & ((IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_deq)
                  ? ((2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1))
                      ? 0U : ((IData)(1U) + (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1)))
    ...
    if (vlSelf->reset) {
        ...
        if (vlSelf->QueueFactoryTester__DOT__deq__DOT__do_enq) {
            vlSelf->QueueFactoryTester__DOT__deq__DOT__value 
                = ((IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__wrap)
                    ? 0U : (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT___value_T_1));
        }
    }
    ...
    } else if (vlSelf->QueueFactoryTester__DOT__deq__DOT__do_deq) {
        vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1 
            = ((IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__wrap_1)
                ? 0U : (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT___value_T_3));
    }
    ...
    vlSelf->QueueFactoryTester__DOT___value_T_1 = (0x1fU 
                                                   & ((IData)(1U) 
                                                      + (IData)(vlSelf->QueueFactoryTester__DOT__value)));
    vlSelf->QueueFactoryTester__DOT__deq__DOT__wrap 
        = (2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value));
    ...
    vlSelf->QueueFactoryTester__DOT__deq__DOT__wrap_1 
        = (2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1));
