...
VL_ATTR_COLD void VQueueFactoryTester___024root___ctor_var_reset(VQueueFactoryTester___024root* vlSelf) {
    ...
    vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_en_pipe_0 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 = VL_RAND_RESET_I(2);
    vlSelf->QueueFactoryTester__DOT__deq__DOT__value = VL_RAND_RESET_I(2);
    vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1 = VL_RAND_RESET_I(2);
    ...
    vlSelf->QueueFactoryTester__DOT__deq__DOT__wrap = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq__DOT___value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->QueueFactoryTester__DOT__deq__DOT__wrap_1 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq__DOT___value_T_3 = VL_RAND_RESET_I(2);
    vlSelf->QueueFactoryTester__DOT__deq__DOT____Vlvbound_h86dbd62e__0 = VL_RAND_RESET_I(4);
