...
void VQueueFactoryTester___024root___sequent__TOP__0(VQueueFactoryTester___024root* vlSelf);
...
void VQueueFactoryTester___024root___eval(VQueueFactoryTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueFactoryTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VQueueFactoryTester___024root___sequent__TOP__0(vlSelf);
...
void VQueueFactoryTester___024root___eval_debug_assertions(VQueueFactoryTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VQueueFactoryTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueFactoryTester___024root___eval_debug_assertions\n"); );
    // Body
