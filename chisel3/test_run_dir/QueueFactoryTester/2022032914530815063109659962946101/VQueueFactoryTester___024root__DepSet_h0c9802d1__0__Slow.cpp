...
VL_ATTR_COLD void VQueueFactoryTester___024root___ctor_var_reset(VQueueFactoryTester___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[__Vi0] = VL_RAND_RESET_I(2);
    }
    ...
    vlSelf->QueueFactoryTester__DOT__deq__DOT____Vlvbound_h7234a2a6__0 = VL_RAND_RESET_I(2);
