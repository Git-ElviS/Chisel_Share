...
VL_INLINE_OPT void VQueueFactoryTester___024root___sequent__TOP__0(VQueueFactoryTester___024root* vlSelf) {
    ...
    CData/*1:0*/ __Vdlyvval__QueueFactoryTester__DOT__deq__DOT__ram__v0;
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                            >> 7U) & (~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                              ? 1U : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                                       ? 2U : ((0x11U 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/2022032914530815063109659962946101/QueueFactoryTester.v", 517, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/2022032914530815063109659962946101/QueueFactoryTester.v", 540, "");
        }
    }
    ...
    if (((~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__full)) 
        ...
        vlSelf->QueueFactoryTester__DOT__deq__DOT____Vlvbound_h7234a2a6__0 
            = ((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                ? 1U : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                         ? 2U : ((0x11U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                  ? 1U : ((0x10U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                           ? 3U : (
                                                   (0xfU 
