...
VL_ATTR_COLD void VQueueFactoryTester___024root__trace_init_sub__TOP__0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+42,"clock", false,-1);
    tracep->declBit(c+43,"reset", false,-1);
    tracep->declBit(c+42,"deq_clock", false,-1);
    tracep->declBit(c+43,"deq_reset", false,-1);
    tracep->declBit(c+1,"deq_io_enq_ready", false,-1);
    tracep->declBit(c+2,"deq_io_enq_valid", false,-1);
    tracep->declBus(c+3,"deq_io_enq_bits", false,-1, 1,0);
    tracep->declBit(c+4,"deq_io_deq_ready", false,-1);
    tracep->declBit(c+5,"deq_io_deq_valid", false,-1);
    tracep->declBus(c+6,"deq_io_deq_bits", false,-1, 1,0);
    tracep->declBit(c+42,"deq_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+43,"deq_io_deq_ready_prng_reset", false,-1);
    ...
    tracep->declBit(c+44,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBus(c+31,"ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
    tracep->declBus(c+6,"ram_io_deq_bits_MPORT_data", false,-1, 1,0);
    tracep->declBus(c+3,"ram_MPORT_data", false,-1, 1,0);
    tracep->declBus(c+32,"ram_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+44,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+33,"ram_MPORT_en", false,-1);
    tracep->declBus(c+32,"value", false,-1, 1,0);
    tracep->declBus(c+31,"value_1", false,-1, 1,0);
    tracep->declBit(c+34,"maybe_full", false,-1);
    tracep->declBit(c+35,"ptr_match", false,-1);
    tracep->declBit(c+36,"empty", false,-1);
    tracep->declBit(c+37,"full", false,-1);
    tracep->declBit(c+38,"do_enq", false,-1);
    tracep->declBit(c+39,"do_deq", false,-1);
    tracep->declBit(c+40,"wrap", false,-1);
    tracep->declBit(c+41,"wrap_1", false,-1);
...
VL_ATTR_COLD void VQueueFactoryTester___024root__trace_full_sub_0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+3,(((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                ? 1U : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                         ? 2U : ((0x11U 
    ...
    tracep->fullCData(oldp+6,(((2U >= (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1))
    ...
    tracep->fullCData(oldp+28,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[0]),2);
    tracep->fullCData(oldp+29,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[1]),2);
    tracep->fullCData(oldp+30,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[2]),2);
    tracep->fullCData(oldp+31,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1),2);
    tracep->fullCData(oldp+32,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value),2);
    tracep->fullBit(oldp+33,(((~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->QueueFactoryTester__DOT__value)))));
    tracep->fullBit(oldp+34,(vlSelf->QueueFactoryTester__DOT__deq__DOT__maybe_full));
    tracep->fullBit(oldp+35,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ptr_match));
    tracep->fullBit(oldp+36,(vlSelf->QueueFactoryTester__DOT__deq__DOT__empty));
    tracep->fullBit(oldp+37,(vlSelf->QueueFactoryTester__DOT__deq__DOT__full));
    tracep->fullBit(oldp+38,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_enq));
    tracep->fullBit(oldp+39,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_deq));
    tracep->fullBit(oldp+40,((2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value))));
    tracep->fullBit(oldp+41,((2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1))));
    tracep->fullBit(oldp+42,(vlSelf->clock));
    tracep->fullBit(oldp+43,(vlSelf->reset));
