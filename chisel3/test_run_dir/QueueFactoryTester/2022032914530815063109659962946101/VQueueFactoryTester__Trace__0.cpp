...
void VQueueFactoryTester___024root__trace_chg_sub_0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+5,(((2U >= (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1))
        ...
        tracep->chgCData(oldp+27,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[0]),2);
        tracep->chgCData(oldp+28,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[1]),2);
        tracep->chgCData(oldp+29,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[2]),2);
        tracep->chgCData(oldp+30,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1),2);
        tracep->chgCData(oldp+31,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value),2);
        tracep->chgBit(oldp+32,(((~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->QueueFactoryTester__DOT__value)))));
        tracep->chgBit(oldp+33,(vlSelf->QueueFactoryTester__DOT__deq__DOT__maybe_full));
        tracep->chgBit(oldp+34,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ptr_match));
        tracep->chgBit(oldp+35,(vlSelf->QueueFactoryTester__DOT__deq__DOT__empty));
        tracep->chgBit(oldp+36,(vlSelf->QueueFactoryTester__DOT__deq__DOT__full));
        tracep->chgBit(oldp+37,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_enq));
        tracep->chgBit(oldp+38,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_deq));
        tracep->chgBit(oldp+39,((2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value))));
        tracep->chgBit(oldp+40,((2U == (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1))));
    }
    tracep->chgBit(oldp+41,(vlSelf->clock));
    tracep->chgBit(oldp+42,(vlSelf->reset));
}
