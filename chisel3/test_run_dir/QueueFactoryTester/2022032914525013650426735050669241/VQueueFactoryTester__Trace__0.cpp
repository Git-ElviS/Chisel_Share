...
void VQueueFactoryTester___024root__trace_chg_sub_0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+2,(((0x13U != (IData)(vlSelf->QueueFactoryTester__DOT__value)) 
        ...
        tracep->chgBit(oldp+5,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram
        ...
        tracep->chgBit(oldp+27,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[0]));
        tracep->chgBit(oldp+28,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[1]));
        tracep->chgBit(oldp+29,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[2]));
        tracep->chgBit(oldp+30,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[3]));
        tracep->chgCData(oldp+31,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1),2);
