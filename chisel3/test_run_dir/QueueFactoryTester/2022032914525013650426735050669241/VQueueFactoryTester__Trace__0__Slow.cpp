...
VL_ATTR_COLD void VQueueFactoryTester___024root__trace_init_sub__TOP__0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 4; ++i) {
        tracep->declBit(c+28+i*1,"ram", true,(i+0));
    }
    ...
    tracep->declBus(c+32,"value_1", false,-1, 1,0);
...
VL_ATTR_COLD void VQueueFactoryTester___024root__trace_full_sub_0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+3,(((0x13U != (IData)(vlSelf->QueueFactoryTester__DOT__value)) 
    ...
    tracep->fullBit(oldp+6,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram
    ...
    tracep->fullBit(oldp+28,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[0]));
    tracep->fullBit(oldp+29,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[1]));
    tracep->fullBit(oldp+30,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[2]));
    tracep->fullBit(oldp+31,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram[3]));
    tracep->fullCData(oldp+32,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1),2);
