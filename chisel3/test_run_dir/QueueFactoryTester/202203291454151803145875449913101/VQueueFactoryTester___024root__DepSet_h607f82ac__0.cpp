...
VL_INLINE_OPT void VQueueFactoryTester___024root___sequent__TOP__0(VQueueFactoryTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                         ...
                         & (((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                              ? 0xbU : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                                         ? 0xdU : (
                                                   (0x11U 
                            ...
                            [vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1])))) {
            VL_WRITEF("[%0t] %%Error: QueueFactoryTester.v:494: Assertion failed in %NQueueFactoryTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/202203291454151803145875449913101/QueueFactoryTester.v", 494, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/202203291454151803145875449913101/QueueFactoryTester.v", 517, "");
        }
    }
    ...
    if (((~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__full)) 
        ...
        __Vdlyvval__QueueFactoryTester__DOT__deq__DOT__ram__v0 
            = ((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                ? 0xbU : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                           ? 0xdU : ((0x11U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                      ? 2U : ((0x10U 
