...
void VQueueFactoryTester___024root__trace_chg_sub_0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+5,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram
        ...
        tracep->chgBit(oldp+29,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
        tracep->chgBit(oldp+30,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
        tracep->chgBit(oldp+31,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value));
        ...
        tracep->chgBit(oldp+33,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1));
        tracep->chgBit(oldp+34,(vlSelf->QueueFactoryTester__DOT__deq__DOT__maybe_full));
        tracep->chgBit(oldp+35,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ptr_match));
        tracep->chgBit(oldp+36,(vlSelf->QueueFactoryTester__DOT__deq__DOT__empty));
        tracep->chgBit(oldp+37,(vlSelf->QueueFactoryTester__DOT__deq__DOT__full));
        tracep->chgBit(oldp+38,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_enq));
        tracep->chgBit(oldp+39,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_deq));
    }
