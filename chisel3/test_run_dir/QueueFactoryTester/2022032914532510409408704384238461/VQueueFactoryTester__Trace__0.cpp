...
void VQueueFactoryTester___024root__trace_chg_sub_0(VQueueFactoryTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+29,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value_1));
        tracep->chgBit(oldp+30,(vlSelf->QueueFactoryTester__DOT__deq__DOT__value));
        tracep->chgBit(oldp+31,(((~ (IData)(vlSelf->QueueFactoryTester__DOT__deq__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->QueueFactoryTester__DOT__value)))));
        tracep->chgBit(oldp+32,(vlSelf->QueueFactoryTester__DOT__deq__DOT__maybe_full));
        tracep->chgBit(oldp+33,(vlSelf->QueueFactoryTester__DOT__deq__DOT__ptr_match));
        tracep->chgBit(oldp+34,(vlSelf->QueueFactoryTester__DOT__deq__DOT__empty));
        tracep->chgBit(oldp+35,(vlSelf->QueueFactoryTester__DOT__deq__DOT__full));
        tracep->chgBit(oldp+36,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_enq));
        tracep->chgBit(oldp+37,(vlSelf->QueueFactoryTester__DOT__deq__DOT__do_deq));
    }
