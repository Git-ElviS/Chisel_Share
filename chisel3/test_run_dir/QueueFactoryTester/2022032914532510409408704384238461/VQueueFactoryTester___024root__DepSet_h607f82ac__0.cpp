...
VL_INLINE_OPT void VQueueFactoryTester___024root___sequent__TOP__0(VQueueFactoryTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                         ...
                         & (((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                              ? 3U : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1))
                                       ? 2U : ((0x11U 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/2022032914532510409408704384238461/QueueFactoryTester.v", 494, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFactoryTester/2022032914532510409408704384238461/QueueFactoryTester.v", 517, "");
        }
    }
            ...
            = ((0x13U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                ? 3U : ((0x12U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                         ? 2U : ((0x11U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                  ? 6U : ((0x10U == (IData)(vlSelf->QueueFactoryTester__DOT__value))
                                           ? 3U : (
                                                   (0xfU 
