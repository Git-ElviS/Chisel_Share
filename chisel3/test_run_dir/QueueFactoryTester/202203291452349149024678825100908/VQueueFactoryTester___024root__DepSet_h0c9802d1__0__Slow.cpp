...
VL_ATTR_COLD void VQueueFactoryTester___024root___ctor_var_reset(VQueueFactoryTester___024root* vlSelf) {
    ...
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_0 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_1 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_2 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_3 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_4 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_5 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_6 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_7 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_8 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_9 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_10 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_11 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_12 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_13 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_14 = VL_RAND_RESET_I(1);
    vlSelf->QueueFactoryTester__DOT__deq_ready_prng__DOT__state_15 = VL_RAND_RESET_I(1);
