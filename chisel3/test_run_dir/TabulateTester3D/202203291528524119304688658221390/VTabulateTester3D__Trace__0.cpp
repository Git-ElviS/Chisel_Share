...
void VTabulateTester3D___024root__trace_chg_sub_0(VTabulateTester3D___024root* vlSelf, VerilatedVcd* tracep);

void VTabulateTester3D___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTabulateTester3D___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VTabulateTester3D___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VTabulateTester3D___024root__trace_chg_sub_0(VTabulateTester3D___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VTabulateTester3D__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTabulateTester3D___024root__trace_chg_sub_0\n"); );
    // Init
...
void VTabulateTester3D___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTabulateTester3D___024root__trace_cleanup\n"); );
    // Init
    VTabulateTester3D___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VTabulateTester3D___024root*>(voidSelf);
    VTabulateTester3D__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
