...
VL_ATTR_COLD void VParameterizedVendingMachineTester___024root___ctor_var_reset(VParameterizedVendingMachineTester___024root* vlSelf) {
    ...
    vlSelf->ParameterizedVendingMachineTester__DOT___GEN_102 = VL_RAND_RESET_I(4);
    vlSelf->ParameterizedVendingMachineTester__DOT___GEN_201 = VL_RAND_RESET_I(1);
    vlSelf->ParameterizedVendingMachineTester__DOT__dut__DOT__value = VL_RAND_RESET_I(8);
    vlSelf->ParameterizedVendingMachineTester__DOT__dut__DOT__doDispense = VL_RAND_RESET_I(1);
    vlSelf->ParameterizedVendingMachineTester__DOT__dut__DOT___value_T_1 = VL_RAND_RESET_I(8);
