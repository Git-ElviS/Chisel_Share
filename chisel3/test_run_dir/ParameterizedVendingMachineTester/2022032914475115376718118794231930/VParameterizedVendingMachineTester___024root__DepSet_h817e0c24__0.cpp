...
void VParameterizedVendingMachineTester___024root___sequent__TOP__0(VParameterizedVendingMachineTester___024root* vlSelf);
...
void VParameterizedVendingMachineTester___024root___eval(VParameterizedVendingMachineTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VParameterizedVendingMachineTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VParameterizedVendingMachineTester___024root___sequent__TOP__0(vlSelf);
...
void VParameterizedVendingMachineTester___024root___eval_debug_assertions(VParameterizedVendingMachineTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VParameterizedVendingMachineTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VParameterizedVendingMachineTester___024root___eval_debug_assertions\n"); );
    // Body
