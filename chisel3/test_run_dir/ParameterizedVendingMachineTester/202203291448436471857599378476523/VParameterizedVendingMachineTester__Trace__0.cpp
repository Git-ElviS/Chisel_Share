...
void VParameterizedVendingMachineTester___024root__trace_chg_sub_0(VParameterizedVendingMachineTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+1,((1U & ((IData)(vlSelf->ParameterizedVendingMachineTester__DOT___GEN_102) 
                                      >> 1U))));
        tracep->chgBit(oldp+2,((0x1edU <= (IData)(vlSelf->ParameterizedVendingMachineTester__DOT__dut__DOT__value))));
        ...
        tracep->chgSData(oldp+5,(vlSelf->ParameterizedVendingMachineTester__DOT__dut__DOT__value),10);
        tracep->chgSData(oldp+6,(((2U & (IData)(vlSelf->ParameterizedVendingMachineTester__DOT___GEN_102))
