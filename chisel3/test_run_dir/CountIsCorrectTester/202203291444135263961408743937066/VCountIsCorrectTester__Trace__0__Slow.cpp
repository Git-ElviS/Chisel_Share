...
VL_ATTR_COLD void VCountIsCorrectTester___024root__trace_full_sub_0(VCountIsCorrectTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,((1U & (~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__maybe_full)))));
    ...
    tracep->fullBit(oldp+3,((1U & ((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                   >> 2U))));
    tracep->fullBit(oldp+4,(vlSelf->CountIsCorrectTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+5,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_0));
    tracep->fullBit(oldp+6,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_1));
    tracep->fullBit(oldp+7,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_2));
    tracep->fullBit(oldp+8,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_3));
    tracep->fullBit(oldp+9,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_4));
    tracep->fullBit(oldp+10,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_5));
    tracep->fullBit(oldp+11,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_6));
    tracep->fullBit(oldp+12,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_7));
    tracep->fullBit(oldp+13,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_8));
    tracep->fullBit(oldp+14,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_9));
    tracep->fullBit(oldp+15,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_10));
    tracep->fullBit(oldp+16,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_11));
    tracep->fullBit(oldp+17,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_12));
    tracep->fullBit(oldp+18,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_13));
    tracep->fullBit(oldp+19,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_14));
    tracep->fullBit(oldp+20,(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_15));
    tracep->fullCData(oldp+21,(vlSelf->CountIsCorrectTester__DOT__value),5);
    tracep->fullCData(oldp+22,(vlSelf->CountIsCorrectTester__DOT__value_1),5);
    tracep->fullCData(oldp+23,((((IData)(vlSelf->CountIsCorrectTester__DOT__q_io_deq_ready_prng__DOT__state_7) 
    ...
    tracep->fullBit(oldp+24,((0x14U == (IData)(vlSelf->CountIsCorrectTester__DOT__value))));
    tracep->fullBit(oldp+25,((0x14U == (IData)(vlSelf->CountIsCorrectTester__DOT__value_1))));
    tracep->fullBit(oldp+26,(vlSelf->CountIsCorrectTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+27,((((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
