...
void VCountIsCorrectTester___024root__trace_chg_sub_0(VCountIsCorrectTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+4,((3U & ((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__ptr_match)
        ...
        tracep->chgBit(oldp+34,((2U == (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value))));
        tracep->chgBit(oldp+35,((2U == (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value))));
        tracep->chgCData(oldp+36,(vlSelf->CountIsCorrectTester__DOT__q__DOT__ptr_diff),2);
    }
