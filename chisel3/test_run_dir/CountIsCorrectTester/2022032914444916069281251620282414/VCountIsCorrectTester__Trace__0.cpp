...
void VCountIsCorrectTester___024root__trace_chg_sub_0(VCountIsCorrectTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+26,(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value));
        tracep->chgBit(oldp+27,(vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value));
        ...
        tracep->chgBit(oldp+32,(((~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->CountIsCorrectTester__DOT__value)))));
        tracep->chgBit(oldp+33,((1U & (((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                        >> 8U) & (~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__empty))))));
        tracep->chgBit(oldp+34,((1U & ((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
