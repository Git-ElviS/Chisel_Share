...
extern const VlUnpacked<CData/*2:0*/, 32> VCountIsCorrectTester__ConstPool__TABLE_hbab7df67_0;
extern const VlUnpacked<CData/*0:0*/, 32> VCountIsCorrectTester__ConstPool__TABLE_he56353c7_0;
extern const VlUnpacked<CData/*0:0*/, 32> VCountIsCorrectTester__ConstPool__TABLE_h2b6925bc_0;
extern const VlUnpacked<CData/*0:0*/, 32> VCountIsCorrectTester__ConstPool__TABLE_h6883b3c4_0;
...
VL_INLINE_OPT void VCountIsCorrectTester___024root___sequent__TOP__0(VCountIsCorrectTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__full)) 
                         ...
                         & (((((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__maybe_full) 
                               ...
                               ? 2U : 0U) | (1U & ((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
            ...
            VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:431: Assertion failed in %NCountIsCorrectTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/CountIsCorrectTester/2022032914444916069281251620282414/CountIsCorrectTester.v", 431, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__full)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                            >> 8U) & (~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__maybe_full) 
                               & (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__ptr_match))
                               ? 2U : 0U) | (1U & ((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
                            ...
                            != (0x1fU & ((IData)(vlSelf->CountIsCorrectTester__DOT__value) 
                                         - (IData)(vlSelf->CountIsCorrectTester__DOT__value_1))))))) {
            VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:454: Assertion failed in %NCountIsCorrectTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/CountIsCorrectTester/2022032914444916069281251620282414/CountIsCorrectTester.v", 454, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->CountIsCorrectTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/CountIsCorrectTester/2022032914444916069281251620282414/CountIsCorrectTester.v", 477, "");
        }
    }
    ...
    } else if ((1U & (((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                       >> 8U) & (~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__empty))))) {
    ...
    __Vtableidx1 = (((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value) 
                     << 4U) | ((8U & (((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                       >> 5U) & ((~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__empty)) 
                                                 << 3U))) 
                               | (((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
                                   << 2U) | ((((~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__full)) 
                                               & (0x14U 
                                                  > (IData)(vlSelf->CountIsCorrectTester__DOT__value))) 
                                              << 1U) 
                                             | (IData)(vlSelf->reset)))));
    if ((1U & VCountIsCorrectTester__ConstPool__TABLE_hbab7df67_0
         [__Vtableidx1])) {
        vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value 
            = VCountIsCorrectTester__ConstPool__TABLE_he56353c7_0
            [__Vtableidx1];
    }
    if ((2U & VCountIsCorrectTester__ConstPool__TABLE_hbab7df67_0
         [__Vtableidx1])) {
        vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value 
            = VCountIsCorrectTester__ConstPool__TABLE_h2b6925bc_0
            [__Vtableidx1];
    }
    if ((4U & VCountIsCorrectTester__ConstPool__TABLE_hbab7df67_0
         [__Vtableidx1])) {
        vlSelf->CountIsCorrectTester__DOT__q__DOT__maybe_full 
            = VCountIsCorrectTester__ConstPool__TABLE_h6883b3c4_0
            [__Vtableidx1];
    }
    ...
    } else if (vlSelf->CountIsCorrectTester__DOT___T) {
