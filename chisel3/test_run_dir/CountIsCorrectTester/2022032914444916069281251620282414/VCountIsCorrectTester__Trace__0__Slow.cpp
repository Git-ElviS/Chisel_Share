...
VL_ATTR_COLD void VCountIsCorrectTester___024root__trace_full_sub_0(VCountIsCorrectTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+27,(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value));
    tracep->fullBit(oldp+28,(vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value));
    ...
    tracep->fullBit(oldp+33,(((~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->CountIsCorrectTester__DOT__value)))));
    tracep->fullBit(oldp+34,((1U & (((IData)(vlSelf->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                     >> 8U) & (~ (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__empty))))));
    tracep->fullBit(oldp+35,((1U & ((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
