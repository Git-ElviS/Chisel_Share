...
VL_ATTR_COLD void VCountIsCorrectTester___024root__trace_init_sub__TOP__0(VCountIsCorrectTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+35,"wrap", false,-1);
    tracep->declBit(c+36,"wrap_1", false,-1);
...
VL_ATTR_COLD void VCountIsCorrectTester___024root__trace_full_sub_0(VCountIsCorrectTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+5,((3U & ((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__ptr_match)
                                      ...
                                      : (((IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value) 
                                          ...
                                          : (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__ptr_diff))))),2);
    ...
    tracep->fullBit(oldp+35,((2U == (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value))));
    tracep->fullBit(oldp+36,((2U == (IData)(vlSelf->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value))));
    tracep->fullCData(oldp+37,(vlSelf->CountIsCorrectTester__DOT__q__DOT__ptr_diff),2);
