...
void VStopTester___024root__trace_chg_sub_0(VStopTester___024root* vlSelf, VerilatedVcd* tracep);

void VStopTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStopTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VStopTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VStopTester___024root__trace_chg_sub_0(VStopTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VStopTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStopTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VStopTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStopTester___024root__trace_cleanup\n"); );
    // Init
    VStopTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VStopTester___024root*>(voidSelf);
    VStopTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
