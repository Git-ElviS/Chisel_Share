...
VL_INLINE_OPT void VShiftResetTester___024root___sequent__TOP__0(VShiftResetTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftResetTester__DOT__cntVal) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (1U != (IData)(vlSelf->ShiftResetTester__DOT__sr))))) {
            VL_WRITEF("[%0t] %%Error: ShiftResetTester.v:45: Assertion failed in %NShiftResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftResetTester/202203291501495518342055124982438/ShiftResetTester.v", 45, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftResetTester__DOT__cntVal) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->ShiftResetTester__DOT__cntVal) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftResetTester/202203291501495518342055124982438/ShiftResetTester.v", 68, "");
        }
    }
    if (vlSelf->reset) {
        ...
        vlSelf->ShiftResetTester__DOT__sr = vlSelf->ShiftResetTester__DOT__sr_r_1;
    ...
    vlSelf->ShiftResetTester__DOT__cntVal = ((~ (IData)(vlSelf->reset)) 
                                             & (IData)(vlSelf->ShiftResetTester__DOT___wrap_value_T_1));
    vlSelf->ShiftResetTester__DOT___wrap_value_T_1 
        = (1U & ((IData)(1U) + (IData)(vlSelf->ShiftResetTester__DOT__cntVal)));
}
