...
VL_ATTR_COLD void VShiftResetTester___024root__trace_init_sub__TOP__0(VShiftResetTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"sr_r_2", false,-1, 4,0);
    tracep->declBus(c+6,"sr", false,-1, 4,0);
...
VL_ATTR_COLD void VShiftResetTester___024root__trace_full_sub_0(VShiftResetTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullCData(oldp+1,(vlSelf->ShiftResetTester__DOT__cntVal),2);
    tracep->fullBit(oldp+2,((2U == (IData)(vlSelf->ShiftResetTester__DOT__cntVal))));
    tracep->fullCData(oldp+3,(vlSelf->ShiftResetTester__DOT__sr_r),5);
    tracep->fullCData(oldp+4,(vlSelf->ShiftResetTester__DOT__sr_r_1),5);
    tracep->fullCData(oldp+5,(vlSelf->ShiftResetTester__DOT__sr_r_2),5);
    tracep->fullCData(oldp+6,(vlSelf->ShiftResetTester__DOT__sr),5);
