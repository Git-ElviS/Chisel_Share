...
void VShiftResetTester___024root__trace_chg_sub_0(VShiftResetTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgCData(oldp+0,(vlSelf->ShiftResetTester__DOT__cntVal),2);
        tracep->chgBit(oldp+1,((2U == (IData)(vlSelf->ShiftResetTester__DOT__cntVal))));
        tracep->chgCData(oldp+2,(vlSelf->ShiftResetTester__DOT__sr_r),5);
        tracep->chgCData(oldp+3,(vlSelf->ShiftResetTester__DOT__sr_r_1),5);
        tracep->chgCData(oldp+4,(vlSelf->ShiftResetTester__DOT__sr_r_2),5);
        tracep->chgCData(oldp+5,(vlSelf->ShiftResetTester__DOT__sr),5);
    }
