...
VL_INLINE_OPT void VShiftResetTester___024root___sequent__TOP__0(VShiftResetTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((2U == (IData)(vlSelf->ShiftResetTester__DOT__cntVal)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftResetTester/202203291502063289100643713258402/ShiftResetTester.v", 55, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((2U == (IData)(vlSelf->ShiftResetTester__DOT__cntVal)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((2U == (IData)(vlSelf->ShiftResetTester__DOT__cntVal)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftResetTester/202203291502063289100643713258402/ShiftResetTester.v", 78, "");
        }
    }
    if (vlSelf->reset) {
