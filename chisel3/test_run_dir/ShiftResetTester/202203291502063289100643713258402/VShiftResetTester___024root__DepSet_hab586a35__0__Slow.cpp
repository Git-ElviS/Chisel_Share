...
VL_ATTR_COLD void VShiftResetTester___024root___settle__TOP__0(VShiftResetTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VShiftResetTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VShiftResetTester___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void VShiftResetTester___024root___eval_settle(VShiftResetTester___024root* vlSelf) {
    ...
    // Body
    VShiftResetTester___024root___settle__TOP__0(vlSelf);
}
...
VL_ATTR_COLD void VShiftResetTester___024root___ctor_var_reset(VShiftResetTester___024root* vlSelf) {
    ...
    vlSelf->ShiftResetTester__DOT__cntVal = VL_RAND_RESET_I(2);
    vlSelf->ShiftResetTester__DOT__wrap_wrap = VL_RAND_RESET_I(1);
    vlSelf->ShiftResetTester__DOT___wrap_value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->ShiftResetTester__DOT__sr_r = VL_RAND_RESET_I(5);
    vlSelf->ShiftResetTester__DOT__sr_r_1 = VL_RAND_RESET_I(5);
    vlSelf->ShiftResetTester__DOT__sr_r_2 = VL_RAND_RESET_I(5);
