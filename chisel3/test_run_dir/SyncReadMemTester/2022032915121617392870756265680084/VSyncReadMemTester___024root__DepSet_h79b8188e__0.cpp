...
void VSyncReadMemTester___024root___sequent__TOP__0(VSyncReadMemTester___024root* vlSelf);
...
void VSyncReadMemTester___024root___eval(VSyncReadMemTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSyncReadMemTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VSyncReadMemTester___024root___sequent__TOP__0(vlSelf);
...
void VSyncReadMemTester___024root___eval_debug_assertions(VSyncReadMemTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSyncReadMemTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSyncReadMemTester___024root___eval_debug_assertions\n"); );
    // Body
