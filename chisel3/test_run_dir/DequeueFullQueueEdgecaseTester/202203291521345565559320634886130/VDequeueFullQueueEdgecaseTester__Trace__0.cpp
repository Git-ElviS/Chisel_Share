...
void VDequeueFullQueueEdgecaseTester___024root__trace_chg_sub_0(VDequeueFullQueueEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+12,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[0]),4);
        tracep->chgCData(oldp+13,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[1]),4);
        tracep->chgCData(oldp+14,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[2]),4);
