...
VL_ATTR_COLD void VDequeueFullQueueEdgecaseTester___024root__trace_init_sub__TOP__0(VDequeueFullQueueEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 3; ++i) {
        tracep->declBus(c+13+i*1,"ram", true,(i+0), 3,0);
    }
...
VL_ATTR_COLD void VDequeueFullQueueEdgecaseTester___024root__trace_full_sub_0(VDequeueFullQueueEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+13,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[0]),4);
    tracep->fullCData(oldp+14,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[1]),4);
    tracep->fullCData(oldp+15,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[2]),4);
