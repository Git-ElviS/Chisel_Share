...
VL_ATTR_COLD void VDequeueFullQueueEdgecaseTester___024root__trace_full_sub_0(VDequeueFullQueueEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram
                              [vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__deq_ptr_value]),3);
    ...
    tracep->fullCData(oldp+16,(vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[3]),3);
