...
VL_MODULE(VDequeueFullQueueEdgecaseTester___024root) {
  public:
    ...
    CData/*2:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT__enq_ptr_value;
    CData/*2:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT__deq_ptr_value;
    ...
    CData/*2:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT___value_T_1;
    CData/*0:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT__wrap_1;
    CData/*2:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT___value_T_3;
    CData/*2:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT__ptr_diff;
    CData/*1:0*/ DequeueFullQueueEdgecaseTester__DOT__q__DOT____Vlvbound_he487b7cc__0;
    CData/*0:0*/ __Vclklast__TOP__clock;
    VlUnpacked<CData/*1:0*/, 5> DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram;
