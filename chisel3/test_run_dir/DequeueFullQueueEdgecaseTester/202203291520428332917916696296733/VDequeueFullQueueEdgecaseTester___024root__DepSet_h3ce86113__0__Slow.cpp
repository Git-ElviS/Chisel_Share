...
VL_ATTR_COLD void VDequeueFullQueueEdgecaseTester___024root___ctor_var_reset(VDequeueFullQueueEdgecaseTester___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(3);
    }
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    ...
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT__ptr_diff = VL_RAND_RESET_I(2);
    vlSelf->DequeueFullQueueEdgecaseTester__DOT__q__DOT____Vlvbound_he64e4fbc__0 = VL_RAND_RESET_I(3);
