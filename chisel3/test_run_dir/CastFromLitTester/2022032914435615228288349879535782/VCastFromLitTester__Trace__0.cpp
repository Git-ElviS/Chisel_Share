...
void VCastFromLitTester___024root__trace_chg_sub_0(VCastFromLitTester___024root* vlSelf, VerilatedVcd* tracep);

void VCastFromLitTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCastFromLitTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VCastFromLitTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VCastFromLitTester___024root__trace_chg_sub_0(VCastFromLitTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VCastFromLitTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCastFromLitTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VCastFromLitTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCastFromLitTester___024root__trace_cleanup\n"); );
    // Init
    VCastFromLitTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VCastFromLitTester___024root*>(voidSelf);
    VCastFromLitTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
