...
void VBasicRotate___024root___sequent__TOP__0(VBasicRotate___024root* vlSelf);
...
void VBasicRotate___024root___eval(VBasicRotate___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBasicRotate___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VBasicRotate___024root___sequent__TOP__0(vlSelf);
...
void VBasicRotate___024root___eval_debug_assertions(VBasicRotate___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VBasicRotate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBasicRotate___024root___eval_debug_assertions\n"); );
    // Body
