...
void VDetectTwoOnesTester___024root___sequent__TOP__0(VDetectTwoOnesTester___024root* vlSelf);
...
void VDetectTwoOnesTester___024root___eval(VDetectTwoOnesTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VDetectTwoOnesTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VDetectTwoOnesTester___024root___sequent__TOP__0(vlSelf);
...
void VDetectTwoOnesTester___024root___eval_debug_assertions(VDetectTwoOnesTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VDetectTwoOnesTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VDetectTwoOnesTester___024root___eval_debug_assertions\n"); );
    // Body
