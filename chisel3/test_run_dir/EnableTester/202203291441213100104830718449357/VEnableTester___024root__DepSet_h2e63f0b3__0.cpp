...
VL_INLINE_OPT void VEnableTester___024root___sequent__TOP__0(VEnableTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0x20U == (IData)(vlSelf->EnableTester__DOT__done_value)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EnableTester/202203291441213100104830718449357/EnableTester.v", 40, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0x20U == (IData)(vlSelf->EnableTester__DOT__done_value)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x20U == (IData)(vlSelf->EnableTester__DOT__done_value)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EnableTester/202203291441213100104830718449357/EnableTester.v", 63, "");
        }
    }
    if (vlSelf->reset) {
        __Vdly__EnableTester__DOT__ens = 0x3531320fU;
