...
VL_INLINE_OPT void VEnableTester___024root___sequent__TOP__0(VEnableTester___024root* vlSelf) {
    ...
    // Init
    IData/*27:0*/ __Vdly__EnableTester__DOT__ens;
    // Body
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0x20U == (IData)(vlSelf->EnableTester__DOT__done_value)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0xfU != (IData)(vlSelf->EnableTester__DOT__cntEnVal))))) {
            VL_WRITEF("[%0t] %%Error: EnableTester.v:40: Assertion failed in %NEnableTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EnableTester/202203291442118050213528201915285/EnableTester.v", 40, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0x20U == (IData)(vlSelf->EnableTester__DOT__done_value)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x20U == (IData)(vlSelf->EnableTester__DOT__done_value)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EnableTester/202203291442118050213528201915285/EnableTester.v", 63, "");
        }
    }
    if (vlSelf->reset) {
        __Vdly__EnableTester__DOT__ens = 0xfe8a923U;
        vlSelf->EnableTester__DOT__cntEnVal = 0U;
        vlSelf->EnableTester__DOT__done_value = 0U;
    } else {
        __Vdly__EnableTester__DOT__ens = (0x7ffffffU 
