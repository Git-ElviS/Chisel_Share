...
void VMultiExtModuleTester___024root__trace_chg_sub_0(VMultiExtModuleTester___024root* vlSelf, VerilatedVcd* tracep);

void VMultiExtModuleTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiExtModuleTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VMultiExtModuleTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VMultiExtModuleTester___024root__trace_chg_sub_0(VMultiExtModuleTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMultiExtModuleTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiExtModuleTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VMultiExtModuleTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiExtModuleTester___024root__trace_cleanup\n"); );
    // Init
    VMultiExtModuleTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VMultiExtModuleTester___024root*>(voidSelf);
    VMultiExtModuleTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
