...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+45,"clock", false,-1);
    tracep->declBit(c+46,"reset", false,-1);
    tracep->declBit(c+45,"q_clock", false,-1);
    tracep->declBit(c+46,"q_reset", false,-1);
    ...
    tracep->declBit(c+45,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+46,"q_io_deq_ready_prng_reset", false,-1);
    ...
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+31+i*1,"ram", true,(i+0), 2,0);
    }
    tracep->declBit(c+47,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBus(c+35,"ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
    tracep->declBus(c+6,"ram_io_deq_bits_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+3,"ram_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+36,"ram_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+47,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+37,"ram_MPORT_en", false,-1);
    tracep->declBus(c+36,"enq_ptr_value", false,-1, 1,0);
    tracep->declBus(c+35,"deq_ptr_value", false,-1, 1,0);
    tracep->declBit(c+38,"maybe_full", false,-1);
    tracep->declBit(c+39,"ptr_match", false,-1);
    tracep->declBit(c+40,"empty", false,-1);
    tracep->declBit(c+41,"full", false,-1);
    tracep->declBit(c+42,"do_enq", false,-1);
    tracep->declBit(c+43,"do_deq", false,-1);
    tracep->declBus(c+44,"ptr_diff", false,-1, 1,0);
...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_full_sub_0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram
                              [vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value]),3);
    tracep->fullCData(oldp+7,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_count),3);
    tracep->fullBit(oldp+8,((4U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__currQCnt))));
    ...
    tracep->fullCData(oldp+31,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[0]),3);
    tracep->fullCData(oldp+32,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[1]),3);
    tracep->fullCData(oldp+33,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[2]),3);
    tracep->fullCData(oldp+34,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[3]),3);
    tracep->fullCData(oldp+35,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value),2);
    tracep->fullCData(oldp+36,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullBit(oldp+37,(((~ (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value)))));
    tracep->fullBit(oldp+38,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+39,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+40,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+41,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+42,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+43,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_deq));
    tracep->fullCData(oldp+44,((3U & ((IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value) 
                                      - (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value)))),2);
    tracep->fullBit(oldp+45,(vlSelf->clock));
    tracep->fullBit(oldp+46,(vlSelf->reset));
    tracep->fullBit(oldp+47,(1U));
}
