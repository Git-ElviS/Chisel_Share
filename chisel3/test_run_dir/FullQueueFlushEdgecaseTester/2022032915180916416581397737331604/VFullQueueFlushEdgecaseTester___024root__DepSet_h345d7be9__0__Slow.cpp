...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root___ctor_var_reset(VFullQueueFlushEdgecaseTester___024root* vlSelf) {
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_count = VL_RAND_RESET_I(3);
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT___GEN_42 = VL_RAND_RESET_I(3);
    ...
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(3);
    }
