...
void VFullQueueFlushEdgecaseTester___024root__trace_chg_sub_0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+6,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_count),3);
        tracep->chgBit(oldp+7,((4U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__currQCnt))));
        ...
        tracep->chgCData(oldp+30,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[0]),3);
        tracep->chgCData(oldp+31,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[1]),3);
        tracep->chgCData(oldp+32,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[2]),3);
        tracep->chgCData(oldp+33,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[3]),3);
        tracep->chgCData(oldp+34,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->chgCData(oldp+35,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value),2);
        tracep->chgBit(oldp+36,(((~ (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value)))));
        tracep->chgBit(oldp+37,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+38,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+39,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+40,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+41,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+42,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_deq));
        tracep->chgCData(oldp+43,((3U & ((IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value) 
                                         - (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value)))),2);
    }
    tracep->chgBit(oldp+44,(vlSelf->clock));
    tracep->chgBit(oldp+45,(vlSelf->reset));
}
