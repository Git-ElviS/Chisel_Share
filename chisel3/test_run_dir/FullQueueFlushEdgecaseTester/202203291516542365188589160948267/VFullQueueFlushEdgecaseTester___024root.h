...
VL_MODULE(VFullQueueFlushEdgecaseTester___024root) {
  public:
    ...
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value;
    ...
    VlUnpacked<CData/*3:0*/, 2> FullQueueFlushEdgecaseTester__DOT__q__DOT__ram;
