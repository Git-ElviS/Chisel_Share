...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 3; ++i) {
        tracep->declBit(c+31+i*1,"ram", true,(i+0));
    }
    tracep->declBit(c+48,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBus(c+34,"ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+6,"ram_io_deq_bits_MPORT_data", false,-1);
    tracep->declBit(c+3,"ram_MPORT_data", false,-1);
    tracep->declBus(c+35,"ram_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+48,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+36,"ram_MPORT_en", false,-1);
    tracep->declBus(c+35,"enq_ptr_value", false,-1, 1,0);
    tracep->declBus(c+34,"deq_ptr_value", false,-1, 1,0);
    ...
    tracep->declBit(c+43,"wrap", false,-1);
    tracep->declBit(c+44,"wrap_1", false,-1);
    tracep->declBus(c+45,"ptr_diff", false,-1, 1,0);
...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_full_sub_0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+3,(((0x13U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value)) 
    ...
    tracep->fullBit(oldp+6,(((2U >= (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value)) 
    ...
    tracep->fullBit(oldp+8,((3U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__currQCnt))));
    ...
    tracep->fullBit(oldp+31,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[0]));
    tracep->fullBit(oldp+32,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[1]));
    tracep->fullBit(oldp+33,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[2]));
    tracep->fullCData(oldp+34,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value),2);
    tracep->fullCData(oldp+35,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullBit(oldp+36,(((~ (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value)))));
    tracep->fullBit(oldp+37,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+38,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+39,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+40,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+41,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+42,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_deq));
    tracep->fullBit(oldp+43,((2U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value))));
    tracep->fullBit(oldp+44,((2U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))));
    tracep->fullCData(oldp+45,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_diff),2);
