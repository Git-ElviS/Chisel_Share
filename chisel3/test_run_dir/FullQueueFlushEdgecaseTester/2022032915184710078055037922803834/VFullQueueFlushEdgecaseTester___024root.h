...
VL_MODULE(VFullQueueFlushEdgecaseTester___024root) {
  public:
    ...
    VL_IN8(clock,0,0);
    VL_IN8(reset,0,0);
    CData/*1:0*/ FullQueueFlushEdgecaseTester__DOT__q_io_count;
    ...
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT___GEN_40;
    ...
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT___GEN_64;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT___GEN_67;
    CData/*1:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value;
    CData/*1:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_match;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__empty;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__full;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__do_enq;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__do_deq;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__wrap;
    CData/*1:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT___value_T_1;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__wrap_1;
    CData/*1:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT___value_T_3;
    CData/*1:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_diff;
    CData/*0:0*/ FullQueueFlushEdgecaseTester__DOT__q__DOT____Vlvbound_hd270ee13__0;
    ...
    VlUnpacked<CData/*0:0*/, 3> FullQueueFlushEdgecaseTester__DOT__q__DOT__ram;
