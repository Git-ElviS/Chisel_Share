...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root___settle__TOP__0(VFullQueueFlushEdgecaseTester___024root* vlSelf) {
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT___GEN_67 
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT___T = 
        ((~ (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__full)) 
         & (0x14U > (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value)));
    vlSelf->FullQueueFlushEdgecaseTester__DOT___GEN_64 
...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root___ctor_var_reset(VFullQueueFlushEdgecaseTester___024root* vlSelf) {
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT___GEN_40 = VL_RAND_RESET_I(1);
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT___GEN_64 = VL_RAND_RESET_I(1);
    vlSelf->FullQueueFlushEdgecaseTester__DOT___GEN_67 = VL_RAND_RESET_I(1);
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(1);
    }
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    ...
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__wrap = VL_RAND_RESET_I(1);
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ptr_diff = VL_RAND_RESET_I(2);
    vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT____Vlvbound_hd270ee13__0 = VL_RAND_RESET_I(1);
