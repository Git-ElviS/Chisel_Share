...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+34,"clock", false,-1);
    tracep->declBit(c+35,"reset", false,-1);
    tracep->declBit(c+34,"q_clock", false,-1);
    tracep->declBit(c+35,"q_reset", false,-1);
    ...
    tracep->declBit(c+34,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+35,"q_io_deq_ready_prng_reset", false,-1);
    ...
    tracep->declBus(c+26,"currQCnt", false,-1, 2,0);
    ...
    for (int i = 0; i < 1; ++i) {
        tracep->declBus(c+30+i*1,"ram", true,(i+0), 2,0);
    }
    tracep->declBit(c+36,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBit(c+37,"ram_io_deq_bits_MPORT_addr", false,-1);
    ...
    tracep->declBit(c+36,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+31,"ram_MPORT_en", false,-1);
    tracep->declBit(c+5,"maybe_full", false,-1);
    tracep->declBit(c+1,"empty", false,-1);
    tracep->declBit(c+32,"do_enq", false,-1);
    tracep->declBit(c+33,"do_deq", false,-1);
...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_full_sub_0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,((1U & (~ (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full)))));
    ...
    tracep->fullBit(oldp+4,((1U & ((IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT___q_io_deq_ready_T) 
                                   >> 0xcU))));
    tracep->fullBit(oldp+5,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full));
    tracep->fullCData(oldp+6,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram
                              [0U]),3);
    tracep->fullBit(oldp+7,((1U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__currQCnt))));
    tracep->fullBit(oldp+8,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_0));
    tracep->fullBit(oldp+9,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_1));
    tracep->fullBit(oldp+10,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_2));
    tracep->fullBit(oldp+11,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_3));
    tracep->fullBit(oldp+12,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_4));
    tracep->fullBit(oldp+13,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_5));
    tracep->fullBit(oldp+14,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_6));
    tracep->fullBit(oldp+15,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_7));
    tracep->fullBit(oldp+16,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_8));
    tracep->fullBit(oldp+17,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_9));
    tracep->fullBit(oldp+18,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_10));
    tracep->fullBit(oldp+19,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_11));
    tracep->fullBit(oldp+20,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_12));
    tracep->fullBit(oldp+21,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_13));
    tracep->fullBit(oldp+22,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_14));
    tracep->fullBit(oldp+23,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_15));
    tracep->fullCData(oldp+24,(vlSelf->FullQueueFlushEdgecaseTester__DOT__value),5);
    tracep->fullCData(oldp+25,(vlSelf->FullQueueFlushEdgecaseTester__DOT__outCnt),5);
    tracep->fullCData(oldp+26,(vlSelf->FullQueueFlushEdgecaseTester__DOT__currQCnt),3);
    tracep->fullBit(oldp+27,(vlSelf->FullQueueFlushEdgecaseTester__DOT__flushRegister));
    tracep->fullCData(oldp+28,((((IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q_io_deq_ready_prng__DOT__state_7) 
    ...
    tracep->fullBit(oldp+29,((0x14U == (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value))));
    tracep->fullCData(oldp+30,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[0]),3);
    tracep->fullBit(oldp+31,(((~ (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full)) 
                              & (0x14U > (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__value)))));
    tracep->fullBit(oldp+32,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+33,((((IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT___q_io_deq_ready_T) 
                               >> 0xcU) & (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__maybe_full))));
    tracep->fullBit(oldp+34,(vlSelf->clock));
    tracep->fullBit(oldp+35,(vlSelf->reset));
    tracep->fullBit(oldp+36,(1U));
