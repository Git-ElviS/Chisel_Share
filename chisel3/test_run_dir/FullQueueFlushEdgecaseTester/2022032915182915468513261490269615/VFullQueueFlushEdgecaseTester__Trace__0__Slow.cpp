...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 3; ++i) {
        tracep->declBus(c+31+i*1,"ram", true,(i+0), 3,0);
    }
...
VL_ATTR_COLD void VFullQueueFlushEdgecaseTester___024root__trace_full_sub_0(VFullQueueFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,(((2U >= (IData)(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))
    ...
    tracep->fullCData(oldp+31,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[0]),4);
    tracep->fullCData(oldp+32,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[1]),4);
    tracep->fullCData(oldp+33,(vlSelf->FullQueueFlushEdgecaseTester__DOT__q__DOT__ram[2]),4);
