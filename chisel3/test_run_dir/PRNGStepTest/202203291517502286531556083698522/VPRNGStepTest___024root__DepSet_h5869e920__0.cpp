...
void VPRNGStepTest___024root___sequent__TOP__0(VPRNGStepTest___024root* vlSelf);
...
void VPRNGStepTest___024root___eval(VPRNGStepTest___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPRNGStepTest___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VPRNGStepTest___024root___sequent__TOP__0(vlSelf);
...
void VPRNGStepTest___024root___eval_debug_assertions(VPRNGStepTest___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VPRNGStepTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VPRNGStepTest___024root___eval_debug_assertions\n"); );
    // Body
