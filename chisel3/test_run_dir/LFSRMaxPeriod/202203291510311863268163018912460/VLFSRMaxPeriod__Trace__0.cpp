...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),6);
        tracep->chgCData(oldp+14,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
        ...
        tracep->chgSData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__rv),13);
        tracep->chgBit(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgSData(oldp+17,(vlSelf->LFSRMaxPeriod__DOT__seed),13);
        tracep->chgSData(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),13);
        tracep->chgBit(oldp+19,((0x1ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+20,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x1ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgSData(oldp+21,(vlSelf->LFSRMaxPeriod__DOT__last),13);
    }
    tracep->chgBit(oldp+22,(vlSelf->clock));
    tracep->chgBit(oldp+23,(vlSelf->reset));
}
