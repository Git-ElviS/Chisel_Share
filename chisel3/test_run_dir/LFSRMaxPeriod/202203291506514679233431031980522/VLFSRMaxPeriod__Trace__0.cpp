...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+5,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                   << 1U) | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0))),2);
        tracep->chgCData(oldp+6,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
                                   << 2U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
                                              << 1U) 
                                             | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2)))),3);
        tracep->chgCData(oldp+7,(vlSelf->LFSRMaxPeriod__DOT__rv),5);
        tracep->chgBit(oldp+8,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgCData(oldp+9,(vlSelf->LFSRMaxPeriod__DOT__seed),5);
        tracep->chgCData(oldp+10,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),5);
        tracep->chgBit(oldp+11,((0x1eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+12,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x1eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgCData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__last),5);
    }
