...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+26,"clock", false,-1);
    tracep->declBit(c+27,"reset", false,-1);
    tracep->declBit(c+26,"rv_prng_clock", false,-1);
    tracep->declBit(c+27,"rv_prng_reset", false,-1);
    ...
    tracep->declBit(c+13,"rv_prng_io_out_12", false,-1);
    tracep->declBit(c+14,"rv_prng_io_out_13", false,-1);
    tracep->declBit(c+15,"rv_prng_io_out_14", false,-1);
    tracep->declBit(c+16,"rv_prng_io_out_15", false,-1);
    tracep->declBus(c+17,"rv_lo", false,-1, 7,0);
    tracep->declBus(c+18,"rv_hi", false,-1, 7,0);
    tracep->declBus(c+19,"rv", false,-1, 15,0);
    tracep->declBit(c+20,"started", false,-1);
    tracep->declBus(c+21,"seed", false,-1, 15,0);
    tracep->declBus(c+22,"wrap_value", false,-1, 15,0);
    tracep->declBit(c+23,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+24,"wrap", false,-1);
    tracep->declBus(c+25,"last", false,-1, 15,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12));
    tracep->fullBit(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13));
    tracep->fullBit(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14));
    tracep->fullBit(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_15));
    tracep->fullCData(oldp+17,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),8);
    tracep->fullCData(oldp+18,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_15) 
                                 << 7U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14) 
                                            << 6U) 
                                                 ...
                                                 | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11) 
                                                    ...
                                                    | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                                       ...
                                                       | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                           << 1U) 
                                                          | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8))))))))),8);
    tracep->fullSData(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__rv),16);
    tracep->fullBit(oldp+20,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullSData(oldp+21,(vlSelf->LFSRMaxPeriod__DOT__seed),16);
    tracep->fullSData(oldp+22,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),16);
    tracep->fullBit(oldp+23,((0xfffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+24,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0xfffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullSData(oldp+25,(vlSelf->LFSRMaxPeriod__DOT__last),16);
    tracep->fullBit(oldp+26,(vlSelf->clock));
