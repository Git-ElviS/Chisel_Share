...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+25,"clock", false,-1);
    tracep->declBit(c+26,"reset", false,-1);
    tracep->declBit(c+25,"rv_prng_clock", false,-1);
    tracep->declBit(c+26,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+16,"rv_lo", false,-1, 6,0);
    tracep->declBus(c+17,"rv_hi", false,-1, 7,0);
    tracep->declBus(c+18,"rv", false,-1, 14,0);
    tracep->declBit(c+19,"started", false,-1);
    tracep->declBus(c+20,"seed", false,-1, 14,0);
    tracep->declBus(c+21,"wrap_value", false,-1, 14,0);
    tracep->declBit(c+22,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+23,"wrap", false,-1);
    tracep->declBus(c+24,"last", false,-1, 14,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),7);
    tracep->fullCData(oldp+17,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14) 
                                 << 7U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13) 
                                            << 6U) 
                                                 ...
                                                 | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                                    ...
                                                    | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                       ...
                                                       | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                                           << 1U) 
                                                          | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7))))))))),8);
    tracep->fullSData(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__rv),15);
    tracep->fullBit(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullSData(oldp+20,(vlSelf->LFSRMaxPeriod__DOT__seed),15);
    tracep->fullSData(oldp+21,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),15);
    tracep->fullBit(oldp+22,((0x7ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+23,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x7ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullSData(oldp+24,(vlSelf->LFSRMaxPeriod__DOT__last),15);
    tracep->fullBit(oldp+25,(vlSelf->clock));
