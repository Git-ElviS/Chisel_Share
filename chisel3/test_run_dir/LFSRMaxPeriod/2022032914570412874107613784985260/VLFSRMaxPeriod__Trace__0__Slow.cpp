...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+20,"clock", false,-1);
    tracep->declBit(c+21,"reset", false,-1);
    tracep->declBit(c+20,"rv_prng_clock", false,-1);
    tracep->declBit(c+21,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+11,"rv_lo", false,-1, 4,0);
    tracep->declBus(c+12,"rv_hi", false,-1, 4,0);
    tracep->declBus(c+13,"rv", false,-1, 9,0);
    tracep->declBit(c+14,"started", false,-1);
    tracep->declBus(c+15,"seed", false,-1, 9,0);
    tracep->declBus(c+16,"wrap_value", false,-1, 9,0);
    tracep->declBit(c+17,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+18,"wrap", false,-1);
    tracep->declBus(c+19,"last", false,-1, 9,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+11,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
    ...
    tracep->fullCData(oldp+12,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
    ...
    tracep->fullSData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__rv),10);
    tracep->fullBit(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullSData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__seed),10);
    tracep->fullSData(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),10);
    tracep->fullBit(oldp+17,((0x3feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+18,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x3feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullSData(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__last),10);
    tracep->fullBit(oldp+20,(vlSelf->clock));
    tracep->fullBit(oldp+21,(vlSelf->reset));
}
