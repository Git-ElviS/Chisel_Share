...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+19,"clock", false,-1);
    tracep->declBit(c+20,"reset", false,-1);
    tracep->declBit(c+19,"rv_prng_clock", false,-1);
    tracep->declBit(c+20,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+10,"rv_lo", false,-1, 3,0);
    tracep->declBus(c+11,"rv_hi", false,-1, 4,0);
    tracep->declBus(c+12,"rv", false,-1, 8,0);
    tracep->declBit(c+13,"started", false,-1);
    tracep->declBus(c+14,"seed", false,-1, 8,0);
    tracep->declBus(c+15,"wrap_value", false,-1, 8,0);
    tracep->declBit(c+16,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+17,"wrap", false,-1);
    tracep->declBus(c+18,"last", false,-1, 8,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+10,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
    ...
    tracep->fullCData(oldp+11,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                 << 4U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7) 
                                            << 3U) 
                                           | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6) 
                                               << 2U) 
                                              | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_5) 
                                                  << 1U) 
                                                 | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4)))))),5);
    tracep->fullSData(oldp+12,(vlSelf->LFSRMaxPeriod__DOT__rv),9);
    tracep->fullBit(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullSData(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__seed),9);
    tracep->fullSData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),9);
    tracep->fullBit(oldp+16,((0x1feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+17,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x1feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullSData(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__last),9);
