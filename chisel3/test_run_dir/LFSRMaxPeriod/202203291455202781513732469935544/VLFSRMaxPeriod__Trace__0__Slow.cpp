...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+17,"clock", false,-1);
    tracep->declBit(c+18,"reset", false,-1);
    tracep->declBit(c+17,"rv_prng_clock", false,-1);
    tracep->declBit(c+18,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+8,"rv_lo", false,-1, 2,0);
    tracep->declBus(c+9,"rv_hi", false,-1, 3,0);
    tracep->declBus(c+10,"rv", false,-1, 6,0);
    tracep->declBit(c+11,"started", false,-1);
    tracep->declBus(c+12,"seed", false,-1, 6,0);
    tracep->declBus(c+13,"wrap_value", false,-1, 6,0);
    tracep->declBit(c+14,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+15,"wrap", false,-1);
    tracep->declBus(c+16,"last", false,-1, 6,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+8,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
                                << 2U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                           << 1U) | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))),3);
    tracep->fullCData(oldp+9,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6) 
                                << 3U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_5) 
                                           << 2U) | 
                                          (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
                                            << 1U) 
                                           | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3))))),4);
    tracep->fullCData(oldp+10,(vlSelf->LFSRMaxPeriod__DOT__rv),7);
    tracep->fullBit(oldp+11,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullCData(oldp+12,(vlSelf->LFSRMaxPeriod__DOT__seed),7);
    tracep->fullCData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),7);
    tracep->fullBit(oldp+14,((0x7eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+15,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x7eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullCData(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__last),7);
    tracep->fullBit(oldp+17,(vlSelf->clock));
