...
VL_ATTR_COLD void VLFSRMaxPeriod___024root___ctor_var_reset(VLFSRMaxPeriod___024root* vlSelf) {
    ...
    vlSelf->LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(5);
    vlSelf->LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    vlSelf->LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(5);
    vlSelf->LFSRMaxPeriod__DOT__wrap_value = VL_RAND_RESET_I(5);
    vlSelf->LFSRMaxPeriod__DOT__wrap_wrap_wrap = VL_RAND_RESET_I(1);
    vlSelf->LFSRMaxPeriod__DOT___wrap_wrap_value_T_1 = VL_RAND_RESET_I(5);
    vlSelf->LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(5);
