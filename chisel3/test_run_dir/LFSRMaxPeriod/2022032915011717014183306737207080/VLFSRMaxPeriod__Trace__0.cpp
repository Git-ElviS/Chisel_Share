...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+6,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
                                   << 2U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                              << 1U) 
                                             | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))),3);
        tracep->chgCData(oldp+7,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_5) 
                                   << 2U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
                                              << 1U) 
                                             | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3)))),3);
        tracep->chgCData(oldp+8,(vlSelf->LFSRMaxPeriod__DOT__rv),6);
        tracep->chgBit(oldp+9,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgCData(oldp+10,(vlSelf->LFSRMaxPeriod__DOT__seed),6);
        tracep->chgCData(oldp+11,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),6);
        tracep->chgBit(oldp+12,((0x3eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+13,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x3eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgCData(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__last),6);
    }
