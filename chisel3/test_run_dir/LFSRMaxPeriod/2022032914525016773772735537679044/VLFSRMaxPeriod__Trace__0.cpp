...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),7);
        tracep->chgCData(oldp+16,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14) 
        ...
        tracep->chgSData(oldp+17,(vlSelf->LFSRMaxPeriod__DOT__rv),15);
        tracep->chgBit(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgSData(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__seed),15);
        tracep->chgSData(oldp+20,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),15);
        tracep->chgBit(oldp+21,((0x7ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+22,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x7ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgSData(oldp+23,(vlSelf->LFSRMaxPeriod__DOT__last),15);
    }
    tracep->chgBit(oldp+24,(vlSelf->clock));
