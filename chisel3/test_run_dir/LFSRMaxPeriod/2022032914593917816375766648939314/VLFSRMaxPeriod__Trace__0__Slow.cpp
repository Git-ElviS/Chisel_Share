...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+10,"clock", false,-1);
    tracep->declBit(c+11,"reset", false,-1);
    tracep->declBit(c+10,"rv_prng_clock", false,-1);
    tracep->declBit(c+11,"rv_prng_reset", false,-1);
    tracep->declBit(c+1,"rv_prng_io_out_0", false,-1);
    tracep->declBit(c+2,"rv_prng_io_out_1", false,-1);
    tracep->declBus(c+3,"rv", false,-1, 1,0);
    tracep->declBit(c+4,"started", false,-1);
    tracep->declBus(c+5,"seed", false,-1, 1,0);
    tracep->declBus(c+6,"wrap_value", false,-1, 1,0);
    tracep->declBit(c+7,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+8,"wrap", false,-1);
    tracep->declBus(c+9,"last", false,-1, 1,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+3,(vlSelf->LFSRMaxPeriod__DOT__rv),2);
    tracep->fullBit(oldp+4,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullCData(oldp+5,(vlSelf->LFSRMaxPeriod__DOT__seed),2);
    tracep->fullCData(oldp+6,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),2);
    tracep->fullBit(oldp+7,((2U == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+8,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                             & (2U == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullCData(oldp+9,(vlSelf->LFSRMaxPeriod__DOT__last),2);
