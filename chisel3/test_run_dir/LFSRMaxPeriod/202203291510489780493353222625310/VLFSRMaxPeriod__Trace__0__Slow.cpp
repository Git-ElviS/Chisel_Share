...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+24,"clock", false,-1);
    tracep->declBit(c+25,"reset", false,-1);
    tracep->declBit(c+24,"rv_prng_clock", false,-1);
    tracep->declBit(c+25,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+15,"rv_lo", false,-1, 6,0);
    tracep->declBus(c+16,"rv_hi", false,-1, 6,0);
    tracep->declBus(c+17,"rv", false,-1, 13,0);
    tracep->declBit(c+18,"started", false,-1);
    tracep->declBus(c+19,"seed", false,-1, 13,0);
    tracep->declBus(c+20,"wrap_value", false,-1, 13,0);
    tracep->declBit(c+21,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+22,"wrap", false,-1);
    tracep->declBus(c+23,"last", false,-1, 13,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),7);
    tracep->fullCData(oldp+16,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13) 
    ...
    tracep->fullSData(oldp+17,(vlSelf->LFSRMaxPeriod__DOT__rv),14);
    tracep->fullBit(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullSData(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__seed),14);
    tracep->fullSData(oldp+20,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),14);
    tracep->fullBit(oldp+21,((0x3ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+22,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x3ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullSData(oldp+23,(vlSelf->LFSRMaxPeriod__DOT__last),14);
