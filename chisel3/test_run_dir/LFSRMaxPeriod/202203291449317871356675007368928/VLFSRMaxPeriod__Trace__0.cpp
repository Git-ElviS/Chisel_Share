...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+7,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
                                   << 2U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                              << 1U) 
                                             | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))),3);
        tracep->chgCData(oldp+8,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6) 
        ...
        tracep->chgCData(oldp+9,(vlSelf->LFSRMaxPeriod__DOT__rv),7);
        tracep->chgBit(oldp+10,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgCData(oldp+11,(vlSelf->LFSRMaxPeriod__DOT__seed),7);
        tracep->chgCData(oldp+12,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),7);
        tracep->chgBit(oldp+13,((0x7eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+14,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x7eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgCData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__last),7);
    }
    tracep->chgBit(oldp+16,(vlSelf->clock));
