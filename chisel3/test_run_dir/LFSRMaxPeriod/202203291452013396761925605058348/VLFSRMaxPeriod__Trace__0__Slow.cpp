...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+23,"clock", false,-1);
    tracep->declBit(c+24,"reset", false,-1);
    tracep->declBit(c+23,"rv_prng_clock", false,-1);
    tracep->declBit(c+24,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+14,"rv_lo", false,-1, 5,0);
    tracep->declBus(c+15,"rv_hi", false,-1, 6,0);
    tracep->declBus(c+16,"rv", false,-1, 12,0);
    tracep->declBit(c+17,"started", false,-1);
    tracep->declBus(c+18,"seed", false,-1, 12,0);
    tracep->declBus(c+19,"wrap_value", false,-1, 12,0);
    tracep->declBit(c+20,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+21,"wrap", false,-1);
    tracep->declBus(c+22,"last", false,-1, 12,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),6);
    tracep->fullCData(oldp+15,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
                                 << 6U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11) 
                                            << 5U) 
                                              ...
                                              | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                 ...
                                                 | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                                    ...
                                                    | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7) 
                                                        << 1U) 
                                                       | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6)))))))),7);
    tracep->fullSData(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__rv),13);
    tracep->fullBit(oldp+17,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullSData(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__seed),13);
    tracep->fullSData(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),13);
    tracep->fullBit(oldp+20,((0x1ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+21,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x1ffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullSData(oldp+22,(vlSelf->LFSRMaxPeriod__DOT__last),13);
    tracep->fullBit(oldp+23,(vlSelf->clock));
    tracep->fullBit(oldp+24,(vlSelf->reset));
}
