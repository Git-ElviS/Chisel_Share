...
VL_INLINE_OPT void VLFSRMaxPeriod___024root___sequent__TOP__0(VLFSRMaxPeriod___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/LFSRMaxPeriod/2022032914573715347273861295894017/LFSRMaxPeriod.v", 251, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv) 
                          ...
                          & (IData)(vlSelf->LFSRMaxPeriod__DOT__started)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/LFSRMaxPeriod/2022032914573715347273861295894017/LFSRMaxPeriod.v", 273, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((~ (IData)(vlSelf->reset)) 
            ...
            VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:284: Assertion failed in %NLFSRMaxPeriod\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/LFSRMaxPeriod/2022032914573715347273861295894017/LFSRMaxPeriod.v", 284, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((~ (IData)(vlSelf->reset)) 
            ...
            VL_FWRITEF(0x80000002U,"Assertion failed: LFSR last value (0b%b) was equal to current value (0b%b)\n    at LFSRSpec.scala:32 chisel3.assert(rv =/= last, \"LFSR last value (0b%%b) was equal to current value (0b%%b)\", rv, last)\n",
                       11,vlSelf->LFSRMaxPeriod__DOT__rv,
                       11,(IData)(vlSelf->LFSRMaxPeriod__DOT__last));
        }
    }
    __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_6 
        = (1U & ((~ (IData)(vlSelf->reset)) & (~ ((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7) 
    ...
    vlSelf->LFSRMaxPeriod__DOT__last = (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                         << 0xaU) | 
    ...
    vlSelf->LFSRMaxPeriod__DOT__wrap_wrap_wrap = (0x7feU 
                                                  == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value));
    vlSelf->LFSRMaxPeriod__DOT___wrap_wrap_value_T_1 
        = (0x7ffU & ((IData)(1U) + (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)));
    ...
    vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8 
        = (1U & ((~ (IData)(vlSelf->reset)) & (~ ((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                  ^ (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))));
    vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9 
        = (1U & ((~ (IData)(vlSelf->reset)) & (~ ((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                                  ^ (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))));
    ...
    vlSelf->LFSRMaxPeriod__DOT__rv_lo = (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
                                          << 4U) | 
    ...
    vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6 
        = __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_6;
    vlSelf->LFSRMaxPeriod__DOT__rv = (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                       << 0xaU) | (
                                                   ((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                    << 9U) 
                                                   | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
