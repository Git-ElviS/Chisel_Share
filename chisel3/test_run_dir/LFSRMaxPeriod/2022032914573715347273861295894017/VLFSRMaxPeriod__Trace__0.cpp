...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+11,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),5);
        tracep->chgCData(oldp+12,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
        ...
        tracep->chgSData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__rv),11);
        tracep->chgBit(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgSData(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__seed),11);
        tracep->chgSData(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),11);
        tracep->chgBit(oldp+17,((0x7feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+18,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x7feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgSData(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__last),11);
    }
