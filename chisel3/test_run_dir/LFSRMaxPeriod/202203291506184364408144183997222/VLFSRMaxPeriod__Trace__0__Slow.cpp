...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+14,"clock", false,-1);
    tracep->declBit(c+15,"reset", false,-1);
    tracep->declBit(c+14,"rv_prng_clock", false,-1);
    tracep->declBit(c+15,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+5,"rv_lo", false,-1, 1,0);
    tracep->declBus(c+6,"rv_hi", false,-1, 1,0);
    tracep->declBus(c+7,"rv", false,-1, 3,0);
    tracep->declBit(c+8,"started", false,-1);
    tracep->declBus(c+9,"seed", false,-1, 3,0);
    tracep->declBus(c+10,"wrap_value", false,-1, 3,0);
    tracep->declBit(c+11,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+12,"wrap", false,-1);
    tracep->declBus(c+13,"last", false,-1, 3,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+5,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                << 1U) | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0))),2);
    tracep->fullCData(oldp+6,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
                                << 1U) | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2))),2);
    tracep->fullCData(oldp+7,(vlSelf->LFSRMaxPeriod__DOT__rv),4);
    tracep->fullBit(oldp+8,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullCData(oldp+9,(vlSelf->LFSRMaxPeriod__DOT__seed),4);
    tracep->fullCData(oldp+10,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),4);
    tracep->fullBit(oldp+11,((0xeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+12,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0xeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullCData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__last),4);
