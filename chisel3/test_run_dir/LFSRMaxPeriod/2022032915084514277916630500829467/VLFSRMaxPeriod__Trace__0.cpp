...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+9,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
        ...
        tracep->chgCData(oldp+10,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
        ...
        tracep->chgSData(oldp+11,(vlSelf->LFSRMaxPeriod__DOT__rv),9);
        tracep->chgBit(oldp+12,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgSData(oldp+13,(vlSelf->LFSRMaxPeriod__DOT__seed),9);
        tracep->chgSData(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),9);
        tracep->chgBit(oldp+15,((0x1feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+16,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0x1feU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgSData(oldp+17,(vlSelf->LFSRMaxPeriod__DOT__last),9);
    }
