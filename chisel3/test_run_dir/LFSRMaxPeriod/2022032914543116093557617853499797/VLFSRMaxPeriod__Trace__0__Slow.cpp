...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_init_sub__TOP__0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+15,"clock", false,-1);
    tracep->declBit(c+16,"reset", false,-1);
    tracep->declBit(c+15,"rv_prng_clock", false,-1);
    tracep->declBit(c+16,"rv_prng_reset", false,-1);
    ...
    tracep->declBus(c+6,"rv_lo", false,-1, 1,0);
    tracep->declBus(c+7,"rv_hi", false,-1, 2,0);
    tracep->declBus(c+8,"rv", false,-1, 4,0);
    tracep->declBit(c+9,"started", false,-1);
    tracep->declBus(c+10,"seed", false,-1, 4,0);
    tracep->declBus(c+11,"wrap_value", false,-1, 4,0);
    tracep->declBit(c+12,"wrap_wrap_wrap", false,-1);
    tracep->declBit(c+13,"wrap", false,-1);
    tracep->declBus(c+14,"last", false,-1, 4,0);
...
VL_ATTR_COLD void VLFSRMaxPeriod___024root__trace_full_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                << 1U) | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0))),2);
    tracep->fullCData(oldp+7,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
                                << 2U) | (((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
                                           << 1U) | (IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2)))),3);
    tracep->fullCData(oldp+8,(vlSelf->LFSRMaxPeriod__DOT__rv),5);
    tracep->fullBit(oldp+9,(vlSelf->LFSRMaxPeriod__DOT__started));
    tracep->fullCData(oldp+10,(vlSelf->LFSRMaxPeriod__DOT__seed),5);
    tracep->fullCData(oldp+11,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),5);
    tracep->fullBit(oldp+12,((0x1eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
    tracep->fullBit(oldp+13,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                              & (0x1eU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
    tracep->fullCData(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__last),5);
