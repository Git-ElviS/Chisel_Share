...
void VLFSRMaxPeriod___024root__trace_chg_sub_0(VLFSRMaxPeriod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+14,(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14));
        tracep->chgBit(oldp+15,(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_15));
        tracep->chgCData(oldp+16,(vlSelf->LFSRMaxPeriod__DOT__rv_lo),8);
        tracep->chgCData(oldp+17,((((IData)(vlSelf->LFSRMaxPeriod__DOT__rv_prng__DOT__state_15) 
        ...
        tracep->chgSData(oldp+18,(vlSelf->LFSRMaxPeriod__DOT__rv),16);
        tracep->chgBit(oldp+19,(vlSelf->LFSRMaxPeriod__DOT__started));
        tracep->chgSData(oldp+20,(vlSelf->LFSRMaxPeriod__DOT__seed),16);
        tracep->chgSData(oldp+21,(vlSelf->LFSRMaxPeriod__DOT__wrap_value),16);
        tracep->chgBit(oldp+22,((0xfffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->chgBit(oldp+23,(((IData)(vlSelf->LFSRMaxPeriod__DOT__started) 
                                 & (0xfffeU == (IData)(vlSelf->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->chgSData(oldp+24,(vlSelf->LFSRMaxPeriod__DOT__last),16);
    }
    tracep->chgBit(oldp+25,(vlSelf->clock));
