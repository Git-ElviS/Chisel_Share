...
void VExtModuleTester___024root__trace_chg_sub_0(VExtModuleTester___024root* vlSelf, VerilatedVcd* tracep);

void VExtModuleTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VExtModuleTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VExtModuleTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VExtModuleTester___024root__trace_chg_sub_0(VExtModuleTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VExtModuleTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VExtModuleTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VExtModuleTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VExtModuleTester___024root__trace_cleanup\n"); );
    // Init
    VExtModuleTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VExtModuleTester___024root*>(voidSelf);
    VExtModuleTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
