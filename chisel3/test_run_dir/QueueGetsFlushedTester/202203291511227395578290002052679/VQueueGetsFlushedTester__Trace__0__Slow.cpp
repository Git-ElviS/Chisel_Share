...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root__trace_init_sub__TOP__0(VQueueGetsFlushedTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBit(c+62,"clock", false,-1);
    tracep->declBit(c+63,"reset", false,-1);
    tracep->pushNamePrefix("QueueGetsFlushedTester ");
    tracep->declBit(c+62,"clock", false,-1);
    tracep->declBit(c+63,"reset", false,-1);
    tracep->declBit(c+62,"q_clock", false,-1);
    tracep->declBit(c+63,"q_reset", false,-1);
    ...
    tracep->declBit(c+62,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+63,"q_io_deq_ready_prng_reset", false,-1);
    ...
    tracep->declBit(c+62,"flush_prng_clock", false,-1);
    tracep->declBit(c+63,"flush_prng_reset", false,-1);
    ...
    for (int i = 0; i < 4; ++i) {
        tracep->declBit(c+48+i*1,"ram", true,(i+0));
    }
    tracep->declBit(c+64,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBus(c+52,"ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+6,"ram_io_deq_bits_MPORT_data", false,-1);
    tracep->declBit(c+3,"ram_MPORT_data", false,-1);
    tracep->declBus(c+53,"ram_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+64,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+54,"ram_MPORT_en", false,-1);
    tracep->declBus(c+53,"enq_ptr_value", false,-1, 1,0);
    tracep->declBus(c+52,"deq_ptr_value", false,-1, 1,0);
    ...
    tracep->declBit(c+59,"do_enq", false,-1);
    tracep->declBit(c+60,"do_deq", false,-1);
    tracep->declBus(c+61,"ptr_diff", false,-1, 1,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root__trace_full_sub_0(VQueueGetsFlushedTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+3,(((0x13U == (IData)(vlSelf->QueueGetsFlushedTester__DOT__value)) 
    ...
    tracep->fullBit(oldp+6,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram
                            [vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value]));
    tracep->fullCData(oldp+7,(vlSelf->QueueGetsFlushedTester__DOT__q_io_count),3);
    ...
    tracep->fullBit(oldp+48,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[0]));
    tracep->fullBit(oldp+49,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[1]));
    tracep->fullBit(oldp+50,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[2]));
    tracep->fullBit(oldp+51,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[3]));
    tracep->fullCData(oldp+52,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value),2);
    tracep->fullCData(oldp+53,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullBit(oldp+54,(((~ (IData)(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->QueueGetsFlushedTester__DOT__value)))));
    tracep->fullBit(oldp+55,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+56,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+57,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+58,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+59,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+60,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__do_deq));
    tracep->fullCData(oldp+61,((3U & ((IData)(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__enq_ptr_value) 
                                      - (IData)(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value)))),2);
    tracep->fullBit(oldp+62,(vlSelf->clock));
    tracep->fullBit(oldp+63,(vlSelf->reset));
