...
VL_MODULE(VQueueGetsFlushedTester___024root) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ QueueGetsFlushedTester__DOT___GEN_66;
        CData/*0:0*/ QueueGetsFlushedTester__DOT___GEN_69;
        ...
        VlUnpacked<CData/*0:0*/, 4> QueueGetsFlushedTester__DOT__q__DOT__ram;
    };
    struct {
