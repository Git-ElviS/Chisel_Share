...
void VQueueGetsFlushedTester___024root__trace_chg_sub_0(VQueueGetsFlushedTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+2,(((0x13U == (IData)(vlSelf->QueueGetsFlushedTester__DOT__value)) 
        ...
        tracep->chgBit(oldp+5,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram
                               [vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value]));
        tracep->chgCData(oldp+6,(vlSelf->QueueGetsFlushedTester__DOT__q_io_count),3);
        ...
        tracep->chgBit(oldp+47,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[0]));
        tracep->chgBit(oldp+48,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[1]));
        tracep->chgBit(oldp+49,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[2]));
        tracep->chgBit(oldp+50,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[3]));
        tracep->chgCData(oldp+51,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->chgCData(oldp+52,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__enq_ptr_value),2);
        tracep->chgBit(oldp+53,(((~ (IData)(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->QueueGetsFlushedTester__DOT__value)))));
        tracep->chgBit(oldp+54,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+55,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+56,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+57,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+58,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+59,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__do_deq));
        tracep->chgCData(oldp+60,((3U & ((IData)(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__enq_ptr_value) 
                                         - (IData)(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value)))),2);
    }
    tracep->chgBit(oldp+61,(vlSelf->clock));
    tracep->chgBit(oldp+62,(vlSelf->reset));
}
