...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root___ctor_var_reset(VQueueGetsFlushedTester___024root* vlSelf) {
    ...
    vlSelf->QueueGetsFlushedTester__DOT___GEN_41 = VL_RAND_RESET_I(1);
    ...
    vlSelf->QueueGetsFlushedTester__DOT___GEN_66 = VL_RAND_RESET_I(1);
    vlSelf->QueueGetsFlushedTester__DOT___GEN_69 = VL_RAND_RESET_I(1);
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(1);
    }
