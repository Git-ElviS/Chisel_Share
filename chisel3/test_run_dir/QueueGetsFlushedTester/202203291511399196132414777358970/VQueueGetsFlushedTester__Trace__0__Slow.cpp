...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root__trace_init_sub__TOP__0(VQueueGetsFlushedTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+48+i*1,"ram", true,(i+0), 2,0);
    }
...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root__trace_full_sub_0(VQueueGetsFlushedTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram
                              [vlSelf->QueueGetsFlushedTester__DOT__q__DOT__deq_ptr_value]),3);
    ...
    tracep->fullCData(oldp+48,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[0]),3);
    tracep->fullCData(oldp+49,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[1]),3);
    tracep->fullCData(oldp+50,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[2]),3);
    tracep->fullCData(oldp+51,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[3]),3);
