...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root___ctor_var_reset(VQueueGetsFlushedTester___024root* vlSelf) {
    ...
    vlSelf->QueueGetsFlushedTester__DOT___GEN_42 = VL_RAND_RESET_I(2);
    ...
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(2);
    }
    ...
    vlSelf->QueueGetsFlushedTester__DOT__q__DOT____Vlvbound_h7234a2a6__0 = VL_RAND_RESET_I(2);
