...
VL_MODULE(VQueueGetsFlushedTester___024root) {
  public:
    ...
    struct {
        VL_IN8(clock,0,0);
        VL_IN8(reset,0,0);
        CData/*1:0*/ QueueGetsFlushedTester__DOT__q_io_count;
        ...
        CData/*1:0*/ QueueGetsFlushedTester__DOT___GEN_42;
        ...
        CData/*0:0*/ QueueGetsFlushedTester__DOT__q__DOT__wrap;
        CData/*1:0*/ QueueGetsFlushedTester__DOT__q__DOT___value_T_1;
        CData/*0:0*/ QueueGetsFlushedTester__DOT__q__DOT__wrap_1;
        CData/*1:0*/ QueueGetsFlushedTester__DOT__q__DOT___value_T_3;
        CData/*1:0*/ QueueGetsFlushedTester__DOT__q__DOT__ptr_diff;
        CData/*1:0*/ QueueGetsFlushedTester__DOT__q__DOT____Vlvbound_h7234a2a6__0;
    ...
    struct {
        ...
        VlUnpacked<CData/*1:0*/, 3> QueueGetsFlushedTester__DOT__q__DOT__ram;
