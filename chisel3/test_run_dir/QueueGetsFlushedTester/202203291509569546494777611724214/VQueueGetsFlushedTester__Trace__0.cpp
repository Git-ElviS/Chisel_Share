...
void VQueueGetsFlushedTester___024root__trace_chg_sub_0(VQueueGetsFlushedTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+47,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[0]),4);
        tracep->chgCData(oldp+48,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[1]),4);
        tracep->chgCData(oldp+49,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[2]),4);
        tracep->chgCData(oldp+50,(vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[3]),4);
