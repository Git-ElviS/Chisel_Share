...
VL_ATTR_COLD void VQueueGetsFlushedTester___024root___ctor_var_reset(VQueueGetsFlushedTester___024root* vlSelf) {
    ...
    vlSelf->QueueGetsFlushedTester__DOT__q_io_count = VL_RAND_RESET_I(3);
    ...
    vlSelf->QueueGetsFlushedTester__DOT___GEN_42 = VL_RAND_RESET_I(4);
    ...
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        vlSelf->QueueGetsFlushedTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(4);
    }
