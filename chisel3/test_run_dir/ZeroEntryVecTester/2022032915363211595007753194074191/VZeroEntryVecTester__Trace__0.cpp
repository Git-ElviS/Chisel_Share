...
void VZeroEntryVecTester___024root__trace_chg_sub_0(VZeroEntryVecTester___024root* vlSelf, VerilatedVcd* tracep);

void VZeroEntryVecTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VZeroEntryVecTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VZeroEntryVecTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VZeroEntryVecTester___024root__trace_chg_sub_0(VZeroEntryVecTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VZeroEntryVecTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VZeroEntryVecTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VZeroEntryVecTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VZeroEntryVecTester___024root__trace_cleanup\n"); );
    // Init
    VZeroEntryVecTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VZeroEntryVecTester___024root*>(voidSelf);
    VZeroEntryVecTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
