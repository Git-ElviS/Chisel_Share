...
VL_INLINE_OPT void VLFSRResetTester___024root___sequent__TOP__0(VLFSRResetTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((2U == (IData)(vlSelf->LFSRResetTester__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0xfU != (0xeU | (IData)(vlSelf->LFSRResetTester__DOT__lfsr__DOT__state_0)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRResetTester.v:105: Assertion failed in %NLFSRResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/LFSRResetTester/202203291447011895151186687925419/LFSRResetTester.v", 105, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((2U == (IData)(vlSelf->LFSRResetTester__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((4U == (IData)(vlSelf->LFSRResetTester__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0xfU == (0xeU | (IData)(vlSelf->LFSRResetTester__DOT__lfsr__DOT__state_0)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRResetTester.v:129: Assertion failed in %NLFSRResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/LFSRResetTester/202203291447011895151186687925419/LFSRResetTester.v", 129, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((4U == (IData)(vlSelf->LFSRResetTester__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((4U == (IData)(vlSelf->LFSRResetTester__DOT__count)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/LFSRResetTester/202203291447011895151186687925419/LFSRResetTester.v", 153, "");
        }
    }
