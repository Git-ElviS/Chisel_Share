...
void VBundleSpec_Anon___024root__trace_chg_sub_0(VBundleSpec_Anon___024root* vlSelf, VerilatedVcd* tracep);

void VBundleSpec_Anon___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleSpec_Anon___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VBundleSpec_Anon___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VBundleSpec_Anon___024root__trace_chg_sub_0(VBundleSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBundleSpec_Anon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleSpec_Anon___024root__trace_chg_sub_0\n"); );
    // Init
...
void VBundleSpec_Anon___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleSpec_Anon___024root__trace_cleanup\n"); );
    // Init
    VBundleSpec_Anon___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VBundleSpec_Anon___024root*>(voidSelf);
    VBundleSpec_Anon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
