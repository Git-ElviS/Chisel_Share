...
void VQueueFlowTester___024root__trace_chg_sub_0(VQueueFlowTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+4,(((((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full) 
        ...
        tracep->chgBit(oldp+32,(vlSelf->QueueFlowTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+33,(vlSelf->QueueFlowTester__DOT__q__DOT__do_deq));
        tracep->chgCData(oldp+34,((3U & ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
