...
VL_INLINE_OPT void VQueueFlowTester___024root___sequent__TOP__0(VQueueFlowTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
                               & (~ ((~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__full)) 
                                     | (4U == ((((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full) 
            ...
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:441: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFlowTester/202203291450213805046164560803109/QueueFlowTester.v", 441, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
                               & (~ ((IData)(vlSelf->QueueFlowTester__DOT__q_io_deq_valid) 
                                     | ((0U == ((((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                                  & (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match))
                                                  ? 4U
                                                  : 0U) 
                                                | (3U 
            ...
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:464: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFlowTester/202203291450213805046164560803109/QueueFlowTester.v", 464, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueFlowTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFlowTester/202203291450213805046164560803109/QueueFlowTester.v", 488, "");
        }
    }
    ...
    if (vlSelf->reset) {
        ...
        if ((((IData)(vlSelf->QueueFlowTester__DOT___q_io_deq_ready_T) 
              >> 0xdU) & (IData)(vlSelf->QueueFlowTester__DOT__q_io_deq_valid))) {
            ...
            vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full 
                = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__empty)
                    ? ((~ ((IData)(vlSelf->QueueFlowTester__DOT___q_io_deq_ready_T) 
                           >> 0xdU)) & (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___do_enq_T))
