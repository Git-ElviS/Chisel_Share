...
VL_ATTR_COLD void VQueueFlowTester___024root__trace_full_sub_0(VQueueFlowTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+5,(((((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                 & (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match))
                                 ? 4U : 0U) | (3U & 
                                               ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
                                                - (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value))))),3);
    ...
    tracep->fullBit(oldp+33,(vlSelf->QueueFlowTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+34,(vlSelf->QueueFlowTester__DOT__q__DOT__do_deq));
    tracep->fullCData(oldp+35,((3U & ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
                                      - (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value)))),2);
