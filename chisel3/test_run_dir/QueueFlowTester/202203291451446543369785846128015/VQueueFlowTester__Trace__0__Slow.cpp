...
VL_ATTR_COLD void VQueueFlowTester___024root__trace_full_sub_0(VQueueFlowTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,((1U & (~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full)))));
    ...
    tracep->fullBit(oldp+5,(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full));
    ...
    tracep->fullBit(oldp+27,(((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full)
                               ? (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___do_enq_T)
                               : ((~ ((IData)(vlSelf->QueueFlowTester__DOT___q_io_deq_ready_T) 
                                      >> 6U)) & (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___do_enq_T)))));
    tracep->fullBit(oldp+28,(((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full) 
                              & (((IData)(vlSelf->QueueFlowTester__DOT___q_io_deq_ready_T) 
                                  >> 6U) & (IData)(vlSelf->QueueFlowTester__DOT__q_io_deq_valid)))));
