...
void VQueueFlowTester___024root__trace_chg_sub_0(VQueueFlowTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgBit(oldp+0,((1U & (~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__full)))));
        ...
        tracep->chgCData(oldp+4,((3U & ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match)
        ...
        tracep->chgCData(oldp+26,(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value),2);
        tracep->chgCData(oldp+27,(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->chgBit(oldp+28,(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+29,(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+30,(vlSelf->QueueFlowTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+31,(vlSelf->QueueFlowTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+32,((2U == (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value))));
        tracep->chgBit(oldp+33,(vlSelf->QueueFlowTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+34,((2U == (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value))));
        tracep->chgBit(oldp+35,(vlSelf->QueueFlowTester__DOT__q__DOT__do_deq));
        tracep->chgCData(oldp+36,(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_diff),2);
    }
