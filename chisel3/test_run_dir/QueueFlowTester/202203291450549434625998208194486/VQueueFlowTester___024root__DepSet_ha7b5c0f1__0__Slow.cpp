...
VL_ATTR_COLD void VQueueFlowTester___024root___ctor_var_reset(VQueueFlowTester___024root* vlSelf) {
    ...
    vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT__empty = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT__full = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT___do_enq_T = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT__wrap = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->QueueFlowTester__DOT__q__DOT__do_enq = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
    vlSelf->QueueFlowTester__DOT__q__DOT__do_deq = VL_RAND_RESET_I(1);
    vlSelf->QueueFlowTester__DOT__q__DOT__ptr_diff = VL_RAND_RESET_I(2);
