...
VL_INLINE_OPT void VQueueFlowTester___024root___sequent__TOP__0(VQueueFlowTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
                               & (~ ((~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__full)) 
                                     | (3U == (3U & 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFlowTester/202203291450549434625998208194486/QueueFlowTester.v", 452, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:475: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFlowTester/202203291450549434625998208194486/QueueFlowTester.v", 475, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueFlowTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueFlowTester/202203291450549434625998208194486/QueueFlowTester.v", 499, "");
        }
    }
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value = 0U;
        vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value = 0U;
    } else {
        if ((((IData)(vlSelf->QueueFlowTester__DOT___q_io_deq_ready_T) 
              >> 0xaU) & (IData)(vlSelf->QueueFlowTester__DOT__q_io_deq_valid))) {
            ...
            vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full 
                = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__empty)
                    ? ((~ ((IData)(vlSelf->QueueFlowTester__DOT___q_io_deq_ready_T) 
                           >> 0xaU)) & (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___do_enq_T))
                    : (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___do_enq_T));
        }
        if (vlSelf->QueueFlowTester__DOT__q__DOT__do_deq) {
            vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value 
                = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__wrap_1)
                    ? 0U : (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___value_T_3));
        }
        if (vlSelf->QueueFlowTester__DOT__q__DOT__do_enq) {
            vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value 
                = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__wrap)
                    ? 0U : (IData)(vlSelf->QueueFlowTester__DOT__q__DOT___value_T_1));
        }
    }
    ...
    vlSelf->QueueFlowTester__DOT___value_T_1 = (0x1fU 
                                                & ((IData)(1U) 
                                                   + (IData)(vlSelf->QueueFlowTester__DOT__value)));
    vlSelf->QueueFlowTester__DOT__q__DOT__wrap_1 = 
        (2U == (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value));
    vlSelf->QueueFlowTester__DOT__q__DOT___value_T_3 
        = (3U & ((IData)(1U) + (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value)));
    vlSelf->QueueFlowTester__DOT__q__DOT__wrap = (2U 
                                                  == (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value));
    vlSelf->QueueFlowTester__DOT__q__DOT___value_T_1 
        = (3U & ((IData)(1U) + (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value)));
    vlSelf->QueueFlowTester__DOT__q__DOT__ptr_diff 
        = (3U & ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
                 - (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value)));
    vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match 
        = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
           == (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__deq_ptr_value));
    vlSelf->QueueFlowTester__DOT__q__DOT__full = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match) 
                                                  & (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full));
    vlSelf->QueueFlowTester__DOT__q__DOT__empty = ((IData)(vlSelf->QueueFlowTester__DOT__q__DOT__ptr_match) 
                                                   & (~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__maybe_full)));
    ...
    vlSelf->QueueFlowTester__DOT___T_6 = ((~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__full)) 
                                          & (0x14U 
                                             > (IData)(vlSelf->QueueFlowTester__DOT__value)));
    ...
    vlSelf->QueueFlowTester__DOT__q_io_deq_valid = 
        (1U & ((0x14U > (IData)(vlSelf->QueueFlowTester__DOT__value)) 
               | (~ (IData)(vlSelf->QueueFlowTester__DOT__q__DOT__empty))));
