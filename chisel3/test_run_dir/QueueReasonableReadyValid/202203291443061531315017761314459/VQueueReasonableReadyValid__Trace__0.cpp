...
void VQueueReasonableReadyValid___024root__trace_chg_sub_0(VQueueReasonableReadyValid___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+26,(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value),2);
        tracep->chgCData(oldp+27,(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value),2);
        ...
        tracep->chgBit(oldp+32,(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+33,(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__do_deq));
        tracep->chgCData(oldp+34,((3U & ((IData)(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
