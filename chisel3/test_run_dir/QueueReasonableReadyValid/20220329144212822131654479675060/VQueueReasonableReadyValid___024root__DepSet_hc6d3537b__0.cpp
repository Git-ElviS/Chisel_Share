...
VL_INLINE_OPT void VQueueReasonableReadyValid___024root___sequent__TOP__0(VQueueReasonableReadyValid___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueReasonableReadyValid/20220329144212822131654479675060/QueueReasonableReadyValid.v", 428, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:451: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueReasonableReadyValid/20220329144212822131654479675060/QueueReasonableReadyValid.v", 451, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueReasonableReadyValid__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueReasonableReadyValid/20220329144212822131654479675060/QueueReasonableReadyValid.v", 474, "");
        }
    }
    ...
    } else if ((IData)((((IData)(vlSelf->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
    ...
    __Vtableidx1 = (((IData)(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value) 
                     << 4U) | (((IData)((((IData)(vlSelf->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
                                          >> 0xfU) 
                                         & (~ (IData)(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__empty)))) 
                                << 3U) | (((IData)(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
                                           << 2U) | 
                                          ((((~ (IData)(vlSelf->QueueReasonableReadyValid__DOT__q__DOT__full)) 
                                             & (0x14U 
