...
VL_INLINE_OPT void VQueueReasonableReadyValid___024root___sequent__TOP__0(VQueueReasonableReadyValid___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueReasonableReadyValid/202203291441556874683855625584392/QueueReasonableReadyValid.v", 428, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:451: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueReasonableReadyValid/202203291441556874683855625584392/QueueReasonableReadyValid.v", 451, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueueReasonableReadyValid__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueReasonableReadyValid/202203291441556874683855625584392/QueueReasonableReadyValid.v", 474, "");
        }
    }
