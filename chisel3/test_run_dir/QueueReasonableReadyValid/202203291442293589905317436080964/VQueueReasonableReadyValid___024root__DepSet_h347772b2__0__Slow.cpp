...
VL_ATTR_COLD void VQueueReasonableReadyValid___024root___ctor_var_reset(VQueueReasonableReadyValid___024root* vlSelf) {
    ...
    vlSelf->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(1);
    vlSelf->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(1);
