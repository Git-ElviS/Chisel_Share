...
VL_INLINE_OPT void VThingsPassThroughTester___024root___sequent__TOP__0(VThingsPassThroughTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                            >> 4U) & (~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1))
                              ? 3U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1))
                                       ? 3U : ((0x11U 
            ...
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughTester.v:516: Assertion failed in %NThingsPassThroughTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughTester/2022032914392316608522215895169344/ThingsPassThroughTester.v", 516, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughTester/2022032914392316608522215895169344/ThingsPassThroughTester.v", 539, "");
        }
    }
            ...
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                ? 3U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                         ? 3U : ((0x11U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                  ? 3U : ((0x10U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                           ? 2U : (
                                                   (0xfU 
