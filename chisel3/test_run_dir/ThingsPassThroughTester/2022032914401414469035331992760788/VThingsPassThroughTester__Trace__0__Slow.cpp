...
VL_ATTR_COLD void VThingsPassThroughTester___024root__trace_full_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+6,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram
    ...
    tracep->fullBit(oldp+29,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[1]));
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[2]));
    tracep->fullBit(oldp+31,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[3]));
