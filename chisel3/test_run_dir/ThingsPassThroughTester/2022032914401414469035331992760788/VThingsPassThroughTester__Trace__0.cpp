...
void VThingsPassThroughTester___024root__trace_chg_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+5,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram
        ...
        tracep->chgBit(oldp+28,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[1]));
        tracep->chgBit(oldp+29,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[2]));
        tracep->chgBit(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[3]));
