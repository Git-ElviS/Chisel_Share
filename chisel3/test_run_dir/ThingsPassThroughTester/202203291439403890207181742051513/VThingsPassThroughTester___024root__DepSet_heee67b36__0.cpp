...
VL_INLINE_OPT void VThingsPassThroughTester___024root___sequent__TOP__0(VThingsPassThroughTester___024root* vlSelf) {
                         ...
                         & (((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1))
                            ...
                            != ((0U >= (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0))
                                ...
                                [vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]
                                 : 0U))))) {
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughTester.v:484: Assertion failed in %NThingsPassThroughTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughTester/202203291439403890207181742051513/ThingsPassThroughTester.v", 484, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughTester/202203291439403890207181742051513/ThingsPassThroughTester.v", 507, "");
        }
    }
        ...
        __Vdlyvval__ThingsPassThroughTester__DOT__q__DOT__ram__v0 
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                ? 0U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                         ? 3U : ((0x11U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                  ? 0U : ((0x10U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                           ? 3U : (
                                                   (0xfU 
