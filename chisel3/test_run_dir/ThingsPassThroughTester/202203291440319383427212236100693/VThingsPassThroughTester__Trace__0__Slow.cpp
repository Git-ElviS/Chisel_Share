...
VL_ATTR_COLD void VThingsPassThroughTester___024root__trace_full_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+3,(((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                ? 0U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                         ? 1U : ((0x11U 
    ...
    tracep->fullCData(oldp+6,(((2U >= (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0))
    ...
    tracep->fullCData(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[2]),3);
    tracep->fullBit(oldp+31,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
    tracep->fullCData(oldp+32,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0),2);
    tracep->fullCData(oldp+33,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullBit(oldp+34,(((~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughTester__DOT__value)))));
    tracep->fullCData(oldp+35,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value),2);
    tracep->fullBit(oldp+36,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+37,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+38,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+39,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+40,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+41,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_deq));
    tracep->fullBit(oldp+42,((2U == (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value))));
    tracep->fullBit(oldp+43,((2U == (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))));
