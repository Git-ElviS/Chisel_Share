...
void VThingsPassThroughTester___024root__trace_chg_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+29,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
        tracep->chgBit(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
        tracep->chgBit(oldp+31,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value));
        tracep->chgBit(oldp+32,(((~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->ThingsPassThroughTester__DOT__value)))));
        tracep->chgBit(oldp+33,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value));
        tracep->chgBit(oldp+34,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+35,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+36,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+37,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+38,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+39,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_deq));
    }
