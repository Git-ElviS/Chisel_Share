...
VL_INLINE_OPT void VThingsPassThroughTester___024root___sequent__TOP__0(VThingsPassThroughTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                            >> 0xcU) & (~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1))
                              ? 5U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1))
                                       ? 2U : ((0x11U 
            ...
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughTester.v:513: Assertion failed in %NThingsPassThroughTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughTester/2022032914395711452775707956092199/ThingsPassThroughTester.v", 513, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughTester/2022032914395711452775707956092199/ThingsPassThroughTester.v", 536, "");
        }
    }
            ...
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                ? 5U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                         ? 2U : ((0x11U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                  ? 6U : ((0x10U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                           ? 0U : (
                                                   (0xfU 
    ...
    } else if (vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_enq) {
        __Vdly__ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value 
            = (1U & ((IData)(1U) + (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value)));
    }
    __Vdly__ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_0 
    ...
    vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 
        = ((IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_deq)
            ? ((1U != (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT___GEN_15)) 
               & (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT___value_T_3))
    ...
    if (vlSelf->reset) {
        ...
        if (vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_deq) {
            __Vdly__ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value 
                = (1U & ((IData)(1U) + (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value)));
        }
    ...
    vlSelf->ThingsPassThroughTester__DOT__q__DOT___value_T_3 
        = (1U & ((IData)(1U) + (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value)));
    vlSelf->ThingsPassThroughTester__DOT__q__DOT___GEN_15 
        = vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value;
