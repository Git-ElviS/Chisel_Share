...
VL_ATTR_COLD void VThingsPassThroughTester___024root___ctor_var_reset(VThingsPassThroughTester___024root* vlSelf) {
    ...
    vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(1);
    ...
    vlSelf->ThingsPassThroughTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughTester__DOT__q__DOT___GEN_15 = VL_RAND_RESET_I(2);
