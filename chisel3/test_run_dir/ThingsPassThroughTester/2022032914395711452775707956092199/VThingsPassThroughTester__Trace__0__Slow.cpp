...
VL_ATTR_COLD void VThingsPassThroughTester___024root__trace_init_sub__TOP__0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+41,"clock", false,-1);
    tracep->declBit(c+42,"reset", false,-1);
    tracep->declBit(c+41,"q_clock", false,-1);
    tracep->declBit(c+42,"q_reset", false,-1);
    ...
    tracep->declBit(c+41,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+42,"q_io_deq_ready_prng_reset", false,-1);
    ...
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+28+i*1,"ram", true,(i+0), 2,0);
    }
    tracep->declBit(c+30,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBit(c+31,"ram_io_deq_bits_MPORT_addr", false,-1);
    tracep->declBus(c+6,"ram_io_deq_bits_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+3,"ram_MPORT_data", false,-1, 2,0);
    tracep->declBit(c+32,"ram_MPORT_addr", false,-1);
    tracep->declBit(c+43,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+33,"ram_MPORT_en", false,-1);
    tracep->declBit(c+30,"ram_io_deq_bits_MPORT_en_pipe_0", false,-1);
    tracep->declBit(c+31,"ram_io_deq_bits_MPORT_addr_pipe_0", false,-1);
    tracep->declBit(c+32,"enq_ptr_value", false,-1);
    tracep->declBit(c+34,"deq_ptr_value", false,-1);
    tracep->declBit(c+35,"maybe_full", false,-1);
    tracep->declBit(c+36,"ptr_match", false,-1);
    tracep->declBit(c+37,"empty", false,-1);
    tracep->declBit(c+38,"full", false,-1);
    tracep->declBit(c+39,"do_enq", false,-1);
    tracep->declBit(c+40,"do_deq", false,-1);
...
VL_ATTR_COLD void VThingsPassThroughTester___024root__trace_full_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+3,(((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                ? 5U : ((0x12U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value))
                                         ? 2U : ((0x11U 
    ...
    tracep->fullCData(oldp+6,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram
                              [vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]),3);
    ...
    tracep->fullCData(oldp+28,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[0]),3);
    tracep->fullCData(oldp+29,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[1]),3);
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
    tracep->fullBit(oldp+31,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
    tracep->fullBit(oldp+32,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value));
    tracep->fullBit(oldp+33,(((~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughTester__DOT__value)))));
    tracep->fullBit(oldp+34,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value));
    tracep->fullBit(oldp+35,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+36,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+37,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+38,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+39,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+40,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_deq));
    tracep->fullBit(oldp+41,(vlSelf->clock));
    tracep->fullBit(oldp+42,(vlSelf->reset));
