...
VL_ATTR_COLD void VThingsPassThroughTester___024root__trace_full_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,((1U & (~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full)))));
    tracep->fullBit(oldp+2,((0x14U > (IData)(vlSelf->ThingsPassThroughTester__DOT__value))));
    tracep->fullBit(oldp+3,(((0x13U == (IData)(vlSelf->ThingsPassThroughTester__DOT__value)) 
    ...
    tracep->fullBit(oldp+4,((1U & ((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                                   >> 8U))));
    tracep->fullBit(oldp+5,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+6,(((0U >= (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0)) 
    ...
    tracep->fullBit(oldp+28,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram[0]));
    tracep->fullBit(oldp+29,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
    tracep->fullBit(oldp+31,(((~ (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughTester__DOT__value)))));
    tracep->fullBit(oldp+32,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+33,((((IData)(vlSelf->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
