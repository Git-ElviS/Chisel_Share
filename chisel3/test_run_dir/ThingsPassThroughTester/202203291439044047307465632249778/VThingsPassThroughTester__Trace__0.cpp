...
void VThingsPassThroughTester___024root__trace_chg_sub_0(VThingsPassThroughTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+5,(((2U >= (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))
        ...
        tracep->chgCData(oldp+30,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->chgCData(oldp+31,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value),2);
        ...
        tracep->chgBit(oldp+33,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+34,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+35,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+36,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+37,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+38,(vlSelf->ThingsPassThroughTester__DOT__q__DOT__do_deq));
        tracep->chgBit(oldp+39,((2U == (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value))));
        tracep->chgBit(oldp+40,((2U == (IData)(vlSelf->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))));
    }
