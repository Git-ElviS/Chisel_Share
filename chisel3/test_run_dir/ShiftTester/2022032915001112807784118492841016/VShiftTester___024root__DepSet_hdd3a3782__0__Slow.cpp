...
VL_ATTR_COLD void VShiftTester___024root___ctor_var_reset(VShiftTester___024root* vlSelf) {
    ...
    vlSelf->ShiftTester__DOT__cntVal = VL_RAND_RESET_I(2);
    vlSelf->ShiftTester__DOT__wrap_wrap = VL_RAND_RESET_I(1);
    vlSelf->ShiftTester__DOT___wrap_value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->ShiftTester__DOT__sr_r = VL_RAND_RESET_I(5);
    vlSelf->ShiftTester__DOT__sr_r_1 = VL_RAND_RESET_I(5);
