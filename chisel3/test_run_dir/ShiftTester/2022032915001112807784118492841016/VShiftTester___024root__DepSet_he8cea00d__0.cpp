...
VL_INLINE_OPT void VShiftTester___024root___sequent__TOP__0(VShiftTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((2U == (IData)(vlSelf->ShiftTester__DOT__cntVal)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftTester/2022032915001112807784118492841016/ShiftTester.v", 35, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((2U == (IData)(vlSelf->ShiftTester__DOT__cntVal)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((2U == (IData)(vlSelf->ShiftTester__DOT__cntVal)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftTester/2022032915001112807784118492841016/ShiftTester.v", 57, "");
        }
    }
