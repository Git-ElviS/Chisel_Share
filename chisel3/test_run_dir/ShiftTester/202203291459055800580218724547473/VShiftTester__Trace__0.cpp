...
void VShiftTester___024root__trace_chg_sub_0(VShiftTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgBit(oldp+0,(vlSelf->ShiftTester__DOT__cntVal));
        tracep->chgCData(oldp+1,(vlSelf->ShiftTester__DOT__sr_r),5);
        tracep->chgCData(oldp+2,(vlSelf->ShiftTester__DOT__sr),5);
    }
