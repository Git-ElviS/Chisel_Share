...
VL_INLINE_OPT void VMultiClockSpec_Anon___024root___sequent__TOP__0(VMultiClockSpec_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlSelf->MultiClockSpec_Anon__DOT__done_value)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/MultiClockSpec_Anon/2022032915200413415128452836420483/MultiClockSpec_Anon.v", 23, "");
        }
    }
    vlSelf->MultiClockSpec_Anon__DOT__done_value = 
        ((IData)(vlSelf->reset) ? 0U : (IData)(vlSelf->MultiClockSpec_Anon__DOT___done_wrap_value_T_1));
