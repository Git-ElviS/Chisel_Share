...
VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_init_sub__TOP__0(VBidirectionalTester2DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBidirectionalTester2DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester2DTabulate___024root__trace_init_sub__TOP__0\n"); );
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declBit(c+1,"clock", false,-1);
    tracep->declBit(c+2,"reset", false,-1);
    tracep->pushNamePrefix("BidirectionalTester2DTabulate ");
    tracep->declBit(c+1,"clock", false,-1);
    tracep->declBit(c+2,"reset", false,-1);
    ...
    tracep->declBus(c+5,"PassthroughModule_6_io_in", false,-1, 31,0);
    tracep->declBus(c+5,"PassthroughModule_6_io_out", false,-1, 31,0);
    tracep->declBus(c+6,"PassthroughModule_7_io_in", false,-1, 31,0);
    tracep->declBus(c+6,"PassthroughModule_7_io_out", false,-1, 31,0);
    tracep->declBus(c+7,"PassthroughModule_8_io_in", false,-1, 31,0);
    tracep->declBus(c+7,"PassthroughModule_8_io_out", false,-1, 31,0);
...
VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_init_top(VBidirectionalTester2DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBidirectionalTester2DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester2DTabulate___024root__trace_init_top\n"); );
    // Body
    VBidirectionalTester2DTabulate___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_full_top_0(void* voidSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_register(VBidirectionalTester2DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBidirectionalTester2DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester2DTabulate___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&VBidirectionalTester2DTabulate___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&VBidirectionalTester2DTabulate___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&VBidirectionalTester2DTabulate___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_full_sub_0(VBidirectionalTester2DTabulate___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_full_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester2DTabulate___024root__trace_full_top_0\n"); );
    // Init
    ...
    VBidirectionalTester2DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VBidirectionalTester2DTabulate___024root__trace_full_sub_0((&vlSymsp->TOP), tracep);
}

VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_full_sub_0(VBidirectionalTester2DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBidirectionalTester2DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester2DTabulate___024root__trace_full_sub_0\n"); );
    // Init
