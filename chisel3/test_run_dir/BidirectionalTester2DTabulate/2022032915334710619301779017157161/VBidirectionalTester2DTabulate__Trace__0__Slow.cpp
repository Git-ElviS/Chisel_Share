...
VL_ATTR_COLD void VBidirectionalTester2DTabulate___024root__trace_init_sub__TOP__0(VBidirectionalTester2DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"PassthroughModule_2_io_in", false,-1, 31,0);
    tracep->declBus(c+4,"PassthroughModule_2_io_out", false,-1, 31,0);
    tracep->declBus(c+5,"PassthroughModule_3_io_in", false,-1, 31,0);
    tracep->declBus(c+5,"PassthroughModule_3_io_out", false,-1, 31,0);
