...
VL_INLINE_OPT void VBidirectionalTester2DTabulate___024root___sequent__TOP__0(VBidirectionalTester2DTabulate___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/BidirectionalTester2DTabulate/2022032915334710619301779017157161/BidirectionalTester2DTabulate.v", 250, "");
        }
    }
}
