...
VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_init_sub__TOP__0(VQueueSinglePipeTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VQueueSinglePipeTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueSinglePipeTester___024root__trace_init_sub__TOP__0\n"); );
    // Init
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declBit(c+29,"clock", false,-1);
    tracep->declBit(c+30,"reset", false,-1);
    tracep->pushNamePrefix("QueueSinglePipeTester ");
    tracep->declBit(c+29,"clock", false,-1);
    tracep->declBit(c+30,"reset", false,-1);
...
VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_init_top(VQueueSinglePipeTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VQueueSinglePipeTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueSinglePipeTester___024root__trace_init_top\n"); );
    // Body
    VQueueSinglePipeTester___024root__trace_init_sub__TOP__0(vlSelf, tracep);
}

VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_full_top_0(void* voidSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_register(VQueueSinglePipeTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VQueueSinglePipeTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueSinglePipeTester___024root__trace_register\n"); );
    // Body
    tracep->addFullCb(&VQueueSinglePipeTester___024root__trace_full_top_0, vlSelf);
    tracep->addChgCb(&VQueueSinglePipeTester___024root__trace_chg_top_0, vlSelf);
    tracep->addCleanupCb(&VQueueSinglePipeTester___024root__trace_cleanup, vlSelf);
}

VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_full_sub_0(VQueueSinglePipeTester___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_full_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueSinglePipeTester___024root__trace_full_top_0\n"); );
    // Init
    ...
    VQueueSinglePipeTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    VQueueSinglePipeTester___024root__trace_full_sub_0((&vlSymsp->TOP), tracep);
}

VL_ATTR_COLD void VQueueSinglePipeTester___024root__trace_full_sub_0(VQueueSinglePipeTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VQueueSinglePipeTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueueSinglePipeTester___024root__trace_full_sub_0\n"); );
    // Init
    vluint32_t* const oldp VL_ATTR_UNUSED = tracep->oldp(vlSymsp->__Vm_baseCode);
    // Body
    tracep->fullBit(oldp+1,(vlSelf->QueueSinglePipeTester__DOT__q_io_enq_ready));
    tracep->fullBit(oldp+2,((0x14U > (IData)(vlSelf->QueueSinglePipeTester__DOT__value))));
    tracep->fullBit(oldp+3,((1U & ((IData)(vlSelf->QueueSinglePipeTester__DOT___q_io_deq_ready_T) 
                                   >> 8U))));
    tracep->fullBit(oldp+4,(vlSelf->QueueSinglePipeTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+5,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_0));
    tracep->fullBit(oldp+6,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_1));
    tracep->fullBit(oldp+7,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_2));
    tracep->fullBit(oldp+8,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_3));
    tracep->fullBit(oldp+9,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_4));
    tracep->fullBit(oldp+10,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_5));
    tracep->fullBit(oldp+11,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_6));
    tracep->fullBit(oldp+12,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_7));
    tracep->fullBit(oldp+13,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_8));
    tracep->fullBit(oldp+14,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_9));
    tracep->fullBit(oldp+15,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_10));
    tracep->fullBit(oldp+16,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_11));
    tracep->fullBit(oldp+17,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_12));
    tracep->fullBit(oldp+18,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_13));
    tracep->fullBit(oldp+19,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_14));
    tracep->fullBit(oldp+20,(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_15));
    tracep->fullCData(oldp+21,(vlSelf->QueueSinglePipeTester__DOT__value),5);
    tracep->fullCData(oldp+22,(vlSelf->QueueSinglePipeTester__DOT__value_1),5);
    tracep->fullCData(oldp+23,((((IData)(vlSelf->QueueSinglePipeTester__DOT__q_io_deq_ready_prng__DOT__state_7) 
    ...
    tracep->fullBit(oldp+24,((0x14U == (IData)(vlSelf->QueueSinglePipeTester__DOT__value))));
    tracep->fullBit(oldp+25,((0x14U == (IData)(vlSelf->QueueSinglePipeTester__DOT__value_1))));
    tracep->fullBit(oldp+26,((1U & (~ (IData)(vlSelf->QueueSinglePipeTester__DOT__q__DOT__maybe_full)))));
    tracep->fullBit(oldp+27,(vlSelf->QueueSinglePipeTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+28,((((IData)(vlSelf->QueueSinglePipeTester__DOT___q_io_deq_ready_T) 
                               >> 8U) & (IData)(vlSelf->QueueSinglePipeTester__DOT__q__DOT__maybe_full))));
