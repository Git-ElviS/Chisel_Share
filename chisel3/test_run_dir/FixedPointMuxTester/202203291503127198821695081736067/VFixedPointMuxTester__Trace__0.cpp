...
void VFixedPointMuxTester___024root__trace_chg_sub_0(VFixedPointMuxTester___024root* vlSelf, VerilatedVcd* tracep);

void VFixedPointMuxTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFixedPointMuxTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VFixedPointMuxTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VFixedPointMuxTester___024root__trace_chg_sub_0(VFixedPointMuxTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VFixedPointMuxTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFixedPointMuxTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VFixedPointMuxTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFixedPointMuxTester___024root__trace_cleanup\n"); );
    // Init
    VFixedPointMuxTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VFixedPointMuxTester___024root*>(voidSelf);
    VFixedPointMuxTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
