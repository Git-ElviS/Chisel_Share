...
void VBundleSerializationTest___024root__trace_chg_sub_0(VBundleSerializationTest___024root* vlSelf, VerilatedVcd* tracep);

void VBundleSerializationTest___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleSerializationTest___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VBundleSerializationTest___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VBundleSerializationTest___024root__trace_chg_sub_0(VBundleSerializationTest___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBundleSerializationTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleSerializationTest___024root__trace_chg_sub_0\n"); );
    // Init
...
void VBundleSerializationTest___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleSerializationTest___024root__trace_cleanup\n"); );
    // Init
    VBundleSerializationTest___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VBundleSerializationTest___024root*>(voidSelf);
    VBundleSerializationTest__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
