...
void VSomeOptionBundleTester___024root__trace_chg_sub_0(VSomeOptionBundleTester___024root* vlSelf, VerilatedVcd* tracep);

void VSomeOptionBundleTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSomeOptionBundleTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VSomeOptionBundleTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VSomeOptionBundleTester___024root__trace_chg_sub_0(VSomeOptionBundleTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VSomeOptionBundleTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSomeOptionBundleTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VSomeOptionBundleTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSomeOptionBundleTester___024root__trace_cleanup\n"); );
    // Init
    VSomeOptionBundleTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VSomeOptionBundleTester___024root*>(voidSelf);
    VSomeOptionBundleTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
