...
VL_INLINE_OPT void VSomeOptionBundleTester___024root___sequent__TOP__0(VSomeOptionBundleTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/SomeOptionBundleTester/202203291503463800367067554388171/SomeOptionBundleTester.v", 12, "");
        }
    }
}
