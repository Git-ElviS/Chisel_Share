...
void VFinishTester___024root__trace_chg_sub_0(VFinishTester___024root* vlSelf, VerilatedVcd* tracep);

void VFinishTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFinishTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VFinishTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VFinishTester___024root__trace_chg_sub_0(VFinishTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VFinishTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFinishTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VFinishTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFinishTester___024root__trace_cleanup\n"); );
    // Init
    VFinishTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VFinishTester___024root*>(voidSelf);
    VFinishTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
