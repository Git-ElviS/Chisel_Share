...
VL_INLINE_OPT void VResetTester___024root___sequent__TOP__0(VResetTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ResetTester__DOT__wasReset) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ResetTester/2022032914432210694216992319747359/ResetTester.v", 28, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ResetTester__DOT__wasReset) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->ResetTester__DOT__wasReset) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ResetTester/2022032914432210694216992319747359/ResetTester.v", 50, "");
        }
    }
    vlSelf->ResetTester__DOT__wasReset = (0U == (IData)(vlSelf->ResetTester__DOT__value));
    ...
    vlSelf->ResetTester__DOT__triggerReset = (0U == (IData)(vlSelf->ResetTester__DOT__value));
}
