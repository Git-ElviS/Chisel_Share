...
void VLitTester___024root__trace_chg_sub_0(VLitTester___024root* vlSelf, VerilatedVcd* tracep);

void VLitTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VLitTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VLitTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VLitTester___024root__trace_chg_sub_0(VLitTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VLitTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VLitTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VLitTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VLitTester___024root__trace_cleanup\n"); );
    // Init
    VLitTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VLitTester___024root*>(voidSelf);
    VLitTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
