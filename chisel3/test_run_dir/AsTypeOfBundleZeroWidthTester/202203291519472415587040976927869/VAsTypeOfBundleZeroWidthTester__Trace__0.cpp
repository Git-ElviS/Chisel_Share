...
void VAsTypeOfBundleZeroWidthTester___024root__trace_chg_sub_0(VAsTypeOfBundleZeroWidthTester___024root* vlSelf, VerilatedVcd* tracep);

void VAsTypeOfBundleZeroWidthTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAsTypeOfBundleZeroWidthTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VAsTypeOfBundleZeroWidthTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VAsTypeOfBundleZeroWidthTester___024root__trace_chg_sub_0(VAsTypeOfBundleZeroWidthTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VAsTypeOfBundleZeroWidthTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAsTypeOfBundleZeroWidthTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VAsTypeOfBundleZeroWidthTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAsTypeOfBundleZeroWidthTester___024root__trace_cleanup\n"); );
    // Init
    VAsTypeOfBundleZeroWidthTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VAsTypeOfBundleZeroWidthTester___024root*>(voidSelf);
    VAsTypeOfBundleZeroWidthTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
