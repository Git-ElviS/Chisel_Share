...
VL_INLINE_OPT void VWrapTester___024root___sequent__TOP__0(VWrapTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((3U == (IData)(vlSelf->WrapTester__DOT__cnt)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (3U != (IData)(vlSelf->WrapTester__DOT__cnt))))) {
            VL_WRITEF("[%0t] %%Error: WrapTester.v:23: Assertion failed in %NWrapTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/WrapTester/2022032914471114698785603484872579/WrapTester.v", 23, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((3U == (IData)(vlSelf->WrapTester__DOT__cnt)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlSelf->WrapTester__DOT__cnt)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/WrapTester/2022032914471114698785603484872579/WrapTester.v", 45, "");
        }
    }
