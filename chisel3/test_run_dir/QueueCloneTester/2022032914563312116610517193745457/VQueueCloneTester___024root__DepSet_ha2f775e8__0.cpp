...
VL_INLINE_OPT void VQueueCloneTester___024root___sequent__TOP__0(VQueueCloneTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlSelf->QueueCloneTester__DOT__accept) 
                          ...
                          & (~ (IData)(vlSelf->reset))) 
                         & (0x2aU != vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__ram
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueCloneTester/2022032914563312116610517193745457/QueueCloneTester.v", 224, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlSelf->QueueCloneTester__DOT__accept) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->QueueCloneTester__DOT__accept) 
                          & (~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__empty))) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueueCloneTester/2022032914563312116610517193745457/QueueCloneTester.v", 246, "");
        }
    }
    ...
    if (__Vdlyvset__QueueCloneTester__DOT__dut__DOT__q1__DOT__ram__v0) {
        vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__ram[__Vdlyvdim0__QueueCloneTester__DOT__dut__DOT__q1__DOT__ram__v0] = 0x2aU;
    }
