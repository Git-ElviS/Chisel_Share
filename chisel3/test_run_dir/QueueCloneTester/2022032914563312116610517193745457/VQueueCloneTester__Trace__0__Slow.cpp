...
VL_ATTR_COLD void VQueueCloneTester___024root__trace_init_sub__TOP__0(VQueueCloneTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+31,"q1_clock", false,-1);
    tracep->declBit(c+32,"q1_reset", false,-1);
    tracep->declBit(c+1,"q1_io_enq_ready", false,-1);
    tracep->declBit(c+2,"q1_io_enq_valid", false,-1);
    tracep->declBus(c+33,"q1_io_enq_bits", false,-1, 31,0);
    tracep->declBit(c+6,"q1_io_deq_ready", false,-1);
    tracep->declBit(c+7,"q1_io_deq_valid", false,-1);
    tracep->declBus(c+8,"q1_io_deq_bits", false,-1, 31,0);
    tracep->declBit(c+31,"q2_io_clock", false,-1);
    tracep->declBit(c+32,"q2_io_reset", false,-1);
    tracep->declBit(c+6,"q2_io_io_enq_ready", false,-1);
    tracep->declBit(c+7,"q2_io_io_enq_valid", false,-1);
    tracep->declBus(c+8,"q2_io_io_enq_bits", false,-1, 31,0);
    tracep->declBit(c+3,"q2_io_io_deq_ready", false,-1);
    tracep->declBit(c+4,"q2_io_io_deq_valid", false,-1);
    tracep->declBus(c+5,"q2_io_io_deq_bits", false,-1, 31,0);
...
VL_ATTR_COLD void VQueueCloneTester___024root__trace_full_sub_0(VQueueCloneTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,((1U & (~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__full)))));
    tracep->fullBit(oldp+2,(vlSelf->QueueCloneTester__DOT__start));
    tracep->fullBit(oldp+3,(vlSelf->QueueCloneTester__DOT__accept));
    tracep->fullBit(oldp+4,((1U & (~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__empty)))));
    tracep->fullIData(oldp+5,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__ram
                              [vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__deq_ptr_value]),32);
    tracep->fullBit(oldp+6,((1U & (~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__full)))));
    tracep->fullBit(oldp+7,((1U & (~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__empty)))));
    tracep->fullIData(oldp+8,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__ram
                              [vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__deq_ptr_value]),32);
    tracep->fullIData(oldp+9,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__ram[0]),32);
    tracep->fullIData(oldp+10,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__ram[1]),32);
    tracep->fullBit(oldp+11,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__deq_ptr_value));
    tracep->fullBit(oldp+12,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__enq_ptr_value));
    tracep->fullBit(oldp+13,(((~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__full)) 
                              & (IData)(vlSelf->QueueCloneTester__DOT__start))));
    tracep->fullBit(oldp+14,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__maybe_full));
    tracep->fullBit(oldp+15,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__ptr_match));
    tracep->fullBit(oldp+16,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__empty));
    tracep->fullBit(oldp+17,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__full));
    tracep->fullBit(oldp+18,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__do_enq));
    tracep->fullBit(oldp+19,(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__do_deq));
    tracep->fullIData(oldp+20,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__ram[0]),32);
    tracep->fullIData(oldp+21,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__ram[1]),32);
    tracep->fullBit(oldp+22,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__deq_ptr_value));
    tracep->fullBit(oldp+23,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__enq_ptr_value));
    tracep->fullBit(oldp+24,((1U & ((~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__full)) 
                                    & (~ (IData)(vlSelf->QueueCloneTester__DOT__dut__DOT__q1__DOT__empty))))));
    tracep->fullBit(oldp+25,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__maybe_full));
    tracep->fullBit(oldp+26,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__ptr_match));
    tracep->fullBit(oldp+27,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__empty));
    tracep->fullBit(oldp+28,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__full));
    tracep->fullBit(oldp+29,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__do_enq));
    tracep->fullBit(oldp+30,(vlSelf->QueueCloneTester__DOT__dut__DOT__q2_io__DOT__do_deq));
    tracep->fullBit(oldp+31,(vlSelf->clock));
    tracep->fullBit(oldp+32,(vlSelf->reset));
    tracep->fullIData(oldp+33,(0x2aU),32);
