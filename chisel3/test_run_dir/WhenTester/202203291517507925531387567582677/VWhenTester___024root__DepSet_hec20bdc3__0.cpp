...
void VWhenTester___024root___sequent__TOP__0(VWhenTester___024root* vlSelf);
...
void VWhenTester___024root___eval(VWhenTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VWhenTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VWhenTester___024root___sequent__TOP__0(vlSelf);
...
void VWhenTester___024root___eval_debug_assertions(VWhenTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VWhenTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VWhenTester___024root___eval_debug_assertions\n"); );
    // Body
