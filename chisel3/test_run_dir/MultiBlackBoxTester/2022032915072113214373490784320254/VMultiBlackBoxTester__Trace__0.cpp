...
void VMultiBlackBoxTester___024root__trace_chg_sub_0(VMultiBlackBoxTester___024root* vlSelf, VerilatedVcd* tracep);

void VMultiBlackBoxTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiBlackBoxTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VMultiBlackBoxTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VMultiBlackBoxTester___024root__trace_chg_sub_0(VMultiBlackBoxTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMultiBlackBoxTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiBlackBoxTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VMultiBlackBoxTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiBlackBoxTester___024root__trace_cleanup\n"); );
    // Init
    VMultiBlackBoxTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VMultiBlackBoxTester___024root*>(voidSelf);
    VMultiBlackBoxTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
