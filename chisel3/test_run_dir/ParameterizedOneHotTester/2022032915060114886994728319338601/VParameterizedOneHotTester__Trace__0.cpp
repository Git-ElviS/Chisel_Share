...
void VParameterizedOneHotTester___024root__trace_chg_sub_0(VParameterizedOneHotTester___024root* vlSelf, VerilatedVcd* tracep);

void VParameterizedOneHotTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VParameterizedOneHotTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VParameterizedOneHotTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VParameterizedOneHotTester___024root__trace_chg_sub_0(VParameterizedOneHotTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VParameterizedOneHotTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VParameterizedOneHotTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VParameterizedOneHotTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VParameterizedOneHotTester___024root__trace_cleanup\n"); );
    // Init
    VParameterizedOneHotTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VParameterizedOneHotTester___024root*>(voidSelf);
    VParameterizedOneHotTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
