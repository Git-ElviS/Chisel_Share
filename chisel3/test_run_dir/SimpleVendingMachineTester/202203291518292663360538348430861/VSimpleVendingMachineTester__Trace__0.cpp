...
void VSimpleVendingMachineTester___024root__trace_chg_sub_0(VSimpleVendingMachineTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgBit(oldp+0,(vlSelf->SimpleVendingMachineTester__DOT__dut_io_nickel));
        tracep->chgBit(oldp+1,(vlSelf->SimpleVendingMachineTester__DOT__dut_io_dime));
        tracep->chgBit(oldp+2,((4U == (IData)(vlSelf->SimpleVendingMachineTester__DOT__dut__DOT__state))));
        ...
        tracep->chgCData(oldp+5,(vlSelf->SimpleVendingMachineTester__DOT__dut__DOT__state),3);
    }
