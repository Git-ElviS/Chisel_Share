...
VL_ATTR_COLD void VSimpleVendingMachineTester___024root__trace_full_sub_0(VSimpleVendingMachineTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,(vlSelf->SimpleVendingMachineTester__DOT__dut_io_nickel));
    tracep->fullBit(oldp+2,(vlSelf->SimpleVendingMachineTester__DOT__dut_io_dime));
    tracep->fullBit(oldp+3,((4U == (IData)(vlSelf->SimpleVendingMachineTester__DOT__dut__DOT__state))));
    ...
    tracep->fullCData(oldp+6,(vlSelf->SimpleVendingMachineTester__DOT__dut__DOT__state),3);
