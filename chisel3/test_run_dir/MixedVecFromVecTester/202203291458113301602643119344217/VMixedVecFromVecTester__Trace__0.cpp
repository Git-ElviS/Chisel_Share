...
void VMixedVecFromVecTester___024root__trace_chg_sub_0(VMixedVecFromVecTester___024root* vlSelf, VerilatedVcd* tracep);

void VMixedVecFromVecTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMixedVecFromVecTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VMixedVecFromVecTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VMixedVecFromVecTester___024root__trace_chg_sub_0(VMixedVecFromVecTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMixedVecFromVecTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMixedVecFromVecTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VMixedVecFromVecTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMixedVecFromVecTester___024root__trace_cleanup\n"); );
    // Init
    VMixedVecFromVecTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VMixedVecFromVecTester___024root*>(voidSelf);
    VMixedVecFromVecTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
