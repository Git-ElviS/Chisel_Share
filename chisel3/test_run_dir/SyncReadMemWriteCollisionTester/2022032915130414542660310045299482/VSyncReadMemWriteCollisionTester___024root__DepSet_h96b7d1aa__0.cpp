...
void VSyncReadMemWriteCollisionTester___024root___sequent__TOP__0(VSyncReadMemWriteCollisionTester___024root* vlSelf);
...
void VSyncReadMemWriteCollisionTester___024root___eval(VSyncReadMemWriteCollisionTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSyncReadMemWriteCollisionTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VSyncReadMemWriteCollisionTester___024root___sequent__TOP__0(vlSelf);
...
void VSyncReadMemWriteCollisionTester___024root___eval_debug_assertions(VSyncReadMemWriteCollisionTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VSyncReadMemWriteCollisionTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSyncReadMemWriteCollisionTester___024root___eval_debug_assertions\n"); );
    // Body
