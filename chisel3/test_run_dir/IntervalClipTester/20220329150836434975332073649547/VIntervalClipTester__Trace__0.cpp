...
void VIntervalClipTester___024root__trace_chg_sub_0(VIntervalClipTester___024root* vlSelf, VerilatedVcd* tracep);

void VIntervalClipTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIntervalClipTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VIntervalClipTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VIntervalClipTester___024root__trace_chg_sub_0(VIntervalClipTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VIntervalClipTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIntervalClipTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VIntervalClipTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIntervalClipTester___024root__trace_cleanup\n"); );
    // Init
    VIntervalClipTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VIntervalClipTester___024root*>(voidSelf);
    VIntervalClipTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
