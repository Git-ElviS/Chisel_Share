...
void VBlackBoxTester___024root__trace_chg_sub_0(VBlackBoxTester___024root* vlSelf, VerilatedVcd* tracep);

void VBlackBoxTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VBlackBoxTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VBlackBoxTester___024root__trace_chg_sub_0(VBlackBoxTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBlackBoxTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VBlackBoxTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTester___024root__trace_cleanup\n"); );
    // Init
    VBlackBoxTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VBlackBoxTester___024root*>(voidSelf);
    VBlackBoxTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
