...
void VStrongEnumFSMTester___024root___sequent__TOP__0(VStrongEnumFSMTester___024root* vlSelf);
...
void VStrongEnumFSMTester___024root___eval(VStrongEnumFSMTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStrongEnumFSMTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VStrongEnumFSMTester___024root___sequent__TOP__0(vlSelf);
...
void VStrongEnumFSMTester___024root___eval_debug_assertions(VStrongEnumFSMTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VStrongEnumFSMTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStrongEnumFSMTester___024root___eval_debug_assertions\n"); );
    // Body
