...
void VSimpleOneHotTester___024root__trace_chg_sub_0(VSimpleOneHotTester___024root* vlSelf, VerilatedVcd* tracep);

void VSimpleOneHotTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSimpleOneHotTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VSimpleOneHotTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VSimpleOneHotTester___024root__trace_chg_sub_0(VSimpleOneHotTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VSimpleOneHotTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSimpleOneHotTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VSimpleOneHotTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSimpleOneHotTester___024root__trace_cleanup\n"); );
    // Init
    VSimpleOneHotTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VSimpleOneHotTester___024root*>(voidSelf);
    VSimpleOneHotTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
