...
void VAspectTester___024root___sequent__TOP__0(VAspectTester___024root* vlSelf);
...
void VAspectTester___024root___eval(VAspectTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAspectTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VAspectTester___024root___sequent__TOP__0(vlSelf);
    }
    // Final
...
void VAspectTester___024root___eval_debug_assertions(VAspectTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VAspectTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAspectTester___024root___eval_debug_assertions\n"); );
    // Body
