...
VL_INLINE_OPT void VEmptyFlushEdgecaseTester___024root___sequent__TOP__0(VEmptyFlushEdgecaseTester___024root* vlSelf) {
    ...
    CData/*3:0*/ __Vdlyvval__EmptyFlushEdgecaseTester__DOT__q__DOT__ram__v0;
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915130412737788078716144900/EmptyFlushEdgecaseTester.v", 550, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:574: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915130412737788078716144900/EmptyFlushEdgecaseTester.v", 574, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:596: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915130412737788078716144900/EmptyFlushEdgecaseTester.v", 596, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:620: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915130412737788078716144900/EmptyFlushEdgecaseTester.v", 620, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__value)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915130412737788078716144900/EmptyFlushEdgecaseTester.v", 644, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
                         ...
                         & (((0x13U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__outCnt))
                              ? 1U : ((0x12U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__outCnt))
                                       ? 9U : ((0x11U 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:655: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915130412737788078716144900/EmptyFlushEdgecaseTester.v", 655, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
    ...
    if (((~ (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__full)) 
        ...
        vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT____Vlvbound_h86dbd62e__0 
            = ((0x13U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__value))
                ? 1U : ((0x12U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__value))
                         ? 9U : ((0x11U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__value))
                                  ? 0xfU : ((0x10U 
    ...
    vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__do_deq 
        = (1U & (((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___q_io_deq_ready_T) 
                  >> 9U) & (~ (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__empty))));
}
