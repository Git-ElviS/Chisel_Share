...
void VEmptyFlushEdgecaseTester___024root__trace_chg_sub_0(VEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+32,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]),4);
        tracep->chgCData(oldp+33,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]),4);
        tracep->chgCData(oldp+34,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[2]),4);
