...
void VEmptyFlushEdgecaseTester___024root__trace_chg_sub_0(VEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+5,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram
                                 [vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value]),2);
        tracep->chgCData(oldp+6,(((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full) 
        ...
        tracep->chgBit(oldp+34,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value));
        tracep->chgBit(oldp+35,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value));
        tracep->chgBit(oldp+36,(((~ (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__full)) 
                                 & (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q_io_enq_valid))));
        tracep->chgBit(oldp+37,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+38,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+39,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+40,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+41,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+42,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__do_deq));
        tracep->chgBit(oldp+43,((1U & ((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value) 
