...
VL_MODULE(VEmptyFlushEdgecaseTester___024root) {
  public:
    ...
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value;
    ...
    VlUnpacked<CData/*1:0*/, 2> EmptyFlushEdgecaseTester__DOT__q__DOT__ram;
