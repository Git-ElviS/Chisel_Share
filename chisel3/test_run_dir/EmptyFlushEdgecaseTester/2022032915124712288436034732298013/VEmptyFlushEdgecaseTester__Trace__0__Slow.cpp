...
VL_ATTR_COLD void VEmptyFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+44,"ptr_diff", false,-1);
...
VL_ATTR_COLD void VEmptyFlushEdgecaseTester___024root__trace_full_sub_0(VEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+3,(((0x13U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__value))
    ...
    tracep->fullCData(oldp+6,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram
                              [vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value]),2);
    tracep->fullCData(oldp+7,(((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full) 
                                 ...
                                 ? 2U : 0U) | (1U & 
                                               ((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value) 
                                                - (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))))),2);
    ...
    tracep->fullCData(oldp+33,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]),2);
    tracep->fullCData(oldp+34,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]),2);
    tracep->fullBit(oldp+35,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value));
    tracep->fullBit(oldp+36,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value));
    tracep->fullBit(oldp+37,(((~ (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__full)) 
                              & (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q_io_enq_valid))));
    tracep->fullBit(oldp+38,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+39,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+40,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+41,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+42,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+43,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__do_deq));
    tracep->fullBit(oldp+44,((1U & ((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value) 
