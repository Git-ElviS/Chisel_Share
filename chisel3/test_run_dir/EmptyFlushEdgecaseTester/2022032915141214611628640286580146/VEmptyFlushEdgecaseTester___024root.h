...
VL_MODULE(VEmptyFlushEdgecaseTester___024root) {
  public:
    ...
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q_io_flush;
    ...
    CData/*1:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value;
    CData/*1:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__empty;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__full;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__do_enq;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__do_deq;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__wrap;
    CData/*1:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT___value_T_1;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__wrap_1;
    CData/*1:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT___value_T_3;
    CData/*1:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT__ptr_diff;
    CData/*0:0*/ EmptyFlushEdgecaseTester__DOT__q__DOT____Vlvbound_hd270ee13__0;
    ...
    VlUnpacked<CData/*0:0*/, 3> EmptyFlushEdgecaseTester__DOT__q__DOT__ram;
