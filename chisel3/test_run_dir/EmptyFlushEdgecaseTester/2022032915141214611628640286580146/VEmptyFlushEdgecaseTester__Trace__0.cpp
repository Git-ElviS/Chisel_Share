...
void VEmptyFlushEdgecaseTester___024root__trace_chg_sub_0(VEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+5,(((2U >= (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value)) 
        ...
        tracep->chgBit(oldp+32,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]));
        tracep->chgBit(oldp+33,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]));
        tracep->chgBit(oldp+34,(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[2]));
