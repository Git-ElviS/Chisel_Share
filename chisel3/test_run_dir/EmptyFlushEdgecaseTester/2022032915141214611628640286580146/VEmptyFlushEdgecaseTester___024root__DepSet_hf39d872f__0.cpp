...
VL_INLINE_OPT void VEmptyFlushEdgecaseTester___024root___sequent__TOP__0(VEmptyFlushEdgecaseTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:528: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915141214611628640286580146/EmptyFlushEdgecaseTester.v", 528, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
        ...
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
                         ...
                         & (0U != (3U & ((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match)
                                          ...
                                          : (((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value) 
                                              ...
                                              : (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ptr_diff)))))))) {
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:552: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915141214611628640286580146/EmptyFlushEdgecaseTester.v", 552, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:574: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915141214611628640286580146/EmptyFlushEdgecaseTester.v", 574, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:598: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915141214611628640286580146/EmptyFlushEdgecaseTester.v", 598, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__flushRegister) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__value)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915141214611628640286580146/EmptyFlushEdgecaseTester.v", 622, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
            ...
            VL_WRITEF("[%0t] %%Error: EmptyFlushEdgecaseTester.v:633: Assertion failed in %NEmptyFlushEdgecaseTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/EmptyFlushEdgecaseTester/2022032915141214611628640286580146/EmptyFlushEdgecaseTester.v", 633, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___T_1) 
    ...
    if (((~ (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__full)) 
        ...
        vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT____Vlvbound_hd270ee13__0 
    ...
    vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__do_deq 
        = (1U & (((IData)(vlSelf->EmptyFlushEdgecaseTester__DOT___q_io_deq_ready_T) 
                  >> 0xbU) & (~ (IData)(vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__empty))));
}
