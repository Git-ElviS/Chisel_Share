...
VL_ATTR_COLD void VEmptyFlushEdgecaseTester___024root___ctor_var_reset(VEmptyFlushEdgecaseTester___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(4);
    }
    ...
    vlSelf->EmptyFlushEdgecaseTester__DOT__q__DOT____Vlvbound_h86dbd62e__0 = VL_RAND_RESET_I(4);
