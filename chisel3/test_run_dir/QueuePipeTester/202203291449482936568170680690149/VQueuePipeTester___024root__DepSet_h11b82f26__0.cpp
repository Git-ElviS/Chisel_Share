...
VL_INLINE_OPT void VQueuePipeTester___024root___sequent__TOP__0(VQueuePipeTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueuePipeTester/202203291449482936568170680690149/QueuePipeTester.v", 428, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueuePipeTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueuePipeTester/202203291449482936568170680690149/QueuePipeTester.v", 452, "");
        }
    }
    ...
    } else if ((IData)((((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
    ...
    __Vtableidx1 = (((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value) 
                     << 4U) | (((IData)((((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                          >> 0xfU) 
                                         & (~ (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__empty)))) 
                                << 3U) | (((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
                                           << 2U) | 
                                          ((((IData)(vlSelf->QueuePipeTester__DOT__q_io_enq_ready) 
                                             & (0x14U 
    ...
    vlSelf->QueuePipeTester__DOT__q_io_enq_ready = 
        (1U & (((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                >> 0xfU) | (~ ((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__ptr_match) 
                               & (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__maybe_full)))));
