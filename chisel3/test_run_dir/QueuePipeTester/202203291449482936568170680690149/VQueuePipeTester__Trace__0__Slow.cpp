...
VL_ATTR_COLD void VQueuePipeTester___024root__trace_full_sub_0(VQueuePipeTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+3,((1U & ((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                   >> 0xfU))));
    tracep->fullBit(oldp+4,((1U & (~ (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__empty)))));
    tracep->fullCData(oldp+5,(((((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__maybe_full) 
                                 & (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__ptr_match))
                                 ? 2U : 0U) | (1U & 
                                               ((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
                                                - (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value))))),2);
    tracep->fullBit(oldp+6,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_0));
    tracep->fullBit(oldp+7,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_1));
    tracep->fullBit(oldp+8,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_2));
    tracep->fullBit(oldp+9,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_3));
    tracep->fullBit(oldp+10,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_4));
    tracep->fullBit(oldp+11,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_5));
    tracep->fullBit(oldp+12,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_6));
    tracep->fullBit(oldp+13,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_7));
    tracep->fullBit(oldp+14,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_8));
    tracep->fullBit(oldp+15,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_9));
    tracep->fullBit(oldp+16,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_10));
    tracep->fullBit(oldp+17,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_11));
    tracep->fullBit(oldp+18,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_12));
    tracep->fullBit(oldp+19,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_13));
    tracep->fullBit(oldp+20,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_14));
    tracep->fullBit(oldp+21,(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_15));
    tracep->fullCData(oldp+22,(vlSelf->QueuePipeTester__DOT__value),5);
    tracep->fullCData(oldp+23,(vlSelf->QueuePipeTester__DOT__value_1),5);
    tracep->fullCData(oldp+24,((((IData)(vlSelf->QueuePipeTester__DOT__q_io_deq_ready_prng__DOT__state_7) 
    ...
    tracep->fullBit(oldp+25,((0x14U == (IData)(vlSelf->QueuePipeTester__DOT__value))));
    tracep->fullBit(oldp+26,((0x14U == (IData)(vlSelf->QueuePipeTester__DOT__value_1))));
    tracep->fullBit(oldp+27,(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value));
    tracep->fullBit(oldp+28,(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value));
    tracep->fullBit(oldp+29,(vlSelf->QueuePipeTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+30,(vlSelf->QueuePipeTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+31,(vlSelf->QueuePipeTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+32,(((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__ptr_match) 
                              & (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__maybe_full))));
    tracep->fullBit(oldp+33,(((IData)(vlSelf->QueuePipeTester__DOT__q_io_enq_ready) 
                              & (0x14U > (IData)(vlSelf->QueuePipeTester__DOT__value)))));
    tracep->fullBit(oldp+34,((IData)((((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                       >> 0xfU) & (~ (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__empty))))));
    tracep->fullBit(oldp+35,((1U & ((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
