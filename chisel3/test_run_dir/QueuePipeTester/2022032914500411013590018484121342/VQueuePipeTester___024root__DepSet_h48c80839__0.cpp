...
void VQueuePipeTester___024root___sequent__TOP__0(VQueuePipeTester___024root* vlSelf);
...
void VQueuePipeTester___024root___eval(VQueuePipeTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueuePipeTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VQueuePipeTester___024root___sequent__TOP__0(vlSelf);
...
void VQueuePipeTester___024root___eval_debug_assertions(VQueuePipeTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VQueuePipeTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VQueuePipeTester___024root___eval_debug_assertions\n"); );
    // Body
