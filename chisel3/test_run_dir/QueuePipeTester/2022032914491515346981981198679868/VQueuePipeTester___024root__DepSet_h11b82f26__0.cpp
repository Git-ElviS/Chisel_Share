...
VL_INLINE_OPT void VQueuePipeTester___024root___sequent__TOP__0(VQueuePipeTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueuePipeTester/2022032914491515346981981198679868/QueuePipeTester.v", 428, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueuePipeTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueuePipeTester/2022032914491515346981981198679868/QueuePipeTester.v", 452, "");
        }
    }
    ...
    __Vtableidx1 = (((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value) 
                     << 4U) | ((8U & (((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                       << 1U) & ((~ (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__empty)) 
                                                 << 3U))) 
                               | (((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
