...
VL_INLINE_OPT void VQueuePipeTester___024root___sequent__TOP__0(VQueuePipeTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
                               & (~ ((IData)(vlSelf->QueuePipeTester__DOT__q_io_enq_ready) 
                                     | ((4U == ((((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__maybe_full) 
                                        ...
                                        & (~ ((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                              >> 2U))))))))) {
            VL_WRITEF("[%0t] %%Error: QueuePipeTester.v:430: Assertion failed in %NQueuePipeTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueuePipeTester/2022032914485812775026186663123101/QueuePipeTester.v", 430, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & ((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->QueuePipeTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/QueuePipeTester/2022032914485812775026186663123101/QueuePipeTester.v", 454, "");
        }
    }
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value = 0U;
        vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value = 0U;
    } else {
        if (((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__do_enq) 
        ...
        if ((1U & (((IData)(vlSelf->QueuePipeTester__DOT___q_io_deq_ready_T) 
                    >> 2U) & (~ (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__empty))))) {
            vlSelf->QueuePipeTester__DOT__value_1 = 
                ((IData)(vlSelf->QueuePipeTester__DOT__wrap_1)
                  ? 0U : (IData)(vlSelf->QueuePipeTester__DOT___value_T_3));
        }
        if (vlSelf->QueuePipeTester__DOT__q__DOT__do_enq) {
            vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value 
                = vlSelf->QueuePipeTester__DOT__q__DOT___value_T_1;
        }
        if (vlSelf->QueuePipeTester__DOT__q__DOT__do_deq) {
            vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value 
                = vlSelf->QueuePipeTester__DOT__q__DOT___value_T_3;
        }
    }
    ...
    vlSelf->QueuePipeTester__DOT__q__DOT___value_T_1 
        = (3U & ((IData)(1U) + (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value)));
    vlSelf->QueuePipeTester__DOT__q__DOT___value_T_3 
        = (3U & ((IData)(1U) + (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value)));
