...
VL_ATTR_COLD void VQueuePipeTester___024root___ctor_var_reset(VQueuePipeTester___024root* vlSelf) {
    ...
    vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    ...
    vlSelf->QueuePipeTester__DOT__q__DOT__do_enq = VL_RAND_RESET_I(1);
    vlSelf->QueuePipeTester__DOT__q__DOT__do_deq = VL_RAND_RESET_I(1);
    vlSelf->QueuePipeTester__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->QueuePipeTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
