...
VL_ATTR_COLD void VQueuePipeTester___024root__trace_full_sub_0(VQueuePipeTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+5,(((((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__maybe_full) 
                                 ...
                                 ? 4U : 0U) | (3U & 
                                               ((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
                                                - (IData)(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value))))),3);
    ...
    tracep->fullCData(oldp+27,(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullCData(oldp+28,(vlSelf->QueuePipeTester__DOT__q__DOT__deq_ptr_value),2);
    ...
    tracep->fullBit(oldp+33,(vlSelf->QueuePipeTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+34,(vlSelf->QueuePipeTester__DOT__q__DOT__do_deq));
    tracep->fullCData(oldp+35,((3U & ((IData)(vlSelf->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
