...
void VBlackBoxWithClockTester___024root___sequent__TOP__0(VBlackBoxWithClockTester___024root* vlSelf);
...
void VBlackBoxWithClockTester___024root___eval(VBlackBoxWithClockTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxWithClockTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VBlackBoxWithClockTester___024root___sequent__TOP__0(vlSelf);
...
void VBlackBoxWithClockTester___024root___eval_debug_assertions(VBlackBoxWithClockTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VBlackBoxWithClockTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxWithClockTester___024root___eval_debug_assertions\n"); );
    // Body
