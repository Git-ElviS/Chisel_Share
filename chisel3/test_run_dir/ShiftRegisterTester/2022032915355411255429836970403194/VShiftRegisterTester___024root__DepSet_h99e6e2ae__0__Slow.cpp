...
VL_ATTR_COLD void VShiftRegisterTester___024root___ctor_var_reset(VShiftRegisterTester___024root* vlSelf) {
    ...
    vlSelf->ShiftRegisterTester__DOT__cnt = VL_RAND_RESET_I(2);
    vlSelf->ShiftRegisterTester__DOT___wrap_value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->ShiftRegisterTester__DOT__shifter_0 = VL_RAND_RESET_I(1);
    vlSelf->ShiftRegisterTester__DOT__shifter_1 = VL_RAND_RESET_I(1);
