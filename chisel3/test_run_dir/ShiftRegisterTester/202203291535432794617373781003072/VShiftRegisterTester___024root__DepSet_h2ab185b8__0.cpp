...
VL_INLINE_OPT void VShiftRegisterTester___024root___sequent__TOP__0(VShiftRegisterTester___024root* vlSelf) {
        ...
        if (VL_UNLIKELY((((3U <= (IData)(vlSelf->ShiftRegisterTester__DOT__cnt)) 
                         ...
                         & ((IData)(vlSelf->ShiftRegisterTester__DOT__shifter_0) 
                            != (7U & ((IData)(vlSelf->ShiftRegisterTester__DOT__cnt) 
                                      - (IData)(3U))))))) {
            VL_WRITEF("[%0t] %%Error: ShiftRegisterTester.v:37: Assertion failed in %NShiftRegisterTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftRegisterTester/202203291535432794617373781003072/ShiftRegisterTester.v", 37, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((3U <= (IData)(vlSelf->ShiftRegisterTester__DOT__cnt)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((5U == (IData)(vlSelf->ShiftRegisterTester__DOT__cnt)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftRegisterTester/202203291535432794617373781003072/ShiftRegisterTester.v", 59, "");
        }
    }
