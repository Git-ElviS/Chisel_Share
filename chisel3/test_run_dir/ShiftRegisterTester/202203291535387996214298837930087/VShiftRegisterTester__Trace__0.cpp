...
void VShiftRegisterTester___024root__trace_chg_sub_0(VShiftRegisterTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgBit(oldp+0,(vlSelf->ShiftRegisterTester__DOT__cnt));
        tracep->chgBit(oldp+1,(vlSelf->ShiftRegisterTester__DOT__shifter_0));
        tracep->chgBit(oldp+2,((1U & ((IData)(vlSelf->ShiftRegisterTester__DOT__cnt) 
                                      - (IData)(1U)))));
    }
