...
VL_ATTR_COLD void VShiftRegisterTester___024root__trace_init_sub__TOP__0(VShiftRegisterTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"shifter_3", false,-1, 1,0);
    tracep->declBus(c+7,"expected", false,-1, 2,0);
...
VL_ATTR_COLD void VShiftRegisterTester___024root__trace_full_sub_0(VShiftRegisterTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+2,((7U == (IData)(vlSelf->ShiftRegisterTester__DOT__cnt))));
    ...
    tracep->fullCData(oldp+6,(vlSelf->ShiftRegisterTester__DOT__shifter_3),2);
    tracep->fullCData(oldp+7,((7U & ((IData)(vlSelf->ShiftRegisterTester__DOT__cnt) 
                                     - (IData)(4U)))),3);
