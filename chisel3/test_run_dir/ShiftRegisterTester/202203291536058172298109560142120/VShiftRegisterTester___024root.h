...
VL_MODULE(VShiftRegisterTester___024root) {
  public:
    ...
    VL_IN8(clock,0,0);
    VL_IN8(reset,0,0);
    CData/*2:0*/ ShiftRegisterTester__DOT__cnt;
    CData/*2:0*/ ShiftRegisterTester__DOT___wrap_value_T_1;
    CData/*1:0*/ ShiftRegisterTester__DOT__shifter_0;
    CData/*1:0*/ ShiftRegisterTester__DOT__shifter_1;
    CData/*1:0*/ ShiftRegisterTester__DOT__shifter_2;
    CData/*1:0*/ ShiftRegisterTester__DOT__shifter_3;
