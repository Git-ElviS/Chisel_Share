...
void VFill2DTester___024root__trace_chg_sub_0(VFill2DTester___024root* vlSelf, VerilatedVcd* tracep);

void VFill2DTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFill2DTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VFill2DTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VFill2DTester___024root__trace_chg_sub_0(VFill2DTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VFill2DTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFill2DTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VFill2DTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFill2DTester___024root__trace_cleanup\n"); );
    // Init
    VFill2DTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VFill2DTester___024root*>(voidSelf);
    VFill2DTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
