...
VL_INLINE_OPT void VPRNGUpdateSeedTest___024root___sequent__TOP__0(VPRNGUpdateSeedTest___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((3U == (IData)(vlSelf->PRNGUpdateSeedTest__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (6U != (((IData)(vlSelf->PRNGUpdateSeedTest__DOT__a__DOT__state_15) 
            ...
            VL_WRITEF("[%0t] %%Error: PRNGUpdateSeedTest.v:322: Assertion failed in %NPRNGUpdateSeedTest\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/PRNGUpdateSeedTest/202203291518289687840811531253123/PRNGUpdateSeedTest.v", 322, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((3U == (IData)(vlSelf->PRNGUpdateSeedTest__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlSelf->PRNGUpdateSeedTest__DOT__count)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/PRNGUpdateSeedTest/202203291518289687840811531253123/PRNGUpdateSeedTest.v", 346, "");
        }
    }
    __Vdly__PRNGUpdateSeedTest__DOT__a__DOT__state_1 
