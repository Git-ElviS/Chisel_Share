...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root___ctor_var_reset(VThingsPassThroughFlushQueueTester___024root* vlSelf) {
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(1);
