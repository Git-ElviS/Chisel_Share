...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_init_sub__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+39,"clock", false,-1);
    tracep->declBit(c+40,"reset", false,-1);
    tracep->declBit(c+39,"q_clock", false,-1);
    tracep->declBit(c+40,"q_reset", false,-1);
    ...
    tracep->declBit(c+39,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+40,"q_io_deq_ready_prng_reset", false,-1);
    ...
    tracep->declBit(c+31,"enq_ptr_value", false,-1);
    tracep->declBit(c+30,"deq_ptr_value", false,-1);
...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_full_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value));
    tracep->fullBit(oldp+31,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value));
    tracep->fullBit(oldp+32,(((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)))));
    tracep->fullBit(oldp+33,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+34,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+35,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+36,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+37,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+38,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq));
