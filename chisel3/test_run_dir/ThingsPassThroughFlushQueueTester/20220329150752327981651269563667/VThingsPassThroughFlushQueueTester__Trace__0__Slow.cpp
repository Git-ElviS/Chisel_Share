...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_init_sub__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+32,"clock", false,-1);
    tracep->declBit(c+33,"reset", false,-1);
    tracep->declBit(c+32,"q_clock", false,-1);
    tracep->declBit(c+33,"q_reset", false,-1);
    ...
    tracep->declBit(c+32,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+33,"q_io_deq_ready_prng_reset", false,-1);
    ...
    tracep->declBit(c+35,"ram_MPORT_addr", false,-1);
    tracep->declBit(c+34,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+29,"ram_MPORT_en", false,-1);
    tracep->declBit(c+5,"maybe_full", false,-1);
    tracep->declBit(c+1,"empty", false,-1);
    tracep->declBit(c+30,"do_enq", false,-1);
    tracep->declBit(c+31,"do_deq", false,-1);
...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_full_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+3,(((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
    ...
    tracep->fullBit(oldp+6,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram
                            [0U]));
    ...
    tracep->fullBit(oldp+28,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[0]));
    tracep->fullBit(oldp+29,(((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)))));
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+31,((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                               >> 0xcU) & (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full))));
    tracep->fullBit(oldp+32,(vlSelf->clock));
    tracep->fullBit(oldp+33,(vlSelf->reset));
