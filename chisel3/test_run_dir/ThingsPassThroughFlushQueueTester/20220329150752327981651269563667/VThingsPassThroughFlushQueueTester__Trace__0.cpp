...
void VThingsPassThroughFlushQueueTester___024root__trace_chg_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+5,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram
                               [0U]));
        ...
        tracep->chgBit(oldp+28,(((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full)) 
                                 & (0x14U > (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)))));
        tracep->chgBit(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+30,((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                                  >> 0xcU) & (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full))));
    }
    tracep->chgBit(oldp+31,(vlSelf->clock));
    tracep->chgBit(oldp+32,(vlSelf->reset));
}
