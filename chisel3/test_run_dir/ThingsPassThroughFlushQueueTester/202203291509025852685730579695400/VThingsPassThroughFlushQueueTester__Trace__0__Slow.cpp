...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_full_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+6,(((2U >= (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0)) 
    ...
    tracep->fullBit(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[1]));
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[2]));
