...
VL_MODULE(VThingsPassThroughFlushQueueTester___024root) {
  public:
    ...
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT____Vlvbound_hd270ee13__0;
    ...
    VlUnpacked<CData/*0:0*/, 3> ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram;
