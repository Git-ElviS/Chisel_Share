...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root___ctor_var_reset(VThingsPassThroughFlushQueueTester___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(1);
    }
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0 = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 = VL_RAND_RESET_I(2);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full = VL_RAND_RESET_I(1);
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT____Vlvbound_hd270ee13__0 = VL_RAND_RESET_I(1);
