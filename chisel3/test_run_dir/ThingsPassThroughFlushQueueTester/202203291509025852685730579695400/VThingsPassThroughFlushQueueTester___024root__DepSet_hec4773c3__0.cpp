...
VL_INLINE_OPT void VThingsPassThroughFlushQueueTester___024root___sequent__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf) {
    ...
    // Init
    CData/*1:0*/ __Vdlyvdim0__ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram__v0;
    CData/*0:0*/ __Vdlyvval__ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram__v0;
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                            >> 7U) & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                             | ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                                | ((0x11U != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                                   & ((0x10U != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                                      & ((0xfU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                                         & ((0xeU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                                            & ((0xdU 
                                                                 ...
                                                                 & ((6U 
                                                                    ...
                                                                    | ((5U 
                                                                       ...
                                                                       | ((4U 
                                                                          ...
                                                                          & (3U 
                                                                             != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)))))))))))))))))) 
                            != ((2U >= (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0)) 
            ...
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughFlushQueueTester.v:521: Assertion failed in %NThingsPassThroughFlushQueueTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/202203291509025852685730579695400/ThingsPassThroughFlushQueueTester.v", 521, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/202203291509025852685730579695400/ThingsPassThroughFlushQueueTester.v", 544, "");
        }
    }
    ...
    if (((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full)) 
        ...
        vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT____Vlvbound_hd270ee13__0 
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
               | ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                  | ((0x11U != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                     & ((0x10U != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                        & ((0xfU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                           & ((0xeU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                              & ((0xdU == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                                 | ((0xcU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                                    & ((0xbU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                                       & ((0xaU != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                                          & ((9U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)) 
                                             | ((8U 
                                                   ...
                                                   & ((6U 
                                                      ...
                                                      | ((5U 
                                                         ...
                                                         | ((4U 
                                                            ...
                                                            & (3U 
                                                               != (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))))))))))))))))));
        if ((2U >= (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value))) {
    ...
    } else if ((1U & (((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                       >> 7U) & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty))))) {
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 
        = (3U & ((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq)
                  ? ((2U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value))
                      ? 0U : ((IData)(1U) + (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value)))
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value = 0U;
    } else {
        ...
        if (vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq) {
            vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value 
                = ((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap)
                    ? 0U : (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_1));
        }
    }
    ...
    if (vlSelf->reset) {
        vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value = 0U;
    } else if (vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq) {
        vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value 
            = ((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap_1)
                ? 0U : (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_3));
    }
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap 
        = (2U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value));
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_1 
        = (3U & ((IData)(1U) + (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value)));
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap_1 
        = (2U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value));
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_3 
        = (3U & ((IData)(1U) + (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value)));
