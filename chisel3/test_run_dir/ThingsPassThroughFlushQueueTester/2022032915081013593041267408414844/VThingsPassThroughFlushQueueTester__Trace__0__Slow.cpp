...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_init_sub__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+43,"ram_io_deq_bits_MPORT_en", false,-1);
    ...
    tracep->declBus(c+32,"deq_ptr_value", false,-1, 1,0);
...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_full_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+3,(((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                ? 0U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                         ? 5U : ((0x11U 
    ...
    tracep->fullCData(oldp+6,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram
                              [vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value]),3);
    ...
    tracep->fullCData(oldp+28,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[0]),3);
    tracep->fullCData(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[1]),3);
    tracep->fullCData(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[2]),3);
    tracep->fullCData(oldp+31,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[3]),3);
    tracep->fullCData(oldp+32,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value),2);
    ...
    tracep->fullBit(oldp+35,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+36,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+37,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+38,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+39,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+40,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq));
