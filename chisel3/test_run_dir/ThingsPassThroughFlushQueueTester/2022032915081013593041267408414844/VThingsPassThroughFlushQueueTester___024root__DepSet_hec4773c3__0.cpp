...
VL_INLINE_OPT void VThingsPassThroughFlushQueueTester___024root___sequent__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf) {
    ...
    CData/*2:0*/ __Vdlyvval__ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram__v0;
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                            >> 0xcU) & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
            ...
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughFlushQueueTester.v:494: Assertion failed in %NThingsPassThroughFlushQueueTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/2022032915081013593041267408414844/ThingsPassThroughFlushQueueTester.v", 494, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/2022032915081013593041267408414844/ThingsPassThroughFlushQueueTester.v", 517, "");
        }
    }
        ...
        __Vdlyvval__ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram__v0 
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                ? 0U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                         ? 5U : ((0x11U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                  ? 6U : ((0x10U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                           ? 5U : (
                                                   (0xfU 
