...
void VThingsPassThroughFlushQueueTester___024root__trace_chg_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+27,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[0]),3);
        tracep->chgCData(oldp+28,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[1]),3);
        tracep->chgCData(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[2]),3);
        tracep->chgCData(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[3]),3);
        tracep->chgCData(oldp+31,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value),2);
        ...
        tracep->chgBit(oldp+34,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+35,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+36,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+37,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+38,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+39,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq));
    }
    tracep->chgBit(oldp+40,(vlSelf->clock));
    tracep->chgBit(oldp+41,(vlSelf->reset));
}
