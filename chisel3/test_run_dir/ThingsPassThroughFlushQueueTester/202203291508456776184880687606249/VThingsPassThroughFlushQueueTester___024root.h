...
VL_MODULE(VThingsPassThroughFlushQueueTester___024root) {
  public:
    ...
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0;
    ...
    VlUnpacked<CData/*3:0*/, 1> ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram;
