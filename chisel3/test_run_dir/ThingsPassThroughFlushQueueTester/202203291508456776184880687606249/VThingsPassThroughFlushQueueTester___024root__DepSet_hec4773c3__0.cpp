...
VL_INLINE_OPT void VThingsPassThroughFlushQueueTester___024root___sequent__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                         ...
                         & (((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1))
                              ? 9U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1))
                                       ? 8U : ((0x11U 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/202203291508456776184880687606249/ThingsPassThroughFlushQueueTester.v", 484, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/202203291508456776184880687606249/ThingsPassThroughFlushQueueTester.v", 507, "");
        }
    }
        ...
        __Vdlyvval__ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram__v0 
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                ? 9U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                         ? 8U : ((0x11U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                  ? 0xcU : ((0x10U 
