...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_init_sub__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+37,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+31,"ram_MPORT_en", false,-1);
    tracep->declBit(c+29,"ram_io_deq_bits_MPORT_en_pipe_0", false,-1);
    tracep->declBit(c+30,"ram_io_deq_bits_MPORT_addr_pipe_0", false,-1);
...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_full_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullBit(oldp+1,((1U & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full)))));
    ...
    tracep->fullCData(oldp+3,(((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                ? 9U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                         ? 8U : ((0x11U 
    ...
    tracep->fullBit(oldp+4,((1U & ((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                                   >> 0xaU))));
    tracep->fullBit(oldp+5,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full));
    tracep->fullCData(oldp+6,(((0U >= (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0))
    ...
    tracep->fullCData(oldp+28,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[0]),4);
    tracep->fullBit(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
    tracep->fullBit(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
    tracep->fullBit(oldp+31,(((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)))));
    tracep->fullBit(oldp+32,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+33,((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                               >> 0xaU) & (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full))));
    tracep->fullBit(oldp+34,(vlSelf->clock));
    tracep->fullBit(oldp+35,(vlSelf->reset));
    tracep->fullBit(oldp+36,(0U));
    tracep->fullBit(oldp+37,(1U));
}
