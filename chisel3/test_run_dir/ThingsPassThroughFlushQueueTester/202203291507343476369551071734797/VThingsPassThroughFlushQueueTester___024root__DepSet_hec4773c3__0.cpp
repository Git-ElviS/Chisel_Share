...
VL_INLINE_OPT void VThingsPassThroughFlushQueueTester___024root___sequent__TOP__0(VThingsPassThroughFlushQueueTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                            >> 0xfU) & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty))) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1))
                              ? 0U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1))
                                       ? 0xbU : ((0x11U 
            ...
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughFlushQueueTester.v:516: Assertion failed in %NThingsPassThroughFlushQueueTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/202203291507343476369551071734797/ThingsPassThroughFlushQueueTester.v", 516, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value_1)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ThingsPassThroughFlushQueueTester/202203291507343476369551071734797/ThingsPassThroughFlushQueueTester.v", 539, "");
        }
    }
        ...
        __Vdlyvval__ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram__v0 
            = ((0x13U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                ? 0U : ((0x12U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                         ? 0xbU : ((0x11U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value))
                                    ? 0xaU : ((0x10U 
    ...
    } else if ((IData)((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                         >> 0xfU) & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty))))) {
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 
        = (3U & ((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq)
                  ? ((3U == (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value))
    ...
    vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq 
        = (IData)((((IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT___q_io_deq_ready_T) 
                    >> 0xfU) & (~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty))));
}
