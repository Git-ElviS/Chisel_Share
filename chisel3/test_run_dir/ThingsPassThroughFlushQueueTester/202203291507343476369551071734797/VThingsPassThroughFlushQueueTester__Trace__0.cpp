...
void VThingsPassThroughFlushQueueTester___024root__trace_chg_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[2]),4);
        tracep->chgCData(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[3]),4);
        tracep->chgBit(oldp+31,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
        tracep->chgCData(oldp+32,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0),2);
        tracep->chgCData(oldp+33,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value),2);
        tracep->chgBit(oldp+34,(((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)))));
        tracep->chgCData(oldp+35,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->chgBit(oldp+36,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+37,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+38,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+39,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+40,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+41,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq));
    }
