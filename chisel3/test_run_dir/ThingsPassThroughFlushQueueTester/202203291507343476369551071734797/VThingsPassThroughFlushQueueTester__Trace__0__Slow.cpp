...
VL_ATTR_COLD void VThingsPassThroughFlushQueueTester___024root__trace_full_sub_0(VThingsPassThroughFlushQueueTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram
                              [vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]),4);
    ...
    tracep->fullCData(oldp+29,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[1]),4);
    tracep->fullCData(oldp+30,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[2]),4);
    tracep->fullCData(oldp+31,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram[3]),4);
    tracep->fullBit(oldp+32,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0));
    tracep->fullCData(oldp+33,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0),2);
    tracep->fullCData(oldp+34,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullBit(oldp+35,(((~ (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->ThingsPassThroughFlushQueueTester__DOT__value)))));
    tracep->fullCData(oldp+36,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value),2);
    tracep->fullBit(oldp+37,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+38,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+39,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+40,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+41,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+42,(vlSelf->ThingsPassThroughFlushQueueTester__DOT__q__DOT__do_deq));
