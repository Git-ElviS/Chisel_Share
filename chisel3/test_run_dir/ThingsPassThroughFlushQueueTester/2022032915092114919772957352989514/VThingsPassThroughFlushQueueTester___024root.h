...
VL_MODULE(VThingsPassThroughFlushQueueTester___024root) {
  public:
    ...
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_en_pipe_0;
    CData/*1:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0;
    CData/*1:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__enq_ptr_value;
    CData/*1:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__deq_ptr_value;
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__maybe_full;
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__ptr_match;
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__empty;
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__full;
    ...
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap;
    CData/*1:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_1;
    CData/*0:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT__wrap_1;
    CData/*1:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT___value_T_3;
    CData/*1:0*/ ThingsPassThroughFlushQueueTester__DOT__q__DOT____Vlvbound_h7234a2a6__0;
    ...
    VlUnpacked<CData/*1:0*/, 3> ThingsPassThroughFlushQueueTester__DOT__q__DOT__ram;
