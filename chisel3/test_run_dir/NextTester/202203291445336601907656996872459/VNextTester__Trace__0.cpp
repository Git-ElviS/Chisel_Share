...
void VNextTester___024root__trace_chg_sub_0(VNextTester___024root* vlSelf, VerilatedVcd* tracep);

void VNextTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNextTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VNextTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VNextTester___024root__trace_chg_sub_0(VNextTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VNextTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNextTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VNextTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNextTester___024root__trace_cleanup\n"); );
    // Init
    VNextTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VNextTester___024root*>(voidSelf);
    VNextTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
