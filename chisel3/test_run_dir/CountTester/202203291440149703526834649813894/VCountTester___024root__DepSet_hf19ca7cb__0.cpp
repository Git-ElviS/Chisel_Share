...
VL_INLINE_OPT void VCountTester___024root___sequent__TOP__0(VCountTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->CountTester__DOT__value) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/CountTester/202203291440149703526834649813894/CountTester.v", 21, "");
        }
    }
