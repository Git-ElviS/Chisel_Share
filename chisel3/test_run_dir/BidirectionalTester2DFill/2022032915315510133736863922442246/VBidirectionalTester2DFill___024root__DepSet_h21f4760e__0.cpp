...
VL_INLINE_OPT void VBidirectionalTester2DFill___024root___sequent__TOP__0(VBidirectionalTester2DFill___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/BidirectionalTester2DFill/2022032915315510133736863922442246/BidirectionalTester2DFill.v", 11, "");
        }
    }
}
