...
void VMultiPrintfTester___024root__trace_chg_sub_0(VMultiPrintfTester___024root* vlSelf, VerilatedVcd* tracep);

void VMultiPrintfTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiPrintfTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VMultiPrintfTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VMultiPrintfTester___024root__trace_chg_sub_0(VMultiPrintfTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMultiPrintfTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiPrintfTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VMultiPrintfTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiPrintfTester___024root__trace_cleanup\n"); );
    // Init
    VMultiPrintfTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VMultiPrintfTester___024root*>(voidSelf);
    VMultiPrintfTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
