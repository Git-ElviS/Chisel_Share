...
VL_INLINE_OPT void VShiftsTester___024root___sequent__TOP__0(VShiftsTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftsTester__DOT__REG) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0x19U != (IData)(vlSelf->ShiftsTester__DOT__srs_0))))) {
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:38: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftsTester/202203291450053473591595783255272/ShiftsTester.v", 38, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftsTester__DOT__REG) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftsTester__DOT__REG) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0x18U != (IData)(vlSelf->ShiftsTester__DOT__srs_1))))) {
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:60: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftsTester/202203291450053473591595783255272/ShiftsTester.v", 60, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftsTester__DOT__REG) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftsTester__DOT__REG) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0x17U != (IData)(vlSelf->ShiftsTester__DOT__srs_2))))) {
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:82: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftsTester/202203291450053473591595783255272/ShiftsTester.v", 82, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->ShiftsTester__DOT__REG) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->ShiftsTester__DOT__REG) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ShiftsTester/202203291450053473591595783255272/ShiftsTester.v", 104, "");
        }
    }
    vlSelf->ShiftsTester__DOT__srs_2 = __Vdly__ShiftsTester__DOT__srs_2;
    vlSelf->ShiftsTester__DOT__REG = (2U == (IData)(vlSelf->ShiftsTester__DOT__cntVal));
    ...
    vlSelf->ShiftsTester__DOT__cntVal = ((IData)(vlSelf->reset)
                                          ? 0U : ((IData)(vlSelf->ShiftsTester__DOT__wrap_wrap)
                                                   ? 0U
