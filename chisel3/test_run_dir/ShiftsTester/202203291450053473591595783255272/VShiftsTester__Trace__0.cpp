...
void VShiftsTester___024root__trace_chg_sub_0(VShiftsTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+1,((2U == (IData)(vlSelf->ShiftsTester__DOT__cntVal))));
        tracep->chgCData(oldp+2,(vlSelf->ShiftsTester__DOT__srs_0),5);
        tracep->chgCData(oldp+3,(vlSelf->ShiftsTester__DOT__srs_1),5);
        tracep->chgCData(oldp+4,(vlSelf->ShiftsTester__DOT__srs_2),5);
