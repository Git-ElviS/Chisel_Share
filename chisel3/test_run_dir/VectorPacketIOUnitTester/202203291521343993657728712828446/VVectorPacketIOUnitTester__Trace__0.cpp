...
void VVectorPacketIOUnitTester___024root__trace_chg_sub_0(VVectorPacketIOUnitTester___024root* vlSelf, VerilatedVcd* tracep);

void VVectorPacketIOUnitTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VVectorPacketIOUnitTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VVectorPacketIOUnitTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VVectorPacketIOUnitTester___024root__trace_chg_sub_0(VVectorPacketIOUnitTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VVectorPacketIOUnitTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VVectorPacketIOUnitTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VVectorPacketIOUnitTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VVectorPacketIOUnitTester___024root__trace_cleanup\n"); );
    // Init
    VVectorPacketIOUnitTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VVectorPacketIOUnitTester___024root*>(voidSelf);
    VVectorPacketIOUnitTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
