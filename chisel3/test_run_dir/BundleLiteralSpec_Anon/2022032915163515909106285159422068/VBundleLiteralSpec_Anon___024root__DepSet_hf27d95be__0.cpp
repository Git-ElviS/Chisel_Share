...
VL_INLINE_OPT void VBundleLiteralSpec_Anon___024root___sequent__TOP__0(VBundleLiteralSpec_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((~ (IData)(vlSelf->reset)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/BundleLiteralSpec_Anon/2022032915163515909106285159422068/BundleLiteralSpec_Anon.v", 22, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((~ (IData)(vlSelf->reset)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/BundleLiteralSpec_Anon/2022032915163515909106285159422068/BundleLiteralSpec_Anon.v", 46, "");
        }
    }
    vlSelf->BundleLiteralSpec_Anon__DOT__r_a = ((IData)(vlSelf->reset)
                                                 ? 0x2aU
                                                 : (IData)(vlSelf->BundleLiteralSpec_Anon__DOT___r_a_T_1));
    vlSelf->BundleLiteralSpec_Anon__DOT___r_a_T_1 = 
        (0xffU & ((IData)(1U) + (IData)(vlSelf->BundleLiteralSpec_Anon__DOT__r_a)));
}
