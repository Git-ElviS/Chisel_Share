...
VL_ATTR_COLD void VBundleLiteralSpec_Anon___024root__trace_init_sub__TOP__0(VBundleLiteralSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+4,"clock", false,-1);
    tracep->declBit(c+5,"reset", false,-1);
    tracep->declBus(c+1,"r_a", false,-1, 7,0);
    tracep->declBit(c+2,"r_b", false,-1);
    tracep->declBit(c+3,"r_c", false,-1);
...
VL_ATTR_COLD void VBundleLiteralSpec_Anon___024root__trace_full_sub_0(VBundleLiteralSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullCData(oldp+1,(vlSelf->BundleLiteralSpec_Anon__DOT__r_a),8);
    tracep->fullBit(oldp+2,(vlSelf->BundleLiteralSpec_Anon__DOT__r_b));
    tracep->fullBit(oldp+3,(vlSelf->BundleLiteralSpec_Anon__DOT__r_c));
