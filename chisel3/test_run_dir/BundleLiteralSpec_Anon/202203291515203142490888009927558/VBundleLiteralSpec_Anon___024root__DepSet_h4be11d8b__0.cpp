...
VL_INLINE_OPT void VBundleLiteralSpec_Anon___024root___sequent__TOP__0(VBundleLiteralSpec_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/BundleLiteralSpec_Anon/202203291515203142490888009927558/BundleLiteralSpec_Anon.v", 12, "");
        }
    }
}
