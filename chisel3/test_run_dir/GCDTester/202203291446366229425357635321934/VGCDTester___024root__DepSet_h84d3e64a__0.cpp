...
VL_INLINE_OPT void VGCDTester___024root___sequent__TOP__0(VGCDTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->GCDTester__DOT__first)) 
                          ...
                          & (~ (IData)(vlSelf->reset))) 
                         & (3U != vlSelf->GCDTester__DOT__dut__DOT__x)))) {
            VL_WRITEF("[%0t] %%Error: GCDTester.v:107: Assertion failed in %NGCDTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/GCDTester/202203291446366229425357635321934/GCDTester.v", 107, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->GCDTester__DOT__first)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((~ (IData)(vlSelf->GCDTester__DOT__first)) 
                          & (0U == vlSelf->GCDTester__DOT__dut__DOT__y)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/GCDTester/202203291446366229425357635321934/GCDTester.v", 129, "");
        }
    }
