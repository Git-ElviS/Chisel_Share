...
void VGCDTester___024root___sequent__TOP__0(VGCDTester___024root* vlSelf);
...
void VGCDTester___024root___eval(VGCDTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGCDTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VGCDTester___024root___sequent__TOP__0(vlSelf);
...
void VGCDTester___024root___eval_debug_assertions(VGCDTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VGCDTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGCDTester___024root___eval_debug_assertions\n"); );
    // Body
