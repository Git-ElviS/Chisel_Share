...
void VBlackBoxTesterSuggestName___024root__trace_chg_sub_0(VBlackBoxTesterSuggestName___024root* vlSelf, VerilatedVcd* tracep);

void VBlackBoxTesterSuggestName___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTesterSuggestName___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VBlackBoxTesterSuggestName___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VBlackBoxTesterSuggestName___024root__trace_chg_sub_0(VBlackBoxTesterSuggestName___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBlackBoxTesterSuggestName__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTesterSuggestName___024root__trace_chg_sub_0\n"); );
    // Init
...
void VBlackBoxTesterSuggestName___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTesterSuggestName___024root__trace_cleanup\n"); );
    // Init
    VBlackBoxTesterSuggestName___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VBlackBoxTesterSuggestName___024root*>(voidSelf);
    VBlackBoxTesterSuggestName__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
