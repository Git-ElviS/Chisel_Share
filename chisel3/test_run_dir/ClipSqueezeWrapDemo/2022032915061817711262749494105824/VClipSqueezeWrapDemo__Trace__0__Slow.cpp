...
VL_ATTR_COLD void VClipSqueezeWrapDemo___024root__trace_init_sub__TOP__0(VClipSqueezeWrapDemo___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,"clock", false,-1);
    tracep->declBit(c+6,"reset", false,-1);
    tracep->declBus(c+1,"counter", false,-1, 4,0);
    tracep->declBus(c+2,"clipped", false,-1, 3,0);
    tracep->declBus(c+3,"squeezed", false,-1, 3,0);
    tracep->declBus(c+4,"wrapped", false,-1, 3,0);
...
VL_ATTR_COLD void VClipSqueezeWrapDemo___024root__trace_full_sub_0(VClipSqueezeWrapDemo___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullCData(oldp+1,(vlSelf->ClipSqueezeWrapDemo__DOT__counter),5);
    tracep->fullCData(oldp+2,((VL_LTS_III(5, 6U, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))
                                ? 6U : (VL_GTS_III(5, 0x1eU, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))
                                         ? 0xeU : (0xfU 
                                                   & (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))))),4);
    tracep->fullCData(oldp+3,((0xfU & (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))),4);
    tracep->fullCData(oldp+4,((0xfU & (VL_LTS_III(5, 6U, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))
