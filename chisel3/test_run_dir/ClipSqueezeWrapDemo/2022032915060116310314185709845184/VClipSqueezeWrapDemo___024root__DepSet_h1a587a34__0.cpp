...
VL_INLINE_OPT void VClipSqueezeWrapDemo___024root___sequent__TOP__0(VClipSqueezeWrapDemo___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((VL_LTS_III(7, 0x1eU, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ClipSqueezeWrapDemo/2022032915060116310314185709845184/ClipSqueezeWrapDemo.v", 35, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((0x7cU == (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter)) 
                         & (~ (IData)(vlSelf->reset))))) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FWRITEF(0x80000002U,"       %3#       %2#          %2#         %2#\n",
                       7,vlSelf->ClipSqueezeWrapDemo__DOT__counter,
                       6,(VL_LTS_III(7, 0x11U, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))
                           ? 0x11U : (VL_GTS_III(7, 0x7cU, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))
                                       ? 0x3cU : (0x3fU 
                                                  & (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter)))),
                       6,(0x3fU & (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter)),
                       6,(0x3fU & (VL_LTS_III(7, 0x11U, (IData)(vlSelf->ClipSqueezeWrapDemo__DOT__counter))
