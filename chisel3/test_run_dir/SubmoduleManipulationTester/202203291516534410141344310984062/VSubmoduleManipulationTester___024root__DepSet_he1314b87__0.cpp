...
VL_INLINE_OPT void VSubmoduleManipulationTester___024root___sequent__TOP__0(VSubmoduleManipulationTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/SubmoduleManipulationTester/202203291516534410141344310984062/SubmoduleManipulationTester.v", 11, "");
        }
    }
}
