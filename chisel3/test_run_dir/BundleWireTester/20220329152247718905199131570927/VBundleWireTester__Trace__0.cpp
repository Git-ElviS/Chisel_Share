...
void VBundleWireTester___024root__trace_chg_sub_0(VBundleWireTester___024root* vlSelf, VerilatedVcd* tracep);

void VBundleWireTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleWireTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VBundleWireTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VBundleWireTester___024root__trace_chg_sub_0(VBundleWireTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBundleWireTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleWireTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VBundleWireTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBundleWireTester___024root__trace_cleanup\n"); );
    // Init
    VBundleWireTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VBundleWireTester___024root*>(voidSelf);
    VBundleWireTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
