...
void VEnumSpec_Anon___024root__trace_chg_sub_0(VEnumSpec_Anon___024root* vlSelf, VerilatedVcd* tracep);

void VEnumSpec_Anon___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEnumSpec_Anon___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VEnumSpec_Anon___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VEnumSpec_Anon___024root__trace_chg_sub_0(VEnumSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VEnumSpec_Anon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEnumSpec_Anon___024root__trace_chg_sub_0\n"); );
    // Init
...
void VEnumSpec_Anon___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEnumSpec_Anon___024root__trace_cleanup\n"); );
    // Init
    VEnumSpec_Anon___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VEnumSpec_Anon___024root*>(voidSelf);
    VEnumSpec_Anon__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
