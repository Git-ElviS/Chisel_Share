...
void VTblTester___024root__trace_chg_sub_0(VTblTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgCData(oldp+0,(vlSelf->TblTester__DOT__dut_io_wi),2);
        tracep->chgCData(oldp+1,(vlSelf->TblTester__DOT__dut_io_ri),2);
        tracep->chgCData(oldp+2,(vlSelf->TblTester__DOT__dut_io_d),2);
        ...
        tracep->chgCData(oldp+6,(vlSelf->TblTester__DOT__dut__DOT__m[0]),2);
        tracep->chgCData(oldp+7,(vlSelf->TblTester__DOT__dut__DOT__m[1]),2);
        tracep->chgCData(oldp+8,(vlSelf->TblTester__DOT__dut__DOT__m[2]),2);
        tracep->chgCData(oldp+9,(vlSelf->TblTester__DOT__dut__DOT__m[3]),2);
        tracep->chgCData(oldp+10,(vlSelf->TblTester__DOT__dut__DOT__m
                                  [vlSelf->TblTester__DOT__dut_io_ri]),2);
    }
