...
VL_ATTR_COLD void VTblTester___024root__trace_init_sub__TOP__0(VTblTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+24,"clock", false,-1);
    tracep->declBit(c+25,"reset", false,-1);
    tracep->declBit(c+24,"dut_clock", false,-1);
    tracep->declBus(c+1,"dut_io_wi", false,-1, 3,0);
    tracep->declBus(c+2,"dut_io_ri", false,-1, 3,0);
    tracep->declBus(c+3,"dut_io_d", false,-1, 3,0);
    tracep->declBus(c+4,"dut_io_o", false,-1, 3,0);
    tracep->declBus(c+5,"cnt", false,-1, 2,0);
    tracep->declBit(c+6,"wrap_wrap", false,-1);
    tracep->pushNamePrefix("dut ");
    tracep->declBit(c+24,"clock", false,-1);
    tracep->declBus(c+1,"io_wi", false,-1, 3,0);
    tracep->declBus(c+2,"io_ri", false,-1, 3,0);
    tracep->declBus(c+3,"io_d", false,-1, 3,0);
    tracep->declBus(c+4,"io_o", false,-1, 3,0);
    for (int i = 0; i < 16; ++i) {
        tracep->declBus(c+7+i*1,"m", true,(i+0), 3,0);
    }
    tracep->declBit(c+26,"m_io_o_MPORT_en", false,-1);
    tracep->declBus(c+2,"m_io_o_MPORT_addr", false,-1, 3,0);
    tracep->declBus(c+23,"m_io_o_MPORT_data", false,-1, 3,0);
    tracep->declBus(c+3,"m_MPORT_data", false,-1, 3,0);
    tracep->declBus(c+1,"m_MPORT_addr", false,-1, 3,0);
    tracep->declBit(c+26,"m_MPORT_mask", false,-1);
    tracep->declBit(c+26,"m_MPORT_en", false,-1);
...
VL_ATTR_COLD void VTblTester___024root__trace_full_sub_0(VTblTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullCData(oldp+1,(vlSelf->TblTester__DOT__dut_io_wi),4);
    tracep->fullCData(oldp+2,(vlSelf->TblTester__DOT__dut_io_ri),4);
    tracep->fullCData(oldp+3,(vlSelf->TblTester__DOT__dut_io_d),4);
    ...
    tracep->fullCData(oldp+7,(vlSelf->TblTester__DOT__dut__DOT__m[0]),4);
    tracep->fullCData(oldp+8,(vlSelf->TblTester__DOT__dut__DOT__m[1]),4);
    tracep->fullCData(oldp+9,(vlSelf->TblTester__DOT__dut__DOT__m[2]),4);
    tracep->fullCData(oldp+10,(vlSelf->TblTester__DOT__dut__DOT__m[3]),4);
    tracep->fullCData(oldp+11,(vlSelf->TblTester__DOT__dut__DOT__m[4]),4);
    tracep->fullCData(oldp+12,(vlSelf->TblTester__DOT__dut__DOT__m[5]),4);
    tracep->fullCData(oldp+13,(vlSelf->TblTester__DOT__dut__DOT__m[6]),4);
    tracep->fullCData(oldp+14,(vlSelf->TblTester__DOT__dut__DOT__m[7]),4);
    tracep->fullCData(oldp+15,(vlSelf->TblTester__DOT__dut__DOT__m[8]),4);
    tracep->fullCData(oldp+16,(vlSelf->TblTester__DOT__dut__DOT__m[9]),4);
    tracep->fullCData(oldp+17,(vlSelf->TblTester__DOT__dut__DOT__m[10]),4);
    tracep->fullCData(oldp+18,(vlSelf->TblTester__DOT__dut__DOT__m[11]),4);
    tracep->fullCData(oldp+19,(vlSelf->TblTester__DOT__dut__DOT__m[12]),4);
    tracep->fullCData(oldp+20,(vlSelf->TblTester__DOT__dut__DOT__m[13]),4);
    tracep->fullCData(oldp+21,(vlSelf->TblTester__DOT__dut__DOT__m[14]),4);
    tracep->fullCData(oldp+22,(vlSelf->TblTester__DOT__dut__DOT__m[15]),4);
    tracep->fullCData(oldp+23,(vlSelf->TblTester__DOT__dut__DOT__m
                               [vlSelf->TblTester__DOT__dut_io_ri]),4);
