...
VL_INLINE_OPT void VTblTester___024root___sequent__TOP__0(VTblTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/TblTester/202203291504354127468679431026522/TblTester.v", 148, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
            ...
            VL_WRITEF("[%0t] %%Error: TblTester.v:170: Assertion failed in %NTblTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/TblTester/202203291504354127468679431026522/TblTester.v", 170, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((7U == (IData)(vlSelf->TblTester__DOT__cnt)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/TblTester/202203291504354127468679431026522/TblTester.v", 192, "");
        }
    }
