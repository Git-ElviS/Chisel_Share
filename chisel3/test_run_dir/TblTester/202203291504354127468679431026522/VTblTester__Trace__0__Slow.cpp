...
VL_ATTR_COLD void VTblTester___024root__trace_init_sub__TOP__0(VTblTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+16,"clock", false,-1);
    tracep->declBit(c+17,"reset", false,-1);
    tracep->declBit(c+16,"dut_clock", false,-1);
    tracep->declBus(c+1,"dut_io_wi", false,-1, 2,0);
    tracep->declBus(c+2,"dut_io_ri", false,-1, 2,0);
    tracep->declBus(c+3,"dut_io_d", false,-1, 2,0);
    tracep->declBus(c+4,"dut_io_o", false,-1, 2,0);
    tracep->declBus(c+5,"cnt", false,-1, 2,0);
    tracep->declBit(c+6,"wrap_wrap", false,-1);
    tracep->pushNamePrefix("dut ");
    tracep->declBit(c+16,"clock", false,-1);
    tracep->declBus(c+1,"io_wi", false,-1, 2,0);
    tracep->declBus(c+2,"io_ri", false,-1, 2,0);
    tracep->declBus(c+3,"io_d", false,-1, 2,0);
    tracep->declBus(c+4,"io_o", false,-1, 2,0);
    for (int i = 0; i < 8; ++i) {
        tracep->declBus(c+7+i*1,"m", true,(i+0), 2,0);
    }
    tracep->declBit(c+18,"m_io_o_MPORT_en", false,-1);
    tracep->declBus(c+2,"m_io_o_MPORT_addr", false,-1, 2,0);
    tracep->declBus(c+15,"m_io_o_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+3,"m_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+1,"m_MPORT_addr", false,-1, 2,0);
    tracep->declBit(c+18,"m_MPORT_mask", false,-1);
    tracep->declBit(c+18,"m_MPORT_en", false,-1);
...
VL_ATTR_COLD void VTblTester___024root__trace_full_sub_0(VTblTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullCData(oldp+1,(vlSelf->TblTester__DOT__dut_io_wi),3);
    tracep->fullCData(oldp+2,(vlSelf->TblTester__DOT__dut_io_ri),3);
    tracep->fullCData(oldp+3,(vlSelf->TblTester__DOT__dut_io_d),3);
    ...
    tracep->fullCData(oldp+7,(vlSelf->TblTester__DOT__dut__DOT__m[0]),3);
    tracep->fullCData(oldp+8,(vlSelf->TblTester__DOT__dut__DOT__m[1]),3);
    tracep->fullCData(oldp+9,(vlSelf->TblTester__DOT__dut__DOT__m[2]),3);
    tracep->fullCData(oldp+10,(vlSelf->TblTester__DOT__dut__DOT__m[3]),3);
    tracep->fullCData(oldp+11,(vlSelf->TblTester__DOT__dut__DOT__m[4]),3);
    tracep->fullCData(oldp+12,(vlSelf->TblTester__DOT__dut__DOT__m[5]),3);
    tracep->fullCData(oldp+13,(vlSelf->TblTester__DOT__dut__DOT__m[6]),3);
    tracep->fullCData(oldp+14,(vlSelf->TblTester__DOT__dut__DOT__m[7]),3);
    tracep->fullCData(oldp+15,(vlSelf->TblTester__DOT__dut__DOT__m
                               [vlSelf->TblTester__DOT__dut_io_ri]),3);
