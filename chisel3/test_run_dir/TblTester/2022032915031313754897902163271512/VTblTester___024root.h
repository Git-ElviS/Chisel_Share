...
VL_MODULE(VTblTester___024root) {
  public:
    ...
    VL_IN8(clock,0,0);
    VL_IN8(reset,0,0);
    CData/*0:0*/ TblTester__DOT__dut_io_wi;
    CData/*0:0*/ TblTester__DOT__dut_io_ri;
    CData/*0:0*/ TblTester__DOT__dut_io_d;
    CData/*2:0*/ TblTester__DOT__cnt;
    CData/*2:0*/ TblTester__DOT___wrap_value_T_1;
    CData/*0:0*/ TblTester__DOT___GEN_6;
    CData/*0:0*/ TblTester__DOT___GEN_14;
    CData/*0:0*/ TblTester__DOT___GEN_24;
    CData/*0:0*/ __Vclklast__TOP__clock;
    VlUnpacked<CData/*0:0*/, 2> TblTester__DOT__dut__DOT__m;
