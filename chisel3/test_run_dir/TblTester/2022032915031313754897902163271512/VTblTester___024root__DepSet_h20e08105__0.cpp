...
VL_INLINE_OPT void VTblTester___024root___sequent__TOP__0(VTblTester___024root* vlSelf) {
    ...
    // Init
    CData/*0:0*/ __Vdlyvdim0__TblTester__DOT__dut__DOT__m__v0;
    CData/*0:0*/ __Vdlyvval__TblTester__DOT__dut__DOT__m__v0;
    // Body
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
                           & (((7U == (7U & ((IData)(vlSelf->TblTester__DOT__cnt) 
                                             - (IData)(1U)))) 
                               | ((6U == (7U & ((IData)(vlSelf->TblTester__DOT__cnt) 
                                                - (IData)(1U)))) 
                                  | ((5U == (7U & ((IData)(vlSelf->TblTester__DOT__cnt) 
                                                   - (IData)(1U)))) 
            ...
            VL_WRITEF("[%0t] %%Error: TblTester.v:137: Assertion failed in %NTblTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/TblTester/2022032915031313754897902163271512/TblTester.v", 137, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
                                   ...
                                   & ((5U != (7U & 
                                      ...
                                      & ((4U != (7U 
                                         ...
                                         & (3U == (7U 
                                                   & ((IData)(vlSelf->TblTester__DOT__cnt) 
                                                      - (IData)(1U)))))))))))) {
            VL_WRITEF("[%0t] %%Error: TblTester.v:159: Assertion failed in %NTblTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/TblTester/2022032915031313754897902163271512/TblTester.v", 159, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((0U < (IData)(vlSelf->TblTester__DOT__cnt)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((7U == (IData)(vlSelf->TblTester__DOT__cnt)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/TblTester/2022032915031313754897902163271512/TblTester.v", 181, "");
        }
    }
