...
VL_ATTR_COLD void VTblTester___024root___ctor_var_reset(VTblTester___024root* vlSelf) {
    ...
    vlSelf->TblTester__DOT__dut_io_wi = VL_RAND_RESET_I(2);
    vlSelf->TblTester__DOT__dut_io_ri = VL_RAND_RESET_I(2);
    vlSelf->TblTester__DOT__dut_io_d = VL_RAND_RESET_I(2);
    vlSelf->TblTester__DOT__cnt = VL_RAND_RESET_I(3);
    vlSelf->TblTester__DOT___wrap_value_T_1 = VL_RAND_RESET_I(3);
    vlSelf->TblTester__DOT___GEN_8 = VL_RAND_RESET_I(2);
    vlSelf->TblTester__DOT___GEN_16 = VL_RAND_RESET_I(2);
    vlSelf->TblTester__DOT___GEN_24 = VL_RAND_RESET_I(2);
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        vlSelf->TblTester__DOT__dut__DOT__m[__Vi0] = VL_RAND_RESET_I(2);
    }
