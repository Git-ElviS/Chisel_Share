...
void VRegTester___024root__trace_chg_sub_0(VRegTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgCData(oldp+0,(vlSelf->RegTester__DOT__dut__DOT__vecReg_0),2);
        tracep->chgCData(oldp+1,(vlSelf->RegTester__DOT__dut__DOT__vecReg_1),2);
        tracep->chgCData(oldp+2,(vlSelf->RegTester__DOT__dut__DOT__vecReg_2),2);
        tracep->chgCData(oldp+3,(vlSelf->RegTester__DOT__dut__DOT__vecReg_3),2);
        tracep->chgCData(oldp+4,(vlSelf->RegTester__DOT__dut__DOT__vecReg_4),2);
        tracep->chgCData(oldp+5,(vlSelf->RegTester__DOT__dut__DOT__vecReg_5),2);
        tracep->chgCData(oldp+6,(vlSelf->RegTester__DOT__dut__DOT__vecReg_6),2);
        tracep->chgCData(oldp+7,(vlSelf->RegTester__DOT__dut__DOT__vecReg_7),2);
