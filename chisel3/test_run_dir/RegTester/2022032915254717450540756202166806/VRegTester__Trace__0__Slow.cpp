...
VL_ATTR_COLD void VRegTester___024root__trace_init_sub__TOP__0(VRegTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+1,"dut_io_out_0", false,-1, 3,0);
    tracep->declBus(c+2,"dut_io_out_1", false,-1, 3,0);
    tracep->declBus(c+3,"dut_io_out_2", false,-1, 3,0);
    tracep->declBus(c+4,"dut_io_out_3", false,-1, 3,0);
    tracep->declBus(c+5,"dut_io_out_4", false,-1, 3,0);
    tracep->declBus(c+6,"dut_io_out_5", false,-1, 3,0);
    tracep->declBus(c+7,"dut_io_out_6", false,-1, 3,0);
    tracep->declBus(c+8,"dut_io_out_7", false,-1, 3,0);
    tracep->declBit(c+9,"doneReg", false,-1);
    tracep->pushNamePrefix("dut ");
    tracep->declBit(c+10,"clock", false,-1);
    tracep->declBit(c+11,"reset", false,-1);
    tracep->declBus(c+1,"io_out_0", false,-1, 3,0);
    tracep->declBus(c+2,"io_out_1", false,-1, 3,0);
    tracep->declBus(c+3,"io_out_2", false,-1, 3,0);
    tracep->declBus(c+4,"io_out_3", false,-1, 3,0);
    tracep->declBus(c+5,"io_out_4", false,-1, 3,0);
    tracep->declBus(c+6,"io_out_5", false,-1, 3,0);
    tracep->declBus(c+7,"io_out_6", false,-1, 3,0);
    tracep->declBus(c+8,"io_out_7", false,-1, 3,0);
    tracep->declBus(c+1,"vecReg_0", false,-1, 3,0);
    tracep->declBus(c+2,"vecReg_1", false,-1, 3,0);
    tracep->declBus(c+3,"vecReg_2", false,-1, 3,0);
    tracep->declBus(c+4,"vecReg_3", false,-1, 3,0);
    tracep->declBus(c+5,"vecReg_4", false,-1, 3,0);
    tracep->declBus(c+6,"vecReg_5", false,-1, 3,0);
    tracep->declBus(c+7,"vecReg_6", false,-1, 3,0);
    tracep->declBus(c+8,"vecReg_7", false,-1, 3,0);
...
VL_ATTR_COLD void VRegTester___024root__trace_full_sub_0(VRegTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->fullCData(oldp+1,(vlSelf->RegTester__DOT__dut__DOT__vecReg_0),4);
    tracep->fullCData(oldp+2,(vlSelf->RegTester__DOT__dut__DOT__vecReg_1),4);
    tracep->fullCData(oldp+3,(vlSelf->RegTester__DOT__dut__DOT__vecReg_2),4);
    tracep->fullCData(oldp+4,(vlSelf->RegTester__DOT__dut__DOT__vecReg_3),4);
    tracep->fullCData(oldp+5,(vlSelf->RegTester__DOT__dut__DOT__vecReg_4),4);
    tracep->fullCData(oldp+6,(vlSelf->RegTester__DOT__dut__DOT__vecReg_5),4);
    tracep->fullCData(oldp+7,(vlSelf->RegTester__DOT__dut__DOT__vecReg_6),4);
    tracep->fullCData(oldp+8,(vlSelf->RegTester__DOT__dut__DOT__vecReg_7),4);
