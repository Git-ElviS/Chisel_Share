...
VL_ATTR_COLD void VRegTester___024root___ctor_var_reset(VRegTester___024root* vlSelf) {
    ...
    vlSelf->RegTester__DOT__dut__DOT__vecReg_0 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_1 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_2 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_3 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_4 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_5 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_6 = VL_RAND_RESET_I(4);
    vlSelf->RegTester__DOT__dut__DOT__vecReg_7 = VL_RAND_RESET_I(4);
