...
void VRegTester___024root___sequent__TOP__0(VRegTester___024root* vlSelf);
...
void VRegTester___024root___eval(VRegTester___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRegTester___024root___eval\n"); );
    // Body
    if (((IData)(vlSelf->clock) & (~ (IData)(vlSelf->__Vclklast__TOP__clock)))) {
        VRegTester___024root___sequent__TOP__0(vlSelf);
...
void VRegTester___024root___eval_debug_assertions(VRegTester___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VRegTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRegTester___024root___eval_debug_assertions\n"); );
    // Body
