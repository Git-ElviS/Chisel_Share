...
void VRegTester___024root__trace_chg_sub_0(VRegTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+3,(vlSelf->RegTester__DOT__dut__DOT__vecReg_5),3);
        tracep->chgCData(oldp+4,(vlSelf->RegTester__DOT__dut__DOT__vecReg_6),3);
        tracep->chgCData(oldp+5,(vlSelf->RegTester__DOT__dut__DOT__vecReg_7),3);
        tracep->chgBit(oldp+6,(vlSelf->RegTester__DOT__doneReg));
    }
