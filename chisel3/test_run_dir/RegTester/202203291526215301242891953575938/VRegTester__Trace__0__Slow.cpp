...
VL_ATTR_COLD void VRegTester___024root__trace_init_sub__TOP__0(VRegTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"dut_io_out_5", false,-1, 2,0);
    tracep->declBus(c+5,"dut_io_out_6", false,-1, 2,0);
    tracep->declBus(c+6,"dut_io_out_7", false,-1, 2,0);
    tracep->declBit(c+7,"doneReg", false,-1);
    ...
    tracep->declBus(c+4,"io_out_5", false,-1, 2,0);
    tracep->declBus(c+5,"io_out_6", false,-1, 2,0);
    tracep->declBus(c+6,"io_out_7", false,-1, 2,0);
    tracep->declBus(c+1,"vecReg_0", false,-1, 2,0);
    tracep->declBus(c+2,"vecReg_1", false,-1, 2,0);
    tracep->declBus(c+3,"vecReg_2", false,-1, 2,0);
    tracep->declBus(c+4,"vecReg_5", false,-1, 2,0);
    tracep->declBus(c+5,"vecReg_6", false,-1, 2,0);
    tracep->declBus(c+6,"vecReg_7", false,-1, 2,0);
...
VL_ATTR_COLD void VRegTester___024root__trace_full_sub_0(VRegTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+4,(vlSelf->RegTester__DOT__dut__DOT__vecReg_5),3);
    tracep->fullCData(oldp+5,(vlSelf->RegTester__DOT__dut__DOT__vecReg_6),3);
    tracep->fullCData(oldp+6,(vlSelf->RegTester__DOT__dut__DOT__vecReg_7),3);
    tracep->fullBit(oldp+7,(vlSelf->RegTester__DOT__doneReg));
