...
void VIntervalChainedMulTester___024root__trace_chg_sub_0(VIntervalChainedMulTester___024root* vlSelf, VerilatedVcd* tracep);

void VIntervalChainedMulTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIntervalChainedMulTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VIntervalChainedMulTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VIntervalChainedMulTester___024root__trace_chg_sub_0(VIntervalChainedMulTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VIntervalChainedMulTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIntervalChainedMulTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VIntervalChainedMulTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VIntervalChainedMulTester___024root__trace_cleanup\n"); );
    // Init
    VIntervalChainedMulTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VIntervalChainedMulTester___024root*>(voidSelf);
    VIntervalChainedMulTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
