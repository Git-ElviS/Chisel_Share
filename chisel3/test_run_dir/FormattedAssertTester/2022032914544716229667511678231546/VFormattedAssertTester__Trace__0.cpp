...
void VFormattedAssertTester___024root__trace_chg_sub_0(VFormattedAssertTester___024root* vlSelf, VerilatedVcd* tracep);

void VFormattedAssertTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFormattedAssertTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VFormattedAssertTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VFormattedAssertTester___024root__trace_chg_sub_0(VFormattedAssertTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VFormattedAssertTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFormattedAssertTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VFormattedAssertTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VFormattedAssertTester___024root__trace_cleanup\n"); );
    // Init
    VFormattedAssertTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VFormattedAssertTester___024root*>(voidSelf);
    VFormattedAssertTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
