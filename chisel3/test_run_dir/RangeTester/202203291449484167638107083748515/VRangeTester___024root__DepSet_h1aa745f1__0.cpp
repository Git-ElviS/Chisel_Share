...
VL_INLINE_OPT void VRangeTester___024root___sequent__TOP__0(VRangeTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->RangeTester__DOT__checkWrap) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0x1aU != (IData)(vlSelf->RangeTester__DOT__cnt))))) {
            VL_WRITEF("[%0t] %%Error: RangeTester.v:33: Assertion failed in %NRangeTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/RangeTester/202203291449484167638107083748515/RangeTester.v", 33, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->RangeTester__DOT__checkWrap) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->RangeTester__DOT__checkWrap) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/RangeTester/202203291449484167638107083748515/RangeTester.v", 55, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->RangeTester__DOT__checkWrap)) 
            ...
            VL_WRITEF("[%0t] %%Error: RangeTester.v:66: Assertion failed in %NRangeTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/RangeTester/202203291449484167638107083748515/RangeTester.v", 66, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->RangeTester__DOT__checkWrap)) 
    ...
    vlSelf->RangeTester__DOT__cnt = ((IData)(vlSelf->reset)
                                      ? 0x1aU : ((IData)(vlSelf->RangeTester__DOT__wrap_wrap)
                                                  ? 0x1aU
