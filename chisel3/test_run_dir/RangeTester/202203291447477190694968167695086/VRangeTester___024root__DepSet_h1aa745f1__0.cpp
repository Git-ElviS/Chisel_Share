...
VL_INLINE_OPT void VRangeTester___024root___sequent__TOP__0(VRangeTester___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->RangeTester__DOT__checkWrap) 
            ...
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/RangeTester/202203291447477190694968167695086/RangeTester.v", 33, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((IData)(vlSelf->RangeTester__DOT__checkWrap) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->RangeTester__DOT__checkWrap) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/RangeTester/202203291447477190694968167695086/RangeTester.v", 55, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->RangeTester__DOT__checkWrap)) 
            ...
            VL_WRITEF("[%0t] %%Error: RangeTester.v:66: Assertion failed in %NRangeTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/RangeTester/202203291447477190694968167695086/RangeTester.v", 66, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((((~ (IData)(vlSelf->RangeTester__DOT__checkWrap)) 
    ...
    vlSelf->RangeTester__DOT__cnt = ((IData)(vlSelf->reset)
                                      ? 0x1cU : ((IData)(vlSelf->RangeTester__DOT__wrap_wrap)
                                                  ? 0x1cU
                                                  : (IData)(vlSelf->RangeTester__DOT___wrap_value_T_1)));
    vlSelf->RangeTester__DOT__wrap_wrap = (8U == (IData)(vlSelf->RangeTester__DOT__cnt));
    vlSelf->RangeTester__DOT___wrap_value_T_1 = (0x1fU 
                                                 & ((IData)(vlSelf->RangeTester__DOT__cnt) 
                                                    - (IData)(2U)));
    vlSelf->RangeTester__DOT___GEN_5 = ((8U == (IData)(vlSelf->RangeTester__DOT__cnt)) 
