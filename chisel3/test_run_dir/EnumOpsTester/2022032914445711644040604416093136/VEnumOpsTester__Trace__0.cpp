...
void VEnumOpsTester___024root__trace_chg_sub_0(VEnumOpsTester___024root* vlSelf, VerilatedVcd* tracep);

void VEnumOpsTester___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEnumOpsTester___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VEnumOpsTester___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VEnumOpsTester___024root__trace_chg_sub_0(VEnumOpsTester___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VEnumOpsTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEnumOpsTester___024root__trace_chg_sub_0\n"); );
    // Init
...
void VEnumOpsTester___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VEnumOpsTester___024root__trace_cleanup\n"); );
    // Init
    VEnumOpsTester___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VEnumOpsTester___024root*>(voidSelf);
    VEnumOpsTester__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
