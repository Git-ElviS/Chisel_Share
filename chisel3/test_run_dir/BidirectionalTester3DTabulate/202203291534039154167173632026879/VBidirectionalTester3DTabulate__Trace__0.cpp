...
void VBidirectionalTester3DTabulate___024root__trace_chg_sub_0(VBidirectionalTester3DTabulate___024root* vlSelf, VerilatedVcd* tracep);

void VBidirectionalTester3DTabulate___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd* tracep) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester3DTabulate___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VBidirectionalTester3DTabulate___024root__trace_chg_sub_0((&vlSymsp->TOP), tracep);
}

void VBidirectionalTester3DTabulate___024root__trace_chg_sub_0(VBidirectionalTester3DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VBidirectionalTester3DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester3DTabulate___024root__trace_chg_sub_0\n"); );
    // Init
...
void VBidirectionalTester3DTabulate___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBidirectionalTester3DTabulate___024root__trace_cleanup\n"); );
    // Init
    VBidirectionalTester3DTabulate___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VBidirectionalTester3DTabulate___024root*>(voidSelf);
    VBidirectionalTester3DTabulate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
