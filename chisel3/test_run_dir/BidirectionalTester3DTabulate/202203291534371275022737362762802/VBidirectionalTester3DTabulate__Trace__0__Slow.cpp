...
VL_ATTR_COLD void VBidirectionalTester3DTabulate___024root__trace_init_sub__TOP__0(VBidirectionalTester3DTabulate___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"PassthroughModule_9_io_in", false,-1, 31,0);
    tracep->declBus(c+4,"PassthroughModule_9_io_out", false,-1, 31,0);
    tracep->declBus(c+5,"PassthroughModule_10_io_in", false,-1, 31,0);
    tracep->declBus(c+5,"PassthroughModule_10_io_out", false,-1, 31,0);
    tracep->declBus(c+6,"PassthroughModule_11_io_in", false,-1, 31,0);
    tracep->declBus(c+6,"PassthroughModule_11_io_out", false,-1, 31,0);
