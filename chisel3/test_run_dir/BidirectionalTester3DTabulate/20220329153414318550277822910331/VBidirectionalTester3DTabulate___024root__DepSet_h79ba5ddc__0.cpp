...
VL_INLINE_OPT void VBidirectionalTester3DTabulate___024root___sequent__TOP__0(VBidirectionalTester3DTabulate___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/BidirectionalTester3DTabulate/20220329153414318550277822910331/BidirectionalTester3DTabulate.v", 250, "");
        }
    }
}
