...
VL_ATTR_COLD void VAsyncResetSpec_Anon___024root___ctor_var_reset(VAsyncResetSpec_Anon___024root* vlSelf) {
    ...
    vlSelf->AsyncResetSpec_Anon__DOT__reg_0 = VL_RAND_RESET_I(8);
    vlSelf->AsyncResetSpec_Anon__DOT__reg_1 = VL_RAND_RESET_I(8);
    vlSelf->AsyncResetSpec_Anon__DOT__reg_2 = VL_RAND_RESET_I(8);
    vlSelf->AsyncResetSpec_Anon__DOT__reg_3 = VL_RAND_RESET_I(8);
