...
VL_INLINE_OPT void VAsyncResetSpec_Anon___024root___sequent__TOP__1(VAsyncResetSpec_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0xdeadbeefU != (((IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_3) 
                                             << 0x18U) 
                                            | (((IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_2) 
                                                << 0x10U) 
                                               | (((IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_1) 
                                                   << 8U) 
                                                  | (IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_0)))))))) {
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:33: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/AsyncResetSpec_Anon/202203291510314406990550168546097/AsyncResetSpec_Anon.v", 33, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U != (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0xbad0cad0U != (((IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_3) 
                                             << 0x18U) 
                                            | (((IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_2) 
                                                << 0x10U) 
                                               | (((IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_1) 
                                                   << 8U) 
                                                  | (IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_0)))))))) {
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:56: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/AsyncResetSpec_Anon/202203291510314406990550168546097/AsyncResetSpec_Anon.v", 56, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U != (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/AsyncResetSpec_Anon/202203291510314406990550168546097/AsyncResetSpec_Anon.v", 79, "");
        }
    }
