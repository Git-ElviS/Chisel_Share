...
void VAsyncResetSpec_Anon___024root__trace_chg_sub_0(VAsyncResetSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        tracep->chgCData(oldp+0,(vlSelf->AsyncResetSpec_Anon__DOT__reg_0),8);
        tracep->chgCData(oldp+1,(vlSelf->AsyncResetSpec_Anon__DOT__reg_1),8);
        tracep->chgCData(oldp+2,(vlSelf->AsyncResetSpec_Anon__DOT__reg_2),8);
        tracep->chgCData(oldp+3,(vlSelf->AsyncResetSpec_Anon__DOT__reg_3),8);
    }
    tracep->chgBit(oldp+4,(vlSelf->clock));
    tracep->chgBit(oldp+5,(vlSelf->reset));
    tracep->chgCData(oldp+6,(vlSelf->AsyncResetSpec_Anon__DOT__count),2);
    tracep->chgBit(oldp+7,((3U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count))));
}
