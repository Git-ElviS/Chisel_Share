...
VL_INLINE_OPT void VAsyncResetSpec_Anon___024root___sequent__TOP__1(VAsyncResetSpec_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (0xdU != (IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_))))) {
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:26: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/AsyncResetSpec_Anon/202203291509564407846921870125769/AsyncResetSpec_Anon.v", 26, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U != (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
                          & (~ (IData)(vlSelf->reset))) 
                         & (7U != (IData)(vlSelf->AsyncResetSpec_Anon__DOT__reg_))))) {
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:48: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/AsyncResetSpec_Anon/202203291509564407846921870125769/AsyncResetSpec_Anon.v", 48, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY((((0U != (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/AsyncResetSpec_Anon/202203291509564407846921870125769/AsyncResetSpec_Anon.v", 70, "");
        }
    }
