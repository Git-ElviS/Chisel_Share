...
void VAsyncResetSpec_Anon___024root__trace_chg_sub_0(VAsyncResetSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->chgSData(oldp+2,(vlSelf->AsyncResetSpec_Anon__DOT__reg_x),16);
    tracep->chgSData(oldp+3,(vlSelf->AsyncResetSpec_Anon__DOT__reg_y),16);
    tracep->chgCData(oldp+4,(vlSelf->AsyncResetSpec_Anon__DOT__count),2);
    tracep->chgBit(oldp+5,((3U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count))));
}
