...
VL_INLINE_OPT void VAsyncResetSpec_Anon___024root___sequent__TOP__2(VAsyncResetSpec_Anon___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->reset) {
        vlSelf->AsyncResetSpec_Anon__DOT__reg_x = 0xdeadU;
        vlSelf->AsyncResetSpec_Anon__DOT__reg_y = 0xbeefU;
    } else {
        vlSelf->AsyncResetSpec_Anon__DOT__reg_x = 0xbad0U;
        vlSelf->AsyncResetSpec_Anon__DOT__reg_y = 0xcad0U;
    }
}
