...
VL_ATTR_COLD void VAsyncResetSpec_Anon___024root__trace_init_sub__TOP__0(VAsyncResetSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+1,"clock", false,-1);
    tracep->declBit(c+2,"reset", false,-1);
    tracep->declBus(c+3,"reg_x", false,-1, 15,0);
    tracep->declBus(c+4,"reg_y", false,-1, 15,0);
    tracep->declBus(c+5,"count", false,-1, 1,0);
...
VL_ATTR_COLD void VAsyncResetSpec_Anon___024root__trace_full_sub_0(VAsyncResetSpec_Anon___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullSData(oldp+3,(vlSelf->AsyncResetSpec_Anon__DOT__reg_x),16);
    tracep->fullSData(oldp+4,(vlSelf->AsyncResetSpec_Anon__DOT__reg_y),16);
    tracep->fullCData(oldp+5,(vlSelf->AsyncResetSpec_Anon__DOT__count),2);
    tracep->fullBit(oldp+6,((3U == (IData)(vlSelf->AsyncResetSpec_Anon__DOT__count))));
}
