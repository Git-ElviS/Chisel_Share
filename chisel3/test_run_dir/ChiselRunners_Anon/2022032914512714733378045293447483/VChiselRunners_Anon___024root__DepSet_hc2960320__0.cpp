...
VL_INLINE_OPT void VChiselRunners_Anon___024root___sequent__TOP__0(VChiselRunners_Anon___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->ChiselRunners_Anon__DOT__done_value) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_WRITEF("[%0t] %%Error: ChiselRunners_Anon.v:22: Assertion failed in %NChiselRunners_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ChiselRunners_Anon/2022032914512714733378045293447483/ChiselRunners_Anon.v", 22, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->ChiselRunners_Anon__DOT__done_value) 
    ...
    if ((1U & (~ (IData)(vlSelf->reset)))) {
        if (VL_UNLIKELY(((IData)(vlSelf->ChiselRunners_Anon__DOT__done_value) 
                         & (~ (IData)(vlSelf->reset))))) {
            VL_FINISH_MT("/Users/caizhongxuan/Chisel/1_code/chisel3/test_run_dir/ChiselRunners_Anon/2022032914512714733378045293447483/ChiselRunners_Anon.v", 45, "");
        }
    }
