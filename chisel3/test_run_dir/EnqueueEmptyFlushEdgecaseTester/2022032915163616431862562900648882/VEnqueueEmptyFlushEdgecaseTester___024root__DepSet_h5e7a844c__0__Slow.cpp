...
VL_ATTR_COLD void VEnqueueEmptyFlushEdgecaseTester___024root___ctor_var_reset(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf) {
    ...
    vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT___GEN_39 = VL_RAND_RESET_I(4);
    vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__wrap_2 = VL_RAND_RESET_I(1);
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
        vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(4);
    }
    vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(1);
    vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(1);
