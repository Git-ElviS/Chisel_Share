...
void VEnqueueEmptyFlushEdgecaseTester___024root__trace_chg_sub_0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgBit(oldp+2,(((0x13U == (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__value)) 
        ...
        tracep->chgBit(oldp+5,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram
        ...
        tracep->chgBit(oldp+33,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]));
        tracep->chgBit(oldp+34,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]));
