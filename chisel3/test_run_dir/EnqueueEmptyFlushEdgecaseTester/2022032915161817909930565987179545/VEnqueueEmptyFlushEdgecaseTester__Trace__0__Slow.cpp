...
VL_ATTR_COLD void VEnqueueEmptyFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    for (int i = 0; i < 2; ++i) {
        tracep->declBit(c+34+i*1,"ram", true,(i+0));
    }
...
VL_ATTR_COLD void VEnqueueEmptyFlushEdgecaseTester___024root__trace_full_sub_0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullBit(oldp+3,(((0x13U == (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__value)) 
    ...
    tracep->fullBit(oldp+6,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram
    ...
    tracep->fullBit(oldp+34,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]));
    tracep->fullBit(oldp+35,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]));
