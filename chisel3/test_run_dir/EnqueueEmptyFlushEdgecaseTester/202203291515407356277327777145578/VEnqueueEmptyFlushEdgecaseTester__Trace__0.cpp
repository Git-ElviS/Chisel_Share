...
void VEnqueueEmptyFlushEdgecaseTester___024root__trace_chg_sub_0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+33,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]),2);
        tracep->chgCData(oldp+34,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]),2);
        tracep->chgCData(oldp+35,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[2]),2);
