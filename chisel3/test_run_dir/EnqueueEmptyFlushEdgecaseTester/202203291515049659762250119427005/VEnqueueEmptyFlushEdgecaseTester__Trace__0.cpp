...
void VEnqueueEmptyFlushEdgecaseTester___024root__trace_chg_sub_0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+5,(((2U >= (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))
                                  ...
                                  [vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value]
                                   : 0U)),3);
        tracep->chgCData(oldp+6,((3U & ((IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match)
        ...
        tracep->chgCData(oldp+33,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]),3);
        tracep->chgCData(oldp+34,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]),3);
        tracep->chgCData(oldp+35,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[2]),3);
        tracep->chgCData(oldp+36,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->chgCData(oldp+37,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value),2);
        tracep->chgBit(oldp+38,(((~ (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__full)) 
                                 & (0x14U > (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__value)))));
        tracep->chgBit(oldp+39,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full));
        tracep->chgBit(oldp+40,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match));
        tracep->chgBit(oldp+41,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__empty));
        tracep->chgBit(oldp+42,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__full));
        tracep->chgBit(oldp+43,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__do_enq));
        tracep->chgBit(oldp+44,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__do_deq));
        tracep->chgBit(oldp+45,((2U == (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value))));
        tracep->chgBit(oldp+46,((2U == (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))));
        tracep->chgCData(oldp+47,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_diff),2);
    }
    tracep->chgBit(oldp+48,(vlSelf->clock));
    tracep->chgBit(oldp+49,(vlSelf->reset));
}
