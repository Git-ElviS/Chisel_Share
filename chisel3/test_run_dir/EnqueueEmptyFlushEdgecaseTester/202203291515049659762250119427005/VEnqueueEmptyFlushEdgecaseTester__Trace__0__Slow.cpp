...
VL_ATTR_COLD void VEnqueueEmptyFlushEdgecaseTester___024root__trace_init_sub__TOP__0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+49,"clock", false,-1);
    tracep->declBit(c+50,"reset", false,-1);
    tracep->declBit(c+49,"q_clock", false,-1);
    tracep->declBit(c+50,"q_reset", false,-1);
    ...
    tracep->declBit(c+49,"q_io_deq_ready_prng_clock", false,-1);
    tracep->declBit(c+50,"q_io_deq_ready_prng_reset", false,-1);
    ...
    for (int i = 0; i < 3; ++i) {
        tracep->declBus(c+34+i*1,"ram", true,(i+0), 2,0);
    }
    tracep->declBit(c+51,"ram_io_deq_bits_MPORT_en", false,-1);
    tracep->declBus(c+37,"ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
    tracep->declBus(c+6,"ram_io_deq_bits_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+3,"ram_MPORT_data", false,-1, 2,0);
    tracep->declBus(c+38,"ram_MPORT_addr", false,-1, 1,0);
    tracep->declBit(c+51,"ram_MPORT_mask", false,-1);
    tracep->declBit(c+39,"ram_MPORT_en", false,-1);
    tracep->declBus(c+38,"enq_ptr_value", false,-1, 1,0);
    tracep->declBus(c+37,"deq_ptr_value", false,-1, 1,0);
    tracep->declBit(c+40,"maybe_full", false,-1);
    tracep->declBit(c+41,"ptr_match", false,-1);
    tracep->declBit(c+42,"empty", false,-1);
    tracep->declBit(c+43,"full", false,-1);
    tracep->declBit(c+44,"do_enq", false,-1);
    tracep->declBit(c+45,"do_deq", false,-1);
    tracep->declBit(c+46,"wrap", false,-1);
    tracep->declBit(c+47,"wrap_1", false,-1);
    tracep->declBus(c+48,"ptr_diff", false,-1, 1,0);
...
VL_ATTR_COLD void VEnqueueEmptyFlushEdgecaseTester___024root__trace_full_sub_0(VEnqueueEmptyFlushEdgecaseTester___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->fullCData(oldp+6,(((2U >= (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))
                               ...
                               [vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value]
                                : 0U)),3);
    tracep->fullCData(oldp+7,((3U & ((IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match)
                                      ...
                                      : (((IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value) 
                                          ...
                                          : (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_diff))))),2);
    ...
    tracep->fullCData(oldp+34,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[0]),3);
    tracep->fullCData(oldp+35,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[1]),3);
    tracep->fullCData(oldp+36,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ram[2]),3);
    tracep->fullCData(oldp+37,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value),2);
    tracep->fullCData(oldp+38,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value),2);
    tracep->fullBit(oldp+39,(((~ (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__full)) 
                              & (0x14U > (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__value)))));
    tracep->fullBit(oldp+40,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__maybe_full));
    tracep->fullBit(oldp+41,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_match));
    tracep->fullBit(oldp+42,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__empty));
    tracep->fullBit(oldp+43,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__full));
    tracep->fullBit(oldp+44,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__do_enq));
    tracep->fullBit(oldp+45,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__do_deq));
    tracep->fullBit(oldp+46,((2U == (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__enq_ptr_value))));
    tracep->fullBit(oldp+47,((2U == (IData)(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__deq_ptr_value))));
    tracep->fullCData(oldp+48,(vlSelf->EnqueueEmptyFlushEdgecaseTester__DOT__q__DOT__ptr_diff),2);
    tracep->fullBit(oldp+49,(vlSelf->clock));
    tracep->fullBit(oldp+50,(vlSelf->reset));
